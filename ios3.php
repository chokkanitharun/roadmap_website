...
<head>
    ...
    <title>Skill Route - UIKit Fundamentals</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">UIKit Fundamentals</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://developer.apple.com/documentation/uikit" target="_blank" class="resource-link">Official UIKit Documentation</a>
            <a href="https://www.raywenderlich.com/ios" target="_blank" class="resource-link">Ray Wenderlich - UIKit Tutorials</a>
            <a href="https://www.udemy.com/course/ios-12-and-swift-5-0/" target="_blank" class="resource-link">Learn UIKit with Swift - Udemy</a>
            
            <div class="section-title">FOR ADVANCED</div>
            <a href="https://www.hackingwithswift.com/" target="_blank" class="resource-link">Hacking with Swift - UIKit Advanced Tutorials</a>
            <a href="https://developer.apple.com/documentation/uikit/uiview" target="_blank" class="resource-link">Advanced UIKit Components Documentation</a>
        --></div>
 ...
 <?php
     foreach ($vadvanceLinks as $name => $url) {
         ...
         ';
            ...
            <a href="https://www.youtube.com/watch?v=s4SbsS04F9g" target="_blank" class="resource-link">UIKit Basics - CodeWithChris</a>
            <a href="https://www.youtube.com/watch?v=1zWGRjq9Gb0" target="_blank" class="resource-link">UIKit for Beginners - LearnCode.academy</a>
            
            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=Z04fBkhxhnA" target="_blank" class="resource-link">Advanced UIKit Techniques - iOS Academy</a>
            <a href="https://www.youtube.com/watch?v=O1C9rdoD0vI" target="_blank" class="resource-link">Mastering UIKit - Sean Allen</a>
        --></div>
