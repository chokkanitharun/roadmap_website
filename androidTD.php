...
<head>
    ...
    <title>Skill Route - Testing & Debugging</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Testing and Debugging</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://developer.android.com/training/testing" target="_blank" class="resource-link">Testing Fundamentals - Android Developer Docs</a>
            <a href="https://www.geeksforgeeks.org/android-application-testing/" target="_blank" class="resource-link">Android Application Testing - GeeksforGeeks</a>
            <a href="https://developer.android.com/training/debugging" target="_blank" class="resource-link">Debugging Basics - Android Developer Docs</a>
            
            <div class="section-title">FOR ADVANCED</div>
            <a href="https://medium.com/androiddevelopers/advanced-android-testing-with-espresso-and-junit-7d2f6a3245fa" target="_blank" class="resource-link">Advanced Testing with Espresso and JUnit - Medium</a>
            <a href="https://developer.android.com/training/testing/espresso" target="_blank" class="resource-link">Using Espresso for UI Testing - Android Docs</a>
            <a href="https://www.raywenderlich.com/2757-unit-testing-in-android-with-junit" target="_blank" class="resource-link">Unit Testing with JUnit - RayWenderlich</a>
        --></div>
 ...
 <?php
     foreach ($vadvanceLinks as $name => $url) {
         ...
         ';
            ...
            <a href="https://www.youtube.com/watch?v=KnJmUdxGboQ" target="_blank" class="resource-link">Testing in Android - Simplified Coding</a>
            <a href="https://www.youtube.com/watch?v=GFSoc44nkBw" target="_blank" class="resource-link">Espresso Testing for Beginners - FreeCodeCamp</a>
            <a href="https://www.youtube.com/watch?v=e9P3WU53dBE" target="_blank" class="resource-link">Debugging Android Apps - Android Studio</a>
            
            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=h6jJwaFQ6DQ" target="_blank" class="resource-link">Advanced Android Testing with Espresso</a>
            <a href="https://www.youtube.com/watch?v=LUAZXwzkEuA" target="_blank" class="resource-link">Using Robolectric for Unit Testing</a>
            <a href="https://www.youtube.com/watch?v=_W2z9un-vvI" target="_blank" class="resource-link">JUnit Testing in Android - TechPrimers</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/android-testing-and-debugging/" target="_blank" class="resource-link">Android Testing and Debugging - Udemy</a>
            <a href="https://www.coursera.org/learn/android-app-debugging" target="_blank" class="resource-link">Debugging Android Apps - Coursera</a>
            <a href="https://www.pluralsight.com/courses/android-testing" target="_blank" class="resource-link">Android Testing - Pluralsight</a>
            
            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.udemy.com/course/advanced-android-testing/" target="_blank" class="resource-link">Advanced Android Testing - Udemy</a>
            <a href="https://frontendmasters.com/courses/android-testing/" target="_blank" class="resource-link">Android Testing Masterclass - Frontend Masters</a>
            <a href="https://www.edx.org/course/advanced-testing-techniques-in-android" target="_blank" class="resource-link">Advanced Testing Techniques - edX</a>
        --></div>
    </div>
