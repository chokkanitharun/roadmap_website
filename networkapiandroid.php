...
<head>
    ...
    <title>Skill Route - Networking & APIs</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Networking and APIs</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://developer.android.com/training/volley" target="_blank" class="resource-link">Networking with Volley - Official Guide</a>
            <a href="https://square.github.io/retrofit/" target="_blank" class="resource-link">Retrofit Documentation - Square</a>
            <a href="https://www.geeksforgeeks.org/retrofit-in-android-with-example/" target="_blank" class="resource-link">Retrofit in Android - GeeksforGeeks</a>
            
            <div class="section-title">FOR ADVANCED</div>
            <a href="https://medium.com/@ssaurel/using-retrofit-with-kotlin-and-android-735a5f2c5a20" target="_blank" class="resource-link">Using Retrofit with Kotlin - Medium</a>
            <a href="https://futurestud.io/tutorials/retrofit-getting-started-and-android-client" target="_blank" class="resource-link">Advanced Retrofit Tutorials - Future Studio</a>
            <a href="https://proandroiddev.com/advanced-retrofit-dynamic-urls-and-query-parameters-d33a27b79f6d" target="_blank" class="resource-link">Dynamic URLs and Query Parameters - ProAndroidDev</a>
        --></div>
...
<?php
    foreach ($vadvanceLinks as $name => $url) {
        ...
        ';
            ...
            <a href="https://www.youtube.com/watch?v=sYPHFGUCPH0" target="_blank" class="resource-link">Introduction to REST APIs in Android - Edureka</a>
            <a href="https://www.youtube.com/watch?v=R1sdXcbRjl8" target="_blank" class="resource-link">Retrofit Tutorial for Beginners - CodeWithHarry</a>
            <a href="https://www.youtube.com/watch?v=UcQR5v6kE20" target="_blank" class="resource-link">JSON Parsing using Gson - Android Basics</a>
            
            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=W8e2O05bDAs" target="_blank" class="resource-link">Advanced Networking with Retrofit - Simplilearn</a>
            <a href="https://www.youtube.com/watch?v=_KjAsWbZ-BY" target="_blank" class="resource-link">Error Handling with Retrofit - ProgrammingKnowledge</a>
            <a href="https://www.youtube.com/watch?v=lr2C33Qu5nI" target="_blank" class="resource-link">Interceptors with OkHttp - CodingInFlow</a>
        --></div>
...
?>
            ...
            <a href="https://www.udemy.com/course/rest-api-integration-with-retrofit/" target="_blank" class="resource-link">REST API Integration with Retrofit - Udemy</a>
            ...
            <a href="https://www.pluralsight.com/courses/retrofit-android-fundamentals" target="_blank" class="resource-link">Retrofit Fundamentals - Pluralsight</a>
            
            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.udemy.com/course/advanced-retrofit-and-okhttp/" target="_blank" class="resource-link">Advanced Retrofit and OkHttp - Udemy</a>
            <a href="https://frontendmasters.com/courses/android-rest-api/" target="_blank" class="resource-link">Mastering REST APIs in Android - Frontend Masters</a>
            <a href="https://www.edx.org/course/advanced-android-development" target="_blank" class="resource-link">Advanced Android Development - edX</a>
        --></div>
    </div>
