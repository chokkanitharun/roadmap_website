...
<head>
    ...
    <title>Skill Route - Layouts and UI Design</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Layouts and UI Design</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://developer.android.com/guide/topics/ui/declaring-layout" target="_blank" class="resource-link">Understanding XML Layouts - Official Guide</a>
            <a href="https://www.geeksforgeeks.org/linearlayout-in-android-with-example/" target="_blank" class="resource-link">LinearLayout in Android - GeeksforGeeks</a>
            <a href="https://www.geeksforgeeks.org/constraintlayout-in-android-with-examples/" target="_blank" class="resource-link">ConstraintLayout Examples - GeeksforGeeks</a>
            
            <div class="section-title">FOR ADVANCED</div>
            <a href="https://medium.com/androiddevelopers/constraintlayout-tips-tricks-682f26ef6b73" target="_blank" class="resource-link">ConstraintLayout Tips & Tricks - Medium</a>
            <a href="https://www.raywenderlich.com/6015343-designing-adaptive-layouts" target="_blank" class="resource-link">Designing Adaptive Layouts - RayWenderlich</a>
            <a href="https://www.youtube.com/watch?v=7FrA0aHZR1g" target="_blank" class="resource-link">Advanced XML Design Techniques - YouTube</a>
        --></div>
        ...
        <div id="videos" class="slider-section" style="display: none;">
            ...
            <a href="https://www.youtube.com/watch?v=AG0zJVSfCec" target="_blank" class="resource-link">XML Layout Basics - Simplilearn</a>
            <a href="https://www.youtube.com/watch?v=_mRbBT3uf_o" target="_blank" class="resource-link">Understanding ConstraintLayout - Coding in Flow</a>
            <a href="https://www.youtube.com/watch?v=hvY9GAKF8xM" target="_blank" class="resource-link">LinearLayout and RelativeLayout Basics - Edureka</a>
            
            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=0w7CNtTPkS0" target="_blank" class="resource-link">Mastering ConstraintLayout - Android Developers</a>
            <a href="https://www.youtube.com/watch?v=WWxuR2GeGJk" target="_blank" class="resource-link">Designing Complex UI - ProgrammingKnowledge</a>
            <a href="https://www.youtube.com/watch?v=YxHSTFaQR-8" target="_blank" class="resource-link">Adaptive Layout Design - Google Developers</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/android-xml-layout-design-basics/" target="_blank" class="resource-link">XML Layout Design Basics - Udemy</a>
            <a href="https://www.coursera.org/learn/android-app-ui-design" target="_blank" class="resource-link">Android UI Design - Coursera</a>
            <a href="https://www.pluralsight.com/courses/android-xml-layouts" target="_blank" class="resource-link">Working with XML Layouts - Pluralsight</a>
            
            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.udemy.com/course/advanced-android-ui-design/" target="_blank" class="resource-link">Advanced Android UI Design - Udemy</a>
            <a href="https://frontendmasters.com/courses/android-ui-design/" target="_blank" class="resource-link">UI Design Mastery - Frontend Masters</a>
            <a href="https://www.edx.org/course/adaptive-layouts-and-ui-design" target="_blank" class="resource-link">Adaptive Layouts and Design - edX</a>
        --></div>
    </div>
