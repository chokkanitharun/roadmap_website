...
<head>
    ...
    <title>Skill Route - Forms and Input Types</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Forms and Input Types</div>
...
?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://developer.mozilla.org/en-US/docs/Learn/Forms" target="_blank" class="resource-link">MDN - Learn Forms</a>
            <a href="https://www.w3schools.com/html/html_forms.asp" target="_blank" class="resource-link">W3Schools - HTML Forms</a>
            <a href="https://html.com/attributes/input/" target="_blank" class="resource-link">HTML.com - Input Types</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/form" target="_blank" class="resource-link">MDN - Form Element</a>
            <a href="https://css-tricks.com/form-validation-part-1-constraint-validation-html/" target="_blank" class="resource-link">CSS-Tricks - Form Validation</a>
            <a href="https://www.udemy.com/course/html-and-css-for-advanced/" target="_blank" class="resource-link">Udemy - Advanced HTML Forms</a>
        --></div>
        ...
        <div id="videos" class="slider-section" style="display: none;">
            ...
            <a href="https://www.youtube.com/watch?v=d8rJrjl5rRk" target="_blank" class="resource-link">HTML Forms Tutorial</a>
            <a href="https://www.youtube.com/watch?v=-8W9D3J_rhM" target="_blank" class="resource-link">Input Types Explained</a>
            <a href="https://www.youtube.com/watch?v=g8K_fHSI4lc" target="_blank" class="resource-link">Forms and Validation Basics</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=TEXw7X8_R6k" target="_blank" class="resource-link">Advanced Form Techniques</a>
            <a href="https://www.youtube.com/watch?v=RaCrbcOAPkk" target="_blank" class="resource-link">Creating Dynamic Forms</a>
            <a href="https://www.youtube.com/watch?v=DvnxBf_qN4I" target="_blank" class="resource-link">HTML5 Forms Features</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.codecademy.com/learn/html-forms" target="_blank" class="resource-link">Codecademy - HTML Forms</a>
            <a href="https://www.udemy.com/course/html-forms-for-beginners/" target="_blank" class="resource-link">Udemy - HTML Forms for Beginners</a>
            <a href="https://scrimba.com/learn/html" target="_blank" class="resource-link">Scrimba - Learn Forms</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.udemy.com/course/html-css-javascript-forms/" target="_blank" class="resource-link">Udemy - Advanced Forms and JavaScript</a>
            <a href="https://frontendmasters.com/courses/html5/" target="_blank" class="resource-link">Frontend Masters - HTML5 Mastery</a>
            <a href="https://www.coursera.org/learn/html-css-javascript-for-web-developers" target="_blank" class="resource-link">Coursera - Advanced Forms</a>
        --></div>
    </div>
