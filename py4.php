...
<head>
    ...
    <title>Skill Route - File Handling</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">File Handling</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://www.geeksforgeeks.org/file-handling-in-python/" target="_blank" class="resource-link">File Handling Basics - GeeksforGeeks</a>
            <a href="https://realpython.com/working-with-files-in-python/" target="_blank" class="resource-link">Working with Files - Real Python</a>
            <a href="https://www.programiz.com/python-programming/file-operation" target="_blank" class="resource-link">Python File Operations - Programiz</a>
            
            <div class="section-title">FOR ADVANCED</div>
            <a href="https://www.tutorialspoint.com/python/python_files_io.htm" target="_blank" class="resource-link">File I/O in Depth - TutorialsPoint</a>
            <a href="https://docs.python.org/3/library/io.html" target="_blank" class="resource-link">Python IO Module - Official Docs</a>
            <a href="https://www.datacamp.com/community/tutorials/tutorial-python-file-operations" target="_blank" class="resource-link">Advanced File Handling - DataCamp</a>
        --></div>
 ...
 <?php
     foreach ($vadvanceLinks as $name => $url) {
         ...
         ';
            ...
            <a href="https://www.youtube.com/watch?v=Uh2ebFW8OYM" target="_blank" class="resource-link">Python File Handling - Tech With Tim</a>
            <a href="https://www.youtube.com/watch?v=6lWMv8UpBzY" target="_blank" class="resource-link">File Operations in Python - Corey Schafer</a>
            <a href="https://www.youtube.com/watch?v=2eebptXfEvw" target="_blank" class="resource-link">File Handling Basics - Programming with Mosh</a>
            
            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=Eh79YSL33_k" target="_blank" class="resource-link">Advanced File Handling - Clever Programmer</a>
            <a href="https://www.youtube.com/watch?v=nqye02H_H6I" target="_blank" class="resource-link">Python File I/O - Edureka</a>
            <a href="https://www.youtube.com/watch?v=iczt7peF4Kc" target="_blank" class="resource-link">Efficient File Handling - CS Dojo</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/python-file-handling-for-beginners/" target="_blank" class="resource-link">File Handling for Beginners - Udemy</a>
            <a href="https://www.codecademy.com/courses/learn-python-3/lessons/python-file-handling" target="_blank" class="resource-link">File Handling Path - Codecademy</a>
            <a href="https://www.coursera.org/learn/python-file-handling" target="_blank" class="resource-link">Python File Handling - Coursera</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.educative.io/courses/python-file-handling-techniques" target="_blank" class="resource-link">Advanced File Handling - Educative.io</a>
            <a href="https://www.datacamp.com/courses/advanced-python-file-handling" target="_blank" class="resource-link">Advanced Python File Handling - DataCamp</a>
            <a href="https://frontendmasters.com/courses/python-file-handling/" target="_blank" class="resource-link">Efficient File Operations - Frontend Masters</a>
        --></div>
    </div>
