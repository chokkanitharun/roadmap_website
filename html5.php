...
<head>
    ...
    <title>Skill Route - HTML Media Elements</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">HTML Media Elements</div>
...
?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/audio" target="_blank" class="resource-link">MDN - Audio Element</a>
            <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/video" target="_blank" class="resource-link">MDN - Video Element</a>
            <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/img" target="_blank" class="resource-link">MDN - Image Element</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://www.smashingmagazine.com/2018/01/guide-responsive-images-picture-srcset/" target="_blank" class="resource-link">Smashing Magazine - Responsive Media</a>
            <a href="https://developer.mozilla.org/en-US/docs/Learn/HTML/Multimedia_and_embedding" target="_blank" class="resource-link">MDN - Multimedia and Embedding</a>
            <a href="https://web.dev/video-audio/" target="_blank" class="resource-link">Web.dev - Best Practices for Media Elements</a>
        --></div>
        ...
        <div id="videos" class="slider-section" style="display: none;">
            ...
            <a href="https://www.youtube.com/watch?v=TnXJV8dK8w0" target="_blank" class="resource-link">HTML Audio Tag Explained</a>
            <a href="https://www.youtube.com/watch?v=lHBRhEajpDg" target="_blank" class="resource-link">HTML Video Tag Tutorial</a>
            <a href="https://www.youtube.com/watch?v=R5SHmMUSou4" target="_blank" class="resource-link">HTML Image Basics</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=K2HjO7N1iUU" target="_blank" class="resource-link">Responsive Images and Videos</a>
            <a href="https://www.youtube.com/watch?v=XdRt4I46A68" target="_blank" class="resource-link">Optimizing Media for Performance</a>
            <a href="https://www.youtube.com/watch?v=X3FC2RHdsfU" target="_blank" class="resource-link">Advanced Media Techniques in HTML</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.codecademy.com/learn/learn-html-media" target="_blank" class="resource-link">Codecademy - HTML Media</a>
            <a href="https://www.udemy.com/course/html-basics/" target="_blank" class="resource-link">Udemy - Learn HTML Basics</a>
            <a href="https://scrimba.com/learn/html" target="_blank" class="resource-link">Scrimba - Multimedia in HTML</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.udemy.com/course/html-responsive-images/" target="_blank" class="resource-link">Udemy - Responsive Media</a>
            <a href="https://frontendmasters.com/courses/modern-html/" target="_blank" class="resource-link">Frontend Masters - Modern HTML</a>
            <a href="https://www.coursera.org/learn/html-css-javascript-for-web-developers" target="_blank" class="resource-link">Coursera - Advanced HTML Techniques</a>
        --></div>
    </div>
