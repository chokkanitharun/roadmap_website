...
<head>
    ...
    <title>Skill Route - Conditional Rendering</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Conditional Rendering</div>
...
?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://reactjs.org/docs/conditional-rendering.html" target="_blank" class="resource-link">React - Conditional Rendering</a>
            <a href="https://www.digitalocean.com/community/tutorials/react-conditional-rendering" target="_blank" class="resource-link">DigitalOcean - React Conditional Rendering</a>
            <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/if...else" target="_blank" class="resource-link">MDN - JavaScript Conditional Statements</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://kentcdodds.com/blog/conditional-rendering-in-react" target="_blank" class="resource-link">Advanced Conditional Rendering in React</a>
            <a href="https://www.sitepoint.com/understanding-conditional-rendering-in-react/" target="_blank" class="resource-link">SitePoint - Conditional Rendering in React</a>
            <a href="https://www.udemy.com/course/react-conditional-rendering/" target="_blank" class="resource-link">React Conditional Rendering - Udemy</a>
    --></div>
    ...
    ?>
           <!-- <div class="section-title">Video Resources for Beginners</div>
            <a href="https://www.youtube.com/watch?v=6tGeZYK-3uc" target="_blank" class="resource-link">Conditional Rendering in React</a>
            <a href="https://www.youtube.com/watch?v=EnX70SOnWgk" target="_blank" class="resource-link">React Conditional Rendering Tutorial</a>
            <a href="https://www.youtube.com/watch?v=dQ9FVkL2meY" target="_blank" class="resource-link">JavaScript Conditional Statements</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=s9RzAtb2AfA" target="_blank" class="resource-link">Advanced Conditional Rendering in React</a>
            <a href="https://www.youtube.com/watch?v=3USbwB2Z8Bo" target="_blank" class="resource-link">React Conditional Rendering - Advanced Concepts</a>
            <a href="https://www.youtube.com/watch?v=gFrtMGGOuLg" target="_blank" class="resource-link">Master React Conditional Rendering</a>
    --></div>
...
?>
            ...
            <a href="https://www.udemy.com/course/the-complete-react-developer-course/" target="_blank" class="resource-link">The Complete React Developer Course - Udemy</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://frontendmasters.com/courses/advanced-react/" target="_blank" class="resource-link">Frontend Masters - Advanced React</a>
            <a href="https://www.coursera.org/learn/advanced-react" target="_blank" class="resource-link">Advanced React - Coursera</a>
            <a href="https://www.udemy.com/course/react-redux-tutorial/" target="_blank" class="resource-link">Advanced React & Redux - Udemy</a>
    --></div>
    </div>
