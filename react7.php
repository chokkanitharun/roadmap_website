...
<head>
    ...
    <title>Skill Route - Handling Events</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Handling Events</div>
...
?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://developer.mozilla.org/en-US/docs/Web/Events" target="_blank" class="resource-link">MDN Web Docs: Events</a>
            <a href="https://reactjs.org/docs/handling-events.html" target="_blank" class="resource-link">React - Handling Events</a>
            <a href="https://www.javascripttutorial.net/javascript-dom/javascript-events/" target="_blank" class="resource-link">JavaScript Events Tutorial</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://kentcdodds.com/blog/understanding-events-in-react" target="_blank" class="resource-link">Advanced React Events</a>
            <a href="https://www.sitepoint.com/understanding-events-in-javascript/" target="_blank" class="resource-link">Understanding JavaScript Events - SitePoint</a>
            <a href="https://www.udemy.com/course/understanding-javascript-events/" target="_blank" class="resource-link">JavaScript Events - Udemy</a>
    --></div>
    ...
    ?>
            ...
            <a href="https://www.youtube.com/watch?v=pcDcxJfbFfM" target="_blank" class="resource-link">Handling Events in JavaScript</a>
            <a href="https://www.youtube.com/watch?v=sUc_l5oLsNk" target="_blank" class="resource-link">JavaScript Event Handling Tutorial</a>
            <a href="https://www.youtube.com/watch?v=-PGljUv3B7E" target="_blank" class="resource-link">React Events - Tutorial for Beginners</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=J6n6okU5EuA" target="_blank" class="resource-link">Mastering Events in React</a>
            <a href="https://www.youtube.com/watch?v=tmjrWvqE5Z8" target="_blank" class="resource-link">JavaScript Event Listeners Explained</a>
            <a href="https://www.youtube.com/watch?v=2t0hmbQ2T4Q" target="_blank" class="resource-link">Advanced Event Handling in React</a>
    --></div>
...
?>
            ...
            <a href="https://www.codecademy.com/courses/introduction-to-javascript/lessons/events/exercises/intro" target="_blank" class="resource-link">Codecademy - JavaScript Events</a>
            <a href="https://scrimba.com/learn/learnreact" target="_blank" class="resource-link">Scrimba - React Event Handling</a>
            <a href="https://www.udemy.com/course/the-complete-javascript-course/" target="_blank" class="resource-link">The Complete JavaScript Course - Udemy</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://frontendmasters.com/courses/advanced-react-events/" target="_blank" class="resource-link">Frontend Masters - Advanced React Events</a>
            <a href="https://www.coursera.org/learn/advanced-javascript/" target="_blank" class="resource-link">Advanced JavaScript - Coursera</a>
            <a href="https://www.udemy.com/course/advanced-javascript/" target="_blank" class="resource-link">Advanced JavaScript - Udemy</a>
    --></div>
    </div>
