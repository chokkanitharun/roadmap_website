...
<head>
    ...
    <title>Skill Route - Web Development (Flask/Django)</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Web Development (Flask/Django)</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://flask.palletsprojects.com/en/2.0.x/quickstart/" target="_blank" class="resource-link">Flask Quickstart - Official Docs</a>
            <a href="https://www.djangoproject.com/start/" target="_blank" class="resource-link">Getting Started with Django - Django Official</a>
            <a href="https://realpython.com/tutorials/flask/" target="_blank" class="resource-link">Flask Tutorials - Real Python</a>
            
            <div class="section-title">FOR ADVANCED</div>
            <a href="https://flask.palletsprojects.com/en/2.0.x/patterns/" target="_blank" class="resource-link">Flask Patterns - Official Docs</a>
            <a href="https://docs.djangoproject.com/en/4.0/topics/" target="_blank" class="resource-link">Advanced Django Topics - Official Docs</a>
            <a href="https://realpython.com/django-advanced-techniques/" target="_blank" class="resource-link">Advanced Django Techniques - Real Python</a>
        --></div>
 ...
 <?php
     foreach ($vadvanceLinks as $name => $url) {
         ...
         ';
            ...
            <a href="https://www.youtube.com/watch?v=Z1RJmh_OqeA" target="_blank" class="resource-link">Flask Crash Course - Traversy Media</a>
            <a href="https://www.youtube.com/watch?v=F5mRW0jo-U4" target="_blank" class="resource-link">Django Beginner's Guide - Programming with Mosh</a>
            <a href="https://www.youtube.com/watch?v=QnDWIZuWYW0" target="_blank" class="resource-link">Flask for Beginners - FreeCodeCamp</a>
            
            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=UmljXZIypDc" target="_blank" class="resource-link">Advanced Flask - Corey Schafer</a>
            <a href="https://www.youtube.com/watch?v=rHux0gMZ3Eg" target="_blank" class="resource-link">Advanced Django Projects - Tech With Tim</a>
            <a href="https://www.youtube.com/watch?v=AmmvylryjXk" target="_blank" class="resource-link">Mastering Django - Clever Programmer</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/python-flask/" target="_blank" class="resource-link">Flask Basics - Udemy</a>
            <a href="https://www.coursera.org/learn/django-web-framework" target="_blank" class="resource-link">Django for Beginners - Coursera</a>
            <a href="https://www.datacamp.com/courses/building-web-applications-in-python-with-flask" target="_blank" class="resource-link">Building Flask Apps - DataCamp</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://frontendmasters.com/courses/flask/" target="_blank" class="resource-link">Advanced Flask - Frontend Masters</a>
            <a href="https://www.educative.io/courses/advanced-django" target="_blank" class="resource-link">Advanced Django - Educative.io</a>
            <a href="https://www.codecademy.com/learn/advanced-django" target="_blank" class="resource-link">Mastering Django - Codecademy</a>
        --></div>
    </div>
