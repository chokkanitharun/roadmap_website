...
<head>
    ...
    <title>Skill Route - HTML Best Practices</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">HTML Best Practices</div>
...
?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://developer.mozilla.org/en-US/docs/Web/HTML" target="_blank" class="resource-link">MDN - HTML Best Practices</a>
            <a href="https://www.freecodecamp.org/news/html-best-practices/" target="_blank" class="resource-link">FreeCodeCamp - HTML Best Practices</a>
            <a href="https://web.dev/learn/html/" target="_blank" class="resource-link">Web.dev - HTML Essentials</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://css-tricks.com/10-html-best-practices-you-should-follow/" target="_blank" class="resource-link">CSS-Tricks - 10 HTML Best Practices</a>
            <a href="https://frontendmasters.com/guides/html-best-practices/" target="_blank" class="resource-link">Frontend Masters - HTML Guide</a>
            <a href="https://www.smashingmagazine.com/2020/06/html5-structural-semantics-accessibility/" target="_blank" class="resource-link">Smashing Magazine - HTML Best Practices</a>
        --></div>
        ...
        <div id="videos" class="slider-section" style="display: none;">
            ...
            <a href="https://www.youtube.com/watch?v=bWPMSSsVdPk" target="_blank" class="resource-link">HTML Basics and Best Practices</a>
            <a href="https://www.youtube.com/watch?v=UB1O30fR-EE" target="_blank" class="resource-link">HTML Explained - FreeCodeCamp</a>
            <a href="https://www.youtube.com/watch?v=D-h8L5hgW-w" target="_blank" class="resource-link">HTML Best Practices Tutorial</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=88PXJAA6szs" target="_blank" class="resource-link">Advanced HTML and Best Practices</a>
            <a href="https://www.youtube.com/watch?v=sMb1XRND0Rk" target="_blank" class="resource-link">Code Organization and Semantic HTML</a>
            <a href="https://www.youtube.com/watch?v=fFJdGH_GW8U" target="_blank" class="resource-link">Writing Clean and Readable HTML</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/html-css-javascript/" target="_blank" class="resource-link">Udemy - HTML & CSS for Beginners</a>
            ...
            <a href="https://frontendmasters.com/courses/html-semantics/" target="_blank" class="resource-link">Frontend Masters - Advanced HTML</a>
            <a href="https://www.udemy.com/course/html5-css3-responsive/" target="_blank" class="resource-link">Udemy - Advanced HTML & CSS</a>
            <a href="https://www.linkedin.com/learning/html-essential-training/" target="_blank" class="resource-link">LinkedIn Learning - HTML Essential Training</a>
        --></div>
    </div>
