...
?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://www.geeksforgeeks.org/exception-handling-in-java/" target="_blank" class="resource-link">GeeksforGeeks - Exception Handling in Java</a>
            <a href="https://www.w3schools.com/java/java_try_catch.asp" target="_blank" class="resource-link">W3Schools - Try Catch in Java</a>
            <a href="https://www.tutorialspoint.com/java/java_exceptions.htm" target="_blank" class="resource-link">TutorialsPoint - Java Exceptions</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://www.baeldung.com/java-exceptions" target="_blank" class="resource-link">Baeldung - A Guide to Java Exceptions</a>
            <a href="https://docs.oracle.com/javase/tutorial/essential/exceptions/" target="_blank" class="resource-link">Oracle Documentation - Essential Exceptions</a>
            <a href="https://rollbar.com/blog/best-practices-for-exception-handling-in-java/" target="_blank" class="resource-link">Rollbar - Best Practices for Exception Handling</a>
        --></div>
        ...
        <div id="videos" class="slider-section" style="display: none;">
            ...
            <a href="https://www.youtube.com/watch?v=fBswXqph5_U" target="_blank" class="resource-link">YouTube - Exception Handling in Java</a>
            <a href="https://www.youtube.com/watch?v=R9OBW6N2V8s" target="_blank" class="resource-link">YouTube - Try Catch Explained with Examples</a>
            <a href="https://www.youtube.com/watch?v=eBzEGNnjHec" target="_blank" class="resource-link">YouTube - Exception Handling for Beginners</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=jlHkDBEumP0" target="_blank" class="resource-link">YouTube - Advanced Exception Handling Techniques</a>
            <a href="https://www.youtube.com/watch?v=dIFUNe8Nc1U" target="_blank" class="resource-link">YouTube - Effective Exception Handling</a>
            <a href="https://www.youtube.com/watch?v=EFfEy4MlQbw" target="_blank" class="resource-link">YouTube - Exception Handling Best Practices</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/java-programming-masterclass/" target="_blank" class="resource-link">Udemy - Java Programming Masterclass</a>
            <a href="https://www.codecademy.com/learn/learn-java" target="_blank" class="resource-link">Codecademy - Learn Java</a>
            <a href="https://www.coursera.org/learn/java-programming" target="_blank" class="resource-link">Coursera - Java Programming</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.udemy.com/course/java-design-patterns/" target="_blank" class="resource-link">Udemy - Java Design Patterns and Practices</a>
            <a href="https://www.pluralsight.com/courses/java-error-handling-best-practices" target="_blank" class="resource-link">Pluralsight - Error Handling Best Practices</a>
            <a href="https://www.coursera.org/learn/advanced-java-programming" target="_blank" class="resource-link">Coursera - Advanced Java Programming</a>
        --> </div>
    </div>
