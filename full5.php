...
<head>
    ...
    <title>Skill Route - Node.js & Express</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Node.js & Express</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://nodejs.dev/en/learn/" target="_blank" class="resource-link">Node.js Official Docs - Learn Node.js</a>
            <a href="https://www.freecodecamp.org/news/learn-node-js-in-1-hour/" target="_blank" class="resource-link">FreeCodeCamp - Node.js Basics</a>
            <a href="https://expressjs.com/en/starter/installing.html" target="_blank" class="resource-link">Express.js Official Docs</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://nodejs.org/en/docs/guides/" target="_blank" class="resource-link">Node.js Guides</a>
            <a href="https://blog.logrocket.com/category/node-js/" target="_blank" class="resource-link">LogRocket Blog - Advanced Node.js</a>
            <a href="https://www.digitalocean.com/community/tutorial_series/getting-started-with-node-js" target="_blank" class="resource-link">DigitalOcean - Advanced Node.js Techniques</a>
        --></div>
 ...
 <?php
     foreach ($vadvanceLinks as $name => $url) {
         ...
         ';
            ...
            <a href="https://www.youtube.com/watch?v=TlB_eWDSMt4" target="_blank" class="resource-link">YouTube - Node.js Crash Course</a>
            <a href="https://www.youtube.com/watch?v=Oe421EPjeBE" target="_blank" class="resource-link">YouTube - Express.js Tutorial</a>
            <a href="https://www.youtube.com/watch?v=2wCpkOk2uCg" target="_blank" class="resource-link">YouTube - REST APIs with Node.js and Express</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=vjf774RKrLc" target="_blank" class="resource-link">YouTube - Advanced Node.js</a>
            <a href="https://www.youtube.com/watch?v=BWUi6BS9T5Y" target="_blank" class="resource-link">YouTube - Express.js Middleware</a>
            <a href="https://www.youtube.com/watch?v=gnsO8-xJ8rs" target="_blank" class="resource-link">YouTube - Advanced REST APIs</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/the-complete-nodejs-developer-course-2/" target="_blank" class="resource-link">Udemy - Complete Node.js Developer Course</a>
            <a href="https://www.codecademy.com/learn/learn-node-js" target="_blank" class="resource-link">Codecademy - Learn Node.js</a>
            <a href="https://scrimba.com/learn/learnnodejs" target="_blank" class="resource-link">Scrimba - Node.js for Beginners</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://frontendmasters.com/courses/advanced-node-js/" target="_blank" class="resource-link">Frontend Masters - Advanced Node.js</a>
            <a href="https://www.pluralsight.com/courses/nodejs-advanced" target="_blank" class="resource-link">Pluralsight - Advanced Node.js</a>
            <a href="https://egghead.io/courses/create-apis-with-node-js-and-express" target="_blank" class="resource-link">Egghead - Node.js and Express APIs</a>
        --></div>
    </div>
