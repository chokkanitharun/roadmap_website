...
<head>
    ...
    <title>Skill Route - Testing and Debugging</title>
    <style>
...
?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://developer.apple.com/documentation/xcode/testing_your_app" target="_blank" class="resource-link">Apple Docs - Testing Your App</a>
            <a href="https://www.raywenderlich.com/11471711-unit-testing-and-ui-testing-tutorial" target="_blank" class="resource-link">Ray Wenderlich - Unit Testing & UI Testing Tutorial</a>
            <a href="https://medium.com/swlh/debugging-in-xcode-a-comprehensive-guide-f23d4417a3a7" target="_blank" class="resource-link">Medium - Debugging in Xcode</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://www.udemy.com/course/ios-testing/" target="_blank" class="resource-link">Udemy - Advanced iOS Testing</a>
            <a href="https://developer.apple.com/videos/play/wwdc2020/10106/" target="_blank" class="resource-link">Apple WWDC - Advanced Debugging in Xcode</a>
            <a href="https://www.raywenderlich.com/23187519-advanced-xcode-debugging" target="_blank" class="resource-link">Ray Wenderlich - Advanced Xcode Debugging</a>
    --></div>
 ...
 <?php
     foreach ($vadvanceLinks as $name => $url) {
         ...
         ';
            ...
            <a href="https://www.youtube.com/watch?v=X5wHeAzb7kY" target="_blank" class="resource-link">YouTube - XCTest Basics</a>
            <a href="https://www.youtube.com/watch?v=0iyDR9ZzpyM" target="_blank" class="resource-link">YouTube - Debugging in Xcode</a>
            <a href="https://www.youtube.com/watch?v=NXcZKnrbIKs" target="_blank" class="resource-link">YouTube - Setting Breakpoints in Xcode</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=wsKf3N5nTy8" target="_blank" class="resource-link">YouTube - Advanced XCTest Features</a>
            <a href="https://www.youtube.com/watch?v=j9zLa6Ro6fs" target="_blank" class="resource-link">YouTube - Advanced Debugging in Xcode</a>
            <a href="https://www.youtube.com/watch?v=AK9PEF1XBbA" target="_blank" class="resource-link">YouTube - Testing UI Interactions in iOS</a>
    --></div>
...
?>
            ...
            <a href="https://www.udemy.com/course/ios-unit-and-ui-testing/" target="_blank" class="resource-link">Udemy - iOS Unit & UI Testing</a>
            <a href="https://developer.apple.com/documentation/xcode/debugging_with_xcode" target="_blank" class="resource-link">Apple - Debugging with Xcode</a>
            <a href="https://teamtreehouse.com/library/testing-and-debugging-ios-applications" target="_blank" class="resource-link">Treehouse - Testing & Debugging iOS Applications</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://frontendmasters.com/courses/ios-testing-debugging/" target="_blank" class="resource-link">Frontend Masters - Advanced iOS Testing</a>
            <a href="https://www.linkedin.com/learning/testing-and-debugging-ios-applications/" target="_blank" class="resource-link">LinkedIn Learning - Testing & Debugging iOS Applications</a>
            <a href="https://www.pluralsight.com/courses/advanced-ios-debugging" target="_blank" class="resource-link">Pluralsight - Advanced iOS Debugging</a>
    --></div>
    </div>
