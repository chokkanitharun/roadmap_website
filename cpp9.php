...
<head>
    ...
    <title>Skill Route - System Programming</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">System Programming</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://www.geeksforgeeks.org/system-programming/" target="_blank" class="resource-link">Introduction to System Programming - GeeksforGeeks</a>
            <a href="https://www.tutorialspoint.com/system_programming/index.htm" target="_blank" class="resource-link">System Programming Tutorial - TutorialsPoint</a>
            <a href="https://www.programiz.com/cpp-programming/system-programming" target="_blank" class="resource-link">System Programming in C++ - Programiz</a>
            
            <div class="section-title">FOR ADVANCED</div>
            <a href="https://www.learn-c.org/en/System_Programming" target="_blank" class="resource-link">Advanced System Programming - Learn-C</a>
            <a href="https://www.coursera.org/learn/linux-system-programming" target="_blank" class="resource-link">Linux System Programming - Coursera</a>
            <a href="https://www.udemy.com/course/linux-system-programming/" target="_blank" class="resource-link">Linux System Programming - Udemy</a>
        --></div>
 ...
 <?php
     foreach ($vadvanceLinks as $name => $url) {
         ...
         ';
            ...
            <a href="https://www.youtube.com/watch?v=F6OqbdtDk5A" target="_blank" class="resource-link">System Programming Basics - Geeky Shows</a>
            <a href="https://www.youtube.com/watch?v=ckp7W0K7DlY" target="_blank" class="resource-link">Introduction to System Programming - TechSith</a>
            <a href="https://www.youtube.com/watch?v=9LxVXIlPb78" target="_blank" class="resource-link">System Programming in C - FreeCodeCamp</a>
            
            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=LvXv8ES4RFE" target="_blank" class="resource-link">Advanced System Programming - FreeCodeCamp</a>
            <a href="https://www.youtube.com/watch?v=DA5Ywlk1oLw" target="_blank" class="resource-link">Linux System Programming - The Net Ninja</a>
            <a href="https://www.youtube.com/watch?v=F3UNJvW7sjw" target="_blank" class="resource-link">Mastering System Programming - Simplilearn</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/system-programming-in-c/" target="_blank" class="resource-link">System Programming in C - Udemy</a>
            <a href="https://www.coursera.org/learn/system-programming" target="_blank" class="resource-link">System Programming - Coursera</a>
            <a href="https://www.codecademy.com/learn/learn-c-plus-plus" target="_blank" class="resource-link">Learn C++ and System Programming - Codecademy</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.udemy.com/course/advanced-system-programming/" target="_blank" class="resource-link">Advanced System Programming - Udemy</a>
            <a href="https://www.edx.org/course/linux-system-programming" target="_blank" class="resource-link">Linux System Programming - edX</a>
            <a href="https://frontendmasters.com/courses/linux-system-programming/" target="_blank" class="resource-link">Master Linux System Programming - Frontend Masters</a>
        --></div>
    </div>
