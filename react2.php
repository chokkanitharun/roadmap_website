...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">JSX</div>
...
?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://react.dev/learn/writing-markup-with-jsx" target="_blank" class="resource-link">JSX Basics - React Official Docs</a>
            <a href="https://www.freecodecamp.org/news/react-jsx-a-brief-introduction/" target="_blank" class="resource-link">Introduction to JSX - FreeCodeCamp</a>
            <a href="https://blog.logrocket.com/jsx-in-react-introduction-examples/" target="_blank" class="resource-link">JSX in React - LogRocket</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://babeljs.io/docs/en/babel-plugin-transform-react-jsx" target="_blank" class="resource-link">Understanding Babel and JSX Transformation</a>
            <a href="https://dev.to/lydiahallie/react-jsx-tips-2f41" target="_blank" class="resource-link">Advanced JSX Tips - Dev.to</a>
            <a href="https://react-typescript-cheatsheet.netlify.app/docs/basic/getting-started/jsx/" target="_blank" class="resource-link">JSX with TypeScript</a>
    --></div>
    ...
    ?>
            ...
            <a href="https://www.youtube.com/watch?v=VZh0DzHAaTk" target="_blank" class="resource-link">Understanding JSX in React</a>
            <a href="https://www.youtube.com/watch?v=KJP1E-Y-xyo" target="_blank" class="resource-link">JSX Explained - Programming with Mosh</a>
            <a href="https://www.youtube.com/watch?v=ShiuwoMX-Ek" target="_blank" class="resource-link">JSX Crash Course</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=wa2w8dXNhUA" target="_blank" class="resource-link">JSX Deep Dive</a>
            <a href="https://www.youtube.com/watch?v=nIloAzS4y2I" target="_blank" class="resource-link">Understanding JSX Compilation</a>
            <a href="https://www.youtube.com/watch?v=jVm1zKsCpLk" target="_blank" class="resource-link">Advanced JSX Features</a>
    --></div>
...
?>
            ...
            <a href="https://www.udemy.com/course/react-the-complete-guide/" target="_blank" class="resource-link">React and JSX Basics - Udemy</a>
            ...
            <a href="https://frontendmasters.com/courses/react/" target="_blank" class="resource-link">Frontend Masters - Advanced React & JSX</a>
            <a href="https://www.pluralsight.com/courses/react-redux-es6" target="_blank" class="resource-link">React and JSX in Depth - Pluralsight</a>
