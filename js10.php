...
<head>
    ...
    <title>Skill Route - Node.js and Backend Basics</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Node.js and Backend Basics</div>
...
?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://nodejs.dev/learn" target="_blank" class="resource-link">Node.js Basics</a>
            <a href="https://expressjs.com/en/starter/basic-routing.html" target="_blank" class="resource-link">Express.js Beginner Guide</a>
            <a href="https://www.freecodecamp.org/news/what-is-an-api/" target="_blank" class="resource-link">Introduction to APIs</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://nodejs.org/en/docs/guides/event-loop-timers-and-nexttick/" target="_blank" class="resource-link">Understanding the Node.js Event Loop</a>
            <a href="https://expressjs.com/en/advanced/best-practice-security.html" target="_blank" class="resource-link">Express.js Security Best Practices</a>
            <a href="https://medium.com/@nodejs/best-practices-in-node-js-development-95a0d2ec7ab6" target="_blank" class="resource-link">Node.js Development Best Practices</a>
    --></div>
    ...
    ?>
            ...
            <a href="https://www.youtube.com/watch?v=TlB_eWDSMt4" target="_blank" class="resource-link">Learn Node.js Basics</a>
            <a href="https://www.youtube.com/watch?v=L72fhGm1tfE" target="_blank" class="resource-link">Express.js for Beginners</a>
            <a href="https://www.youtube.com/watch?v=GZvSYJDk-us" target="_blank" class="resource-link">What is an API?</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=8aGhZQkoFbQ" target="_blank" class="resource-link">Deep Dive into the Node.js Event Loop</a>
            <a href="https://www.youtube.com/watch?v=zoSJ3bNGPp0" target="_blank" class="resource-link">Building Secure APIs with Express</a>
            <a href="https://www.youtube.com/watch?v=fBNz5xF-Kx4" target="_blank" class="resource-link">Advanced Node.js Concepts</a>
    --></div>
...
?>
            ...
            <a href="https://www.udemy.com/course/the-complete-nodejs-developer-course-2/" target="_blank" class="resource-link">Complete Node.js Developer Course - Udemy</a>
            <a href="https://www.udemy.com/course/expressjs-framework/" target="_blank" class="resource-link">Express.js Framework - Udemy</a>
            <a href="https://www.codecademy.com/learn/learn-node-js" target="_blank" class="resource-link">Learn Node.js - Codecademy</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.pluralsight.com/courses/nodejs-fundamentals" target="_blank" class="resource-link">Node.js Fundamentals - Pluralsight</a>
            ...
            <a href="https://www.coursera.org/specializations/web-applications-nodejs" target="_blank" class="resource-link">Web Applications with Node.js - Coursera</a>
    --></div>
    </div>
