...
<head>
    ...
    <title>Skill Route - Java Collections Framework</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Java Collections Framework</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://www.javatpoint.com/collections-in-java" target="_blank" class="resource-link">Java Collections Overview - JavaTpoint</a>
            <a href="https://www.geeksforgeeks.org/collections-in-java-2/" target="_blank" class="resource-link">Introduction to Collections - GeeksforGeeks</a>
            <a href="https://www.tutorialspoint.com/java/java_collections.htm" target="_blank" class="resource-link">Java Collections Framework - TutorialsPoint</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://www.baeldung.com/java-collections" target="_blank" class="resource-link">Advanced Java Collections - Baeldung</a>
            <a href="https://docs.oracle.com/javase/8/docs/technotes/guides/collections/index.html" target="_blank" class="resource-link">Java Collections Framework Documentation - Oracle</a>
        --></div>
        ...
        <div id="videos" class="slider-section" style="display: none;">
            ...
            <a href="https://www.youtube.com/watch?v=e9lR8QIlhGA" target="_blank" class="resource-link">Java Collections for Beginners - Telusko</a>
            <a href="https://www.youtube.com/watch?v=USjZcfj8yxE" target="_blank" class="resource-link">Java Collections Tutorial - CodeWithHarry</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=GFc2tNtCUXI" target="_blank" class="resource-link">Mastering Java Collections - CodeAcademy</a>
            <a href="https://www.youtube.com/watch?v=fzFpq5MO26E" target="_blank" class="resource-link">Performance of Collections - freeCodeCamp</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/java-collections-framework/" target="_blank" class="resource-link">Java Collections Framework - Udemy</a>
            <a href="https://www.coursera.org/learn/java-programming" target="_blank" class="resource-link">Java Programming and Collections - Coursera</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.udemy.com/course/advanced-java-collections-framework/" target="_blank" class="resource-link">Advanced Java Collections - Udemy</a>
            <a href="https://www.linkedin.com/learning/java-collections-performance-tips-and-tricks" target="_blank" class="resource-link">Performance Tips for Collections - LinkedIn Learning</a>
        --></div>
    </div>
