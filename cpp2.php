...
<body>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://www.geeksforgeeks.org/object-oriented-programming-in-cpp/" target="_blank" class="resource-link">OOP in C++ - GeeksforGeeks</a>
            <a href="https://cplusplus.com/doc/tutorial/classes/" target="_blank" class="resource-link">Classes and Objects - Cplusplus.com</a>
            <a href="https://www.programiz.com/cpp-programming/object-oriented-programming" target="_blank" class="resource-link">Object-Oriented Programming in C++ - Programiz</a>
            
            <div class="section-title">FOR ADVANCED</div>
            <a href="https://isocpp.org/wiki/faq/oop-concepts" target="_blank" class="resource-link">Advanced OOP Concepts - ISO C++</a>
            <a href="https://www.learncpp.com/cpp-tutorial/" target="_blank" class="resource-link">Advanced Topics in OOP - LearnCpp</a>
            <a href="https://www.udemy.com/course/master-object-oriented-programming-in-c/" target="_blank" class="resource-link">Master OOP in C++ - Udemy</a>
        --></div>
 ...
 <?php
     foreach ($vadvanceLinks as $name => $url) {
         ...
         ';
            ...
            <a href="https://www.youtube.com/watch?v=xV_-u5V0sqU" target="_blank" class="resource-link">Introduction to OOP in C++ - Programming with Mosh</a>
            <a href="https://www.youtube.com/watch?v=QM1iUe6IofM" target="_blank" class="resource-link">Learn OOP in C++ - CodeWithHarry</a>
            <a href="https://www.youtube.com/watch?v=sWWay7lEM8k" target="_blank" class="resource-link">C++ OOP Basics - The Cherno</a>
            
            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=ZOgCuxZsd68" target="_blank" class="resource-link">Advanced OOP in C++ - The Net Ninja</a>
            <a href="https://www.youtube.com/watch?v=sHZboYwI_U4" target="_blank" class="resource-link">Deep Dive into OOP - Simplilearn</a>
            <a href="https://www.youtube.com/watch?v=JhvF0U5RoD0" target="_blank" class="resource-link">C++ Polymorphism and Inheritance - FreeCodeCamp</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/cpp-oop-beginners-guide/" target="_blank" class="resource-link">OOP in C++ for Beginners - Udemy</a>
            <a href="https://www.coursera.org/learn/cpp-oop-basics" target="_blank" class="resource-link">Basics of OOP in C++ - Coursera</a>
            <a href="https://www.codecademy.com/learn/learn-c-plus-plus" target="_blank" class="resource-link">Learn C++ and OOP - Codecademy</a>
            
            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.udemy.com/course/mastering-oop-in-cpp/" target="_blank" class="resource-link">Mastering OOP in C++ - Udemy</a>
            <a href="https://frontendmasters.com/courses/oop-in-cpp/" target="_blank" class="resource-link">OOP Masterclass in C++ - Frontend Masters</a>
            <a href="https://www.edx.org/course/cplusplus-oop-techniques" target="_blank" class="resource-link">Advanced OOP in C++ - edX</a>
        --></div>
    </div>
