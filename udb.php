...
<head>
    ...
    <title>Skill Route - Databases</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Understand Databases</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
           <!-- <div class="section-title">FOR BEGINNERS</div>
            <a href="https://dev.mysql.com/doc/" target="_blank" class="resource-link">MySQL Official Documentation</a>
            <a href="https://www.postgresql.org/docs/" target="_blank" class="resource-link">PostgreSQL Official Documentation</a>
            <a href="https://www.mongodb.com/docs/" target="_blank" class="resource-link">MongoDB Official Documentation</a>
            
            <div class="section-title">FOR ADVANCED</div>
            <a href="https://dev.mysql.com/doc/refman/8.0/en/optimization.html" target="_blank" class="resource-link">MySQL Optimization Guide</a>
            <a href="https://www.postgresql.org/docs/current/performance-tips.html" target="_blank" class="resource-link">PostgreSQL Performance Tips</a>
            <a href="https://www.mongodb.com/docs/manual/aggregation/" target="_blank" class="resource-link">MongoDB Aggregation Framework</a>
        --> </div>
        ...
        <div id="videos" class="slider-section" style="display: none;">
            ...
            <a href="https://www.youtube.com/watch?v=7S_tz1z_5bA" target="_blank" class="resource-link">MySQL Tutorial for Beginners - Programming with Mosh</a>
            <a href="https://www.youtube.com/watch?v=qw--VYLpxG4" target="_blank" class="resource-link">PostgreSQL Tutorial - Traversy Media</a>
            <a href="https://www.youtube.com/watch?v=ofme2o29ngU" target="_blank" class="resource-link">MongoDB Tutorial for Beginners - Amigoscode</a>
            
            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=r2EKjU91RDI" target="_blank" class="resource-link">MySQL Performance Optimization</a>
            <a href="https://www.youtube.com/watch?v=sQuqSQIx4rk" target="_blank" class="resource-link">PostgreSQL Advanced Queries</a>
            <a href="https://www.youtube.com/watch?v=bwCX6MCosWQ" target="_blank" class="resource-link">Advanced MongoDB Aggregations</a>
        --> </div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
          ...
          <!--  <div class="section-title">Course Resources for Beginners</div>
            <a href="https://www.udemy.com/course/mysql-database-for-beginners/" target="_blank" class="resource-link">MySQL for Beginners - Udemy</a>
            <a href="https://www.udemy.com/course/postgresql-for-everyone/" target="_blank" class="resource-link">PostgreSQL for Everyone - Udemy</a>
            <a href="https://www.udemy.com/course/mongodb-the-complete-developers-guide/" target="_blank" class="resource-link">MongoDB Complete Guide - Udemy</a>
            
            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.udemy.com/course/mysql-performance-tuning/" target="_blank" class="resource-link">MySQL Performance Tuning - Udemy</a>
            <a href="https://frontendmasters.com/courses/databases/" target="_blank" class="resource-link">Advanced PostgreSQL - Frontend Masters</a>
            <a href="https://www.udemy.com/course/mongodb-advanced/" target="_blank" class="resource-link">Advanced MongoDB - Udemy</a>
        -->  </div>
    </div>
