...
<head>
    ...
    <title>Skill Route - Deployment</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Deployment</div>
...
?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://kotlinlang.org/docs/deployment.html" target="_blank" class="resource-link">Kotlin Docs - Application Deployment</a>
            <a href="https://medium.com/@androiddevelopers/deploying-kotlin-backend-applications-fd1f6820ed0" target="_blank" class="resource-link">Medium - Kotlin Backend Deployment</a>
            <a href="https://firebase.google.com/docs/android/setup" target="_blank" class="resource-link">Firebase - Android App Deployment</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://aws.amazon.com/blogs/developer/deploying-kotlin-applications-on-aws/" target="_blank" class="resource-link">AWS - Kotlin Cloud Deployment</a>
            <a href="https://dev.to/ryanhall/build-and-deploy-kotlin-apps-on-heroku-3g76" target="_blank" class="resource-link">Dev.to - Deploying Kotlin on Heroku</a>
            <a href="https://www.jetbrains.com/help/teamcity/deployment-of-kotlin-applications.html" target="_blank" class="resource-link">JetBrains - Deployment Using TeamCity</a>
        --></div>
        ...
        <div id="videos" class="slider-section" style="display: none;">
            ...
            <a href="https://www.youtube.com/watch?v=LN8ecKU9DsY" target="_blank" class="resource-link">YouTube - Kotlin Android Deployment</a>
            <a href="https://www.youtube.com/watch?v=vQRG8bz9fFQ" target="_blank" class="resource-link">YouTube - Deploying Kotlin Apps on Firebase</a>
            <a href="https://www.youtube.com/watch?v=Yk0J8WMCVhQ" target="_blank" class="resource-link">YouTube - Basics of Cloud Deployment</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=IvNlZ1_NndU" target="_blank" class="resource-link">YouTube - Kotlin on AWS</a>
            <a href="https://www.youtube.com/watch?v=MR5kFOQmK_A" target="_blank" class="resource-link">YouTube - Kotlin Heroku Deployment</a>
            <a href="https://www.youtube.com/watch?v=5cmV-l8RlsA" target="_blank" class="resource-link">YouTube - Advanced Cloud Deployment</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/kotlin-android-app-deployment/" target="_blank" class="resource-link">Udemy - Android Deployment</a>
            <a href="https://pluralsight.com/courses/kotlin-backend-deployment" target="_blank" class="resource-link">Pluralsight - Backend Deployment</a>
            <a href="https://www.coursera.org/learn/cloud-deployment-kotlin" target="_blank" class="resource-link">Coursera - Cloud Deployment</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.udemy.com/course/advanced-kotlin-deployment/" target="_blank" class="resource-link">Udemy - Advanced Kotlin Deployment</a>
            <a href="https://www.linkedin.com/learning/kotlin-deployment-advanced/" target="_blank" class="resource-link">LinkedIn Learning - Deployment</a>
            <a href="https://teamtreehouse.com/library/advanced-kotlin-deployment" target="_blank" class="resource-link">Treehouse - Advanced Deployment</a>
        --></div>
    </div>
