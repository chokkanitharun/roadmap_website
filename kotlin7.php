...
<head>
    ...
    <title>Skill Route - Exception Handling</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Exception Handling</div>
...
?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://www.journaldev.com/1754/java-exception-handling" target="_blank" class="resource-link">JournalDev - Exception Handling in Java</a>
            ...
            <a href="https://www.baeldung.com/java/exception-handling" target="_blank" class="resource-link">Baeldung - Java Exception Handling</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://www.codeproject.com/Articles/321374/Advanced-Exception-Handling-in-Java" target="_blank" class="resource-link">CodeProject - Advanced Exception Handling in Java</a>
            <a href="https://dilfuruz.com/advanced-exception-handling-in-java/" target="_blank" class="resource-link">Dilfuruz - Advanced Exception Handling in Java</a>
            <a href="https://www.codingbat.com/java/exception-handling" target="_blank" class="resource-link">CodingBat - Exception Handling Practice</a>
        --></div>
        ...
        <div id="videos" class="slider-section" style="display: none;">
            ...
            <a href="https://www.youtube.com/watch?v=8Th3kGrzmZ0" target="_blank" class="resource-link">Java Exception Handling - Basics</a>
            <a href="https://www.youtube.com/watch?v=7auT6EvXwvE" target="_blank" class="resource-link">Exception Handling in Java</a>
            <a href="https://www.youtube.com/watch?v=-L5Xo3g0GFQ" target="_blank" class="resource-link">Understanding Exceptions in Java</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=VdQgAgTaUuE" target="_blank" class="resource-link">Advanced Exception Handling in Java</a>
            <a href="https://www.youtube.com/watch?v=au11X4W8PEQ" target="_blank" class="resource-link">Handling Complex Exceptions in Java</a>
            <a href="https://www.youtube.com/watch?v=-k_yzK40hW8" target="_blank" class="resource-link">Exception Handling with Custom Exceptions</a>
        --> </div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/exception-handling-in-java/" target="_blank" class="resource-link">Udemy - Exception Handling in Java</a>
            ...
            <a href="https://www.udemy.com/course/java-advanced/" target="_blank" class="resource-link">Udemy - Java Advanced</a>
            <a href="https://www.pluralsight.com/courses/advanced-java-programming" target="_blank" class="resource-link">Pluralsight - Advanced Java Programming</a>
            <a href="https://www.coursera.org/learn/advanced-java" target="_blank" class="resource-link">Coursera - Advanced Java</a>
        --></div>
    </div>
