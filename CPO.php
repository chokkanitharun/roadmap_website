...
<head>
    ...
    <title>Skill Route - Caching & Performance Optimization</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Caching and Performance Optimization</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://www.geeksforgeeks.org/introduction-to-redis/" target="_blank" class="resource-link">Introduction to Redis - GeeksforGeeks</a>
            <a href="https://www.tutorialspoint.com/memcached/index.htm" target="_blank" class="resource-link">Memcached Basics - TutorialsPoint</a>
            <a href="https://developer.mozilla.org/en-US/docs/Web/Performance" target="_blank" class="resource-link">Web Performance Basics - MDN</a>
            
            <div class="section-title">FOR ADVANCED</div>
            <a href="https://redis.io/docs/" target="_blank" class="resource-link">Redis Documentation</a>
            <a href="https://aws.amazon.com/caching/" target="_blank" class="resource-link">AWS Caching Strategies</a>
            <a href="https://www.linkedin.com/learning/backend-performance-optimization" target="_blank" class="resource-link">Backend Performance Optimization - LinkedIn Learning</a>
        --></div>
        ...
        <div id="videos" class="slider-section" style="display: none;">
            ...
            <a href="https://www.youtube.com/watch?v=nwb8R-1AYyY" target="_blank" class="resource-link">What is Caching? - TechPrimer</a>
            <a href="https://www.youtube.com/watch?v=rY74boFH8Rs" target="_blank" class="resource-link">Redis Basics - Simplilearn</a>
            <a href="https://www.youtube.com/watch?v=UCn5yMTy2-o" target="_blank" class="resource-link">Website Performance Optimization - FreeCodeCamp</a>
            
            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=k6-zYEBQ-bU" target="_blank" class="resource-link">Redis for High Performance - TechWorld</a>
            <a href="https://www.youtube.com/watch?v=yLfpgRzqAGs" target="_blank" class="resource-link">Optimizing API Performance - edureka!</a>
            <a href="https://www.youtube.com/watch?v=8f0WbSGgKro" target="_blank" class="resource-link">Server-Side Optimization Techniques - GCP Training</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/redis-microservices/" target="_blank" class="resource-link">Redis for Microservices - Udemy</a>
            <a href="https://www.pluralsight.com/courses/caching-performance" target="_blank" class="resource-link">Caching & Performance - Pluralsight</a>
            <a href="https://www.coursera.org/learn/website-performance-optimization" target="_blank" class="resource-link">Website Performance Optimization - Coursera</a>
            
            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://frontendmasters.com/courses/web-performance/" target="_blank" class="resource-link">Advanced Web Performance - Frontend Masters</a>
            <a href="https://www.udemy.com/course/performance-optimization-for-backend-services/" target="_blank" class="resource-link">Performance Optimization for Backend - Udemy</a>
            <a href="https://www.edx.org/course/high-performance-backend-architectures" target="_blank" class="resource-link">High-Performance Backend Architectures - edX</a>
        --></div>
    </div>
