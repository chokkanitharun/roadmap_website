...
<head>
    ...
    <title>Skill Route - HTML & CSS Basics</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">HTML & CSS Basics</div>
        <div class="header-icons">
            <img src="https://cdn.vectorstock.com/i/1000v/14/04/home-icon-vector-20131404.jpg" alt="Close" onclick="closePage()">
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://developer.mozilla.org/en-US/docs/Learn/Getting_started_with_the_web/HTML_basics" target="_blank" class="resource-link">MDN - HTML Basics</a>
            <a href="https://developer.mozilla.org/en-US/docs/Learn/CSS/First_steps" target="_blank" class="resource-link">MDN - CSS Basics</a>
            <a href="https://www.w3schools.com/html/html_intro.asp" target="_blank" class="resource-link">W3Schools - HTML Introduction</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://www.freecodecamp.org/news/html-and-css-tutorial/" target="_blank" class="resource-link">FreeCodeCamp - Advanced HTML & CSS</a>
            <a href="https://css-tricks.com/snippets/" target="_blank" class="resource-link">CSS Tricks - Code Snippets</a>
            <a href="https://frontendmasters.com/books/front-end-handbook/2019/" target="_blank" class="resource-link">Frontend Masters - Advanced CSS Concepts</a>
        --></div>
 ...
 <?php
     foreach ($vadvanceLinks as $name => $url) {
         ...
         ';
            ...
            <a href="https://www.youtube.com/watch?v=UB1O30fR-EE" target="_blank" class="resource-link">YouTube - HTML Full Course</a>
            <a href="https://www.youtube.com/watch?v=1Rs2ND1ryYc" target="_blank" class="resource-link">YouTube - CSS Full Course</a>
            <a href="https://www.youtube.com/watch?v=mU6anWqZJcc" target="_blank" class="resource-link">YouTube - HTML & CSS for Beginners</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=3tECvNYx3Sg" target="_blank" class="resource-link">YouTube - Advanced CSS Tricks</a>
            <a href="https://www.youtube.com/watch?v=1PnVor36_40" target="_blank" class="resource-link">YouTube - Flexbox and Grid Mastery</a>
            <a href="https://www.youtube.com/watch?v=8Zf6bM8IJdQ" target="_blank" class="resource-link">YouTube - Building Responsive Websites</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/html-css-web-development-for-beginners/" target="_blank" class="resource-link">Udemy - HTML & CSS for Beginners</a>
            <a href="https://www.coursera.org/learn/html-css-javascript-for-web-developers" target="_blank" class="resource-link">Coursera - HTML & CSS Basics</a>
            <a href="https://www.codecademy.com/learn/learn-html" target="_blank" class="resource-link">Codecademy - Learn HTML</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://frontendmasters.com/courses/css-grids-flexbox/" target="_blank" class="resource-link">Frontend Masters - CSS Grids & Flexbox</a>
            <a href="https://www.pluralsight.com/courses/advanced-html-css" target="_blank" class="resource-link">Pluralsight - Advanced HTML & CSS</a>
            <a href="https://www.linkedin.com/learning/html-and-css-advanced-techniques" target="_blank" class="resource-link">LinkedIn Learning - HTML & CSS Advanced Techniques</a>
        --></div>
    </div>
