...
<head>
    ...
    <title>Skill Route - Asynchronous JavaScript</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Asynchronous JavaScript</div>
...
?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://developer.mozilla.org/en-US/docs/Learn/JavaScript/Asynchronous" target="_blank" class="resource-link">Asynchronous JavaScript - MDN</a>
            <a href="https://www.w3schools.com/js/js_async.asp" target="_blank" class="resource-link">JavaScript Async - W3Schools</a>
            <a href="https://javascript.info/async" target="_blank" class="resource-link">Understanding Asynchronous JavaScript - JavaScript.info</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://www.smashingmagazine.com/2020/11/guide-fetch-api/" target="_blank" class="resource-link">Fetch API Guide</a>
            <a href="https://blog.bitsrc.io/mastering-async-await-in-javascript-37a5c5e4f914" target="_blank" class="resource-link">Mastering Async/Await</a>
    --></div>
    ...
    ?>
            ...
            <a href="https://www.youtube.com/watch?v=PoRJizFvM7s" target="_blank" class="resource-link">Understanding Promises - Academind</a>
            <a href="https://www.youtube.com/watch?v=V_Kr9OSfDeU" target="_blank" class="resource-link">Async/Await in JavaScript - Web Dev Simplified</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=cuEtnrL9-H0" target="_blank" class="resource-link">Advanced Fetch and Async Concepts</a>
            <a href="https://www.youtube.com/watch?v=DWgXKRCFMEU" target="_blank" class="resource-link">Using Axios for API Calls</a>
    --></div>
...
?>
            ...
            <a href="https://www.udemy.com/course/javascript-the-complete-guide/" target="_blank" class="resource-link">JavaScript Asynchronous Concepts - Udemy</a>
            <a href="https://scrimba.com/learn/learnjavascript" target="_blank" class="resource-link">Learn Asynchronous JavaScript - Scrimba</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://frontendmasters.com/courses/asynchronous-javascript/" target="_blank" class="resource-link">Asynchronous JavaScript Deep Dive - Frontend Masters</a>
            <a href="https://www.pluralsight.com/courses/javascript-promises-async-programming" target="_blank" class="resource-link">JavaScript Promises and Async Programming - Pluralsight</a>
    --></div>
    </div>
