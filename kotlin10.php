...
<head>
    ...
    <title>Skill Route - Networking and APIs</title>
    <style>
...
?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://www.geeksforgeeks.org/retrofit-library-in-android/" target="_blank" class="resource-link">GeeksforGeeks - Retrofit Library in Android</a>
            <a href="https://www.raywenderlich.com/10962274-networking-on-android-with-retrofit" target="_blank" class="resource-link">RayWenderlich - Networking with Retrofit</a>
            <a href="https://ktor.io/docs/getting-started.html" target="_blank" class="resource-link">Ktor - Getting Started Guide</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://square.github.io/retrofit/" target="_blank" class="resource-link">Retrofit Documentation</a>
            <a href="https://ktor.io/docs/request.html" target="_blank" class="resource-link">Ktor - Request Handling</a>
            <a href="https://medium.com/swlh/advanced-retrofit-techniques-c2a7614c354f" target="_blank" class="resource-link">Medium - Advanced Retrofit Techniques</a>
        --></div>
        ...
        <div id="videos" class="slider-section" style="display: none;">
           ...
           <!-- <div class="section-title">Video Resources for Beginners</div>
            <a href="https://www.youtube.com/watch?v=4JGvDUlfk7Y" target="_blank" class="resource-link">YouTube - Retrofit Tutorial for Beginners</a>
            <a href="https://www.youtube.com/watch?v=0j2R3X2UlIU" target="_blank" class="resource-link">YouTube - REST API Calls with Retrofit</a>
            <a href="https://www.youtube.com/watch?v=ETBdGh0FOzw" target="_blank" class="resource-link">YouTube - Introduction to Ktor</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=e5_i2lOPhzo" target="_blank" class="resource-link">YouTube - Advanced Retrofit Techniques</a>
            <a href="https://www.youtube.com/watch?v=n7XtCkAHEYE" target="_blank" class="resource-link">YouTube - Building APIs with Ktor</a>
            <a href="https://www.youtube.com/watch?v=5R1OEKpPiV4" target="_blank" class="resource-link">YouTube - Advanced Networking with Kotlin</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/retrofit-android-tutorial/" target="_blank" class="resource-link">Udemy - Retrofit Android Tutorial</a>
            <a href="https://www.coursera.org/learn/android-programming" target="_blank" class="resource-link">Coursera - Android Programming with Kotlin</a>
            <a href="https://developer.android.com/courses/pathways/android-networking" target="_blank" class="resource-link">Google - Android Networking Pathway</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.udemy.com/course/android-networking/" target="_blank" class="resource-link">Udemy - Advanced Networking in Android</a>
            <a href="https://ktor.io/docs/getting-started.html" target="_blank" class="resource-link">Ktor - Advanced API Development</a>
            <a href="https://pluralsight.com/courses/android-retrofit-fundamentals" target="_blank" class="resource-link">Pluralsight - Retrofit Fundamentals</a>
        --></div>
    </div>
