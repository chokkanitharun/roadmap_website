...
?>
            <!--<a href="https://kotlinlang.org/docs/classes.html" target="_blank" class="resource-link">Kotlin Official - Classes and Objects</a>
            <a href="https://www.geeksforgeeks.org/oop-concepts-in-kotlin/" target="_blank" class="resource-link">GeeksforGeeks - OOP in Kotlin</a>
            <a href="https://www.javatpoint.com/kotlin-oops-concepts" target="_blank" class="resource-link">JavaTPoint - OOP Concepts in Kotlin</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://www.udemy.com/course/advanced-kotlin-programming/" target="_blank" class="resource-link">Udemy - Advanced Kotlin OOP</a>
            <a href="https://medium.com/kotlin/kotlin-and-object-oriented-programming-e87c7881f53a" target="_blank" class="resource-link">Medium - Kotlin and OOP</a>
            <a href="https://proandroiddev.com/object-oriented-programming-in-kotlin-tips-and-best-practices-5f3f4a8937e3" target="_blank" class="resource-link">ProAndroidDev - Kotlin OOP Best Practices</a>
        --></div>
        ...
        <div id="videos" class="slider-section" style="display: none;">
            ...
            <a href="https://www.youtube.com/watch?v=hWzOeXUNbzk" target="_blank" class="resource-link">Kotlin OOP Basics - FreeCodeCamp</a>
            <a href="https://www.youtube.com/watch?v=frC6N1o5PjY" target="_blank" class="resource-link">Learn Kotlin OOP Concepts</a>
            <a href="https://www.youtube.com/watch?v=13MBokGFuyk" target="_blank" class="resource-link">Kotlin OOP - Full Tutorial</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=VAn4T69p1-A" target="_blank" class="resource-link">Advanced Kotlin OOP Techniques</a>
            <a href="https://www.youtube.com/watch?v=2g9DK1dHoWc" target="_blank" class="resource-link">Mastering OOP with Kotlin</a>
            <a href="https://www.youtube.com/watch?v=WWeGt1-K5Cg" target="_blank" class="resource-link">Polymorphism and Interfaces in Kotlin</a>
        --></div>
