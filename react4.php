...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">State Management</div>
...
?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://react.dev/learn/state-a-complete-guide" target="_blank" class="resource-link">State: A Complete Guide - React Docs</a>
            <a href="https://blog.logrocket.com/getting-started-with-react-hooks/" target="_blank" class="resource-link">Getting Started with useState Hook - LogRocket</a>
            <a href="https://www.freecodecamp.org/news/state-management-with-usestate-in-react/" target="_blank" class="resource-link">State Management Basics - FreeCodeCamp</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://react.dev/learn/state-management" target="_blank" class="resource-link">Advanced State Management - React Docs</a>
            <a href="https://kentcdodds.com/blog/application-state-management-with-react" target="_blank" class="resource-link">Application State Management - Kent C. Dodds</a>
            <a href="https://www.udemy.com/course/react-hooks-introduction/" target="_blank" class="resource-link">React Hooks Deep Dive - Udemy</a>
    --></div>
    ...
    ?>
            ...
            <a href="https://www.youtube.com/watch?v=O6P86uwfdR0" target="_blank" class="resource-link">React State and useState Hook</a>
            <a href="https://www.youtube.com/watch?v=w7ejDZ8SWv8" target="_blank" class="resource-link">Understanding React State</a>
            <a href="https://www.youtube.com/watch?v=5NnMdlz9vlk" target="_blank" class="resource-link">Managing Component State</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=dpw9EHDh2bM" target="_blank" class="resource-link">Advanced React State Management</a>
            <a href="https://www.youtube.com/watch?v=ZKlXqrcBx88" target="_blank" class="resource-link">Dynamic State in React Applications</a>
            <a href="https://www.youtube.com/watch?v=kb-RQCnT6Eo" target="_blank" class="resource-link">React useState Hook Explained</a>
    --></div>
...
?>
            ...
            <a href="https://frontendmasters.com/courses/react/" target="_blank" class="resource-link">Frontend Masters - React State Management</a>
            <a href="https://www.pluralsight.com/courses/react-redux-es6" target="_blank" class="resource-link">State Management with React - Pluralsight</a>
