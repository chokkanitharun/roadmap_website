...
<head>
    ...
    <title>Skill Route - Standard Template Library (STL)</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Standard Template Library (STL)</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://www.geeksforgeeks.org/the-c-standard-template-library-stl/" target="_blank" class="resource-link">Introduction to STL - GeeksforGeeks</a>
            <a href="https://cplusplus.com/reference/stl/" target="_blank" class="resource-link">STL Reference - Cplusplus.com</a>
            <a href="https://www.programiz.com/cpp-programming/library" target="_blank" class="resource-link">STL Basics - Programiz</a>
            
            <div class="section-title">FOR ADVANCED</div>
            <a href="https://isocpp.org/wiki/faq/stl-algorithms" target="_blank" class="resource-link">Advanced STL Algorithms - ISO C++</a>
            <a href="https://www.learncpp.com/cpp-tutorial/the-standard-template-library/" target="_blank" class="resource-link">Deep Dive into STL - LearnCpp</a>
            <a href="https://www.udemy.com/course/advanced-c-and-stl/" target="_blank" class="resource-link">Master STL - Udemy</a>
        --></div>
 ...
 <?php
     foreach ($vadvanceLinks as $name => $url) {
         ...
         ';
            ...
            <a href="https://www.youtube.com/watch?v=P8P4MzDMMuo" target="_blank" class="resource-link">Introduction to STL - CodeBeauty</a>
            <a href="https://www.youtube.com/watch?v=2olsGf6JIkU" target="_blank" class="resource-link">STL Basics - CodeWithHarry</a>
            <a href="https://www.youtube.com/watch?v=3yCXnpQ0FQ8" target="_blank" class="resource-link">Vectors in STL - The Cherno</a>
            
            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=Qk25hXlyVSk" target="_blank" class="resource-link">Advanced STL Techniques - FreeCodeCamp</a>
            <a href="https://www.youtube.com/watch?v=2q5s5vlxLo4" target="_blank" class="resource-link">STL Algorithms - The Net Ninja</a>
            <a href="https://www.youtube.com/watch?v=xCcpUluWiwI" target="_blank" class="resource-link">Advanced STL Containers - Simplilearn</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/cpp-stl-for-beginners/" target="_blank" class="resource-link">STL for Beginners - Udemy</a>
            <a href="https://www.coursera.org/learn/cpp-stl-basics" target="_blank" class="resource-link">Basics of STL - Coursera</a>
            <a href="https://www.codecademy.com/learn/cplusplus-stl" target="_blank" class="resource-link">Learn STL in C++ - Codecademy</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.udemy.com/course/advanced-stl-in-cpp/" target="_blank" class="resource-link">Advanced STL Techniques - Udemy</a>
            <a href="https://frontendmasters.com/courses/cpp-stl/" target="_blank" class="resource-link">STL Masterclass - Frontend Masters</a>
            <a href="https://www.edx.org/course/advanced-stl-in-cpp" target="_blank" class="resource-link">Advanced STL in C++ - edX</a>
        --></div>
    </div>
