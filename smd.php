...
<head>
    ...
    <title> Server Management & Deployment</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Server Management & Deployment</div>
...
?>
           <!-- <div class="section-title">FOR BEGINNERS</div>
            <a href="https://www.digitalocean.com/community/tutorials" target="_blank" class="resource-link">DigitalOcean Tutorials</a>
            <a href="https://aws.amazon.com/getting-started/" target="_blank" class="resource-link">AWS Getting Started</a>
            <a href="https://devcenter.heroku.com/" target="_blank" class="resource-link">Heroku Developer Center</a>
            
            <div class="section-title">FOR ADVANCED</div>
            <a href="https://aws.amazon.com/architecture/" target="_blank" class="resource-link">AWS Architecture Resources</a>
            <a href="https://www.digitalocean.com/docs/" target="_blank" class="resource-link">DigitalOcean Documentation</a>
            <a href="https://devcenter.heroku.com/articles/best-practices" target="_blank" class="resource-link">Heroku Best Practices</a>
        -->  </div>
        ...
        <div id="videos" class="slider-section" style="display: none;">
          ...
          <!--<div class="section-title">Video Resources for Beginners</div>
            <a href="https://www.youtube.com/watch?v=lZXKFh1bYXI" target="_blank" class="resource-link">AWS Full Course - Simplilearn</a>
            <a href="https://www.youtube.com/watch?v=Q0lfXs2F9fw" target="_blank" class="resource-link">Heroku Deployment Tutorial - Traversy Media</a>
            <a href="https://www.youtube.com/watch?v=bpGLjstWw7k" target="_blank" class="resource-link">DigitalOcean Introduction - Tech With Tim</a>
            
            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=0rsfV-0zN7s" target="_blank" class="resource-link">AWS Advanced Architecting - TechWorld with Nana</a>
            <a href="https://www.youtube.com/watch?v=aP8pTX-B7Uw" target="_blank" class="resource-link">Advanced Heroku Features - Codecademy</a>
            <a href="https://www.youtube.com/watch?v=d2Ob9Cazc5M" target="_blank" class="resource-link">Scaling with DigitalOcean - Fireship</a>
        --> </div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/aws-for-beginners/" target="_blank" class="resource-link">AWS for Beginners - Udemy</a>
            <a href="https://www.udemy.com/course/heroku-for-developers/" target="_blank" class="resource-link">Heroku Deployment - Udemy</a>
            <a href="https://www.udemy.com/course/digitalocean-deployment/" target="_blank" class="resource-link">DigitalOcean Basics - Udemy</a>
            
            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.coursera.org/specializations/aws-cloud-architecture" target="_blank" class="resource-link">AWS Cloud Architecture Specialization - Coursera</a>
            <a href="https://frontendmasters.com/courses/heroku-deployment/" target="_blank" class="resource-link">Advanced Heroku Deployment - Frontend Masters</a>
            <a href="https://www.udemy.com/course/advanced-digitalocean/" target="_blank" class="resource-link">Advanced DigitalOcean - Udemy</a>
        --></div>
    </div>
