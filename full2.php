...
<head>
    ...
    <title>Skill Route - JavaScript Fundamentals</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">JavaScript Fundamentals</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Introduction" target="_blank" class="resource-link">MDN - JavaScript Basics</a>
            <a href="https://www.w3schools.com/js/js_intro.asp" target="_blank" class="resource-link">W3Schools - JavaScript Introduction</a>
            <a href="https://www.freecodecamp.org/news/javascript-basics-for-beginners/" target="_blank" class="resource-link">FreeCodeCamp - JavaScript Basics</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://javascript.info/" target="_blank" class="resource-link">JavaScript.info - Advanced Concepts</a>
            <a href="https://www.freecodecamp.org/news/understanding-javascript-closures/" target="_blank" class="resource-link">FreeCodeCamp - Understanding Closures</a>
            <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Functions" target="_blank" class="resource-link">MDN - Advanced Functions</a>
        --></div>
 ...
 <?php
     foreach ($vadvanceLinks as $name => $url) {
         ...
         ';
            ...
            <a href="https://www.youtube.com/watch?v=W6NZfCO5SIk" target="_blank" class="resource-link">YouTube - JavaScript Full Course</a>
            <a href="https://www.youtube.com/watch?v=hdI2bqOjy3c" target="_blank" class="resource-link">YouTube - JavaScript for Beginners</a>
            <a href="https://www.youtube.com/watch?v=2LeqMNlNyd4" target="_blank" class="resource-link">YouTube - JavaScript Crash Course</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=ylXkAYpdHvQ" target="_blank" class="resource-link">YouTube - Understanding JavaScript Closures</a>
            <a href="https://www.youtube.com/watch?v=Hk1iUDhs5Z8" target="_blank" class="resource-link">YouTube - JavaScript Async/Await</a>
            <a href="https://www.youtube.com/watch?v=R5LQ_Jkz4Dw" target="_blank" class="resource-link">YouTube - Advanced JavaScript Concepts</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/the-complete-javascript-course/" target="_blank" class="resource-link">Udemy - The Complete JavaScript Course</a>
            <a href="https://www.coursera.org/learn/javascript" target="_blank" class="resource-link">Coursera - JavaScript Basics</a>
            <a href="https://www.codecademy.com/learn/introduction-to-javascript" target="_blank" class="resource-link">Codecademy - Introduction to JavaScript</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://frontendmasters.com/courses/javascript-core-2/" target="_blank" class="resource-link">Frontend Masters - JavaScript: The Hard Parts</a>
            <a href="https://www.pluralsight.com/courses/javascript-developer-advanced" target="_blank" class="resource-link">Pluralsight - Advanced JavaScript</a>
            <a href="https://www.linkedin.com/learning/javascript-advanced-concepts-2" target="_blank" class="resource-link">LinkedIn Learning - Advanced JavaScript Concepts</a>
        --></div>
    </div>
