...
<head>
    ...
    <title>Skill Route - Kotlin Basics</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Kotlin Basics</div>
...
?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://kotlinlang.org/docs/reference/basic-syntax.html" target="_blank" class="resource-link">Kotlin Official - Basic Syntax</a>
            <a href="https://www.geeksforgeeks.org/kotlin-programming-language-introduction/" target="_blank" class="resource-link">GeeksforGeeks - Kotlin Basics</a>
            <a href="https://www.tutorialspoint.com/kotlin/index.htm" target="_blank" class="resource-link">TutorialsPoint - Kotlin Basics</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://developer.android.com/kotlin/learn" target="_blank" class="resource-link">Android Developers - Learn Kotlin</a>
            <a href="https://kotlinbyexample.org/" target="_blank" class="resource-link">Kotlin by Example</a>
            <a href="https://kotlinlang.org/docs/kotlin-for-server-side.html" target="_blank" class="resource-link">Kotlin for Server-Side Development</a>
        --></div>
        ...
        <div id="videos" class="slider-section" style="display: none;">
            ...
            <a href="https://www.youtube.com/watch?v=F9UC9DY-vIU" target="_blank" class="resource-link">Kotlin for Beginners - FreeCodeCamp</a>
            <a href="https://www.youtube.com/watch?v=BSM43r4dQdc" target="_blank" class="resource-link">Learn Kotlin in 12 Minutes</a>
            <a href="https://www.youtube.com/watch?v=H_oGi8uuDpA" target="_blank" class="resource-link">Kotlin Full Course - Edureka</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=FeHZHFZXesI" target="_blank" class="resource-link">Advanced Kotlin Programming</a>
            <a href="https://www.youtube.com/watch?v=jjK9diPsrkQ" target="_blank" class="resource-link">Kotlin for Backend Development</a>
            <a href="https://www.youtube.com/watch?v=oUPu4OVYXKs" target="_blank" class="resource-link">Functional Programming in Kotlin</a>
        --></div>
