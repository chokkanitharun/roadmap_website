...
<head>
    ...
    <title>Skill Route - Version Control (Git)</title>
    <style> 
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Version Control (Git)</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://www.git-scm.com/doc" target="_blank" class="resource-link">Git Official Documentation - Basics</a>
            <a href="https://www.atlassian.com/git/tutorials" target="_blank" class="resource-link">Atlassian Git Tutorials</a>
            <a href="https://www.w3schools.com/git/" target="_blank" class="resource-link">W3Schools - Git Basics</a>
            
            <div class="section-title">FOR ADVANCED</div>
            <a href="https://git-scm.com/book/en/v2" target="_blank" class="resource-link">Pro Git Book</a>
            <a href="https://learngitbranching.js.org/" target="_blank" class="resource-link">Learn Git Branching</a>-->
        </div>
        ...
        <div id="videos" class="slider-section" style="display: none;">
            ...
            <a href="https://www.youtube.com/watch?v=HVsySz-h9r4" target="_blank" class="resource-link">Git and GitHub for Beginners - freeCodeCamp</a>
            <a href="https://www.youtube.com/watch?v=USjZcfj8yxE" target="_blank" class="resource-link">Git & GitHub Crash Course - Traversy Media</a>
            
            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=SWYqp7iY_Tc" target="_blank" class="resource-link">Advanced Git Tutorial - freeCodeCamp</a>
            <a href="https://www.youtube.com/watch?v=oPpnCh7InLY" target="_blank" class="resource-link">Git Branching Strategies - Atlassian</a>
        --> </div>
...
?>
            ...
            <a href="https://www.udacity.com/course/version-control-with-git--ud123" target="_blank" class="resource-link">Udacity - Version Control with Git</a>
            <a href="https://www.codecademy.com/learn/learn-git" target="_blank" class="resource-link">Codecademy: Git Fundamentals</a>
            
            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.udemy.com/course/git-complete/" target="_blank" class="resource-link">Git Complete - Udemy</a>
