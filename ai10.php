...
<head>
    ...
    <title>Skill Route - AI Ethics & Responsible AI</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">AI Ethics & Responsible AI</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://www.analyticsvidhya.com/blog/2021/02/understanding-ai-ethics/" target="_blank" class="resource-link">Analytics Vidhya - Understanding AI Ethics</a>
            <a href="https://towardsdatascience.com/a-beginners-guide-to-ai-ethics-36f01c6e7f5e" target="_blank" class="resource-link">Towards Data Science - A Beginner's Guide to AI Ethics</a>
            <a href="https://www.geeksforgeeks.org/ethics-in-ai/" target="_blank" class="resource-link">GeeksforGeeks - Ethics in AI</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://www.cnbc.com/2021/02/23/why-ai-bias-is-a-big-problem-and-how-it-can-be-fixed.html" target="_blank" class="resource-link">CNBC - Why AI Bias is a Big Problem</a>
            <a href="https://www.brookings.edu/research/ai-ethics-and-the-challenges-of-building-responsible-ai/" target="_blank" class="resource-link">Brookings - AI Ethics and Responsible AI</a>
            <a href="https://arxiv.org/abs/1901.09911" target="_blank" class="resource-link">Arxiv - Fairness and Transparency in AI</a>
        --></div>
 ...
 <?php
     foreach ($vadvanceLinks as $name => $url) {
         ...
         ';
            ...
            <a href="https://www.youtube.com/watch?v=b5gxf4VbHdc" target="_blank" class="resource-link">YouTube - Introduction to AI Ethics</a>
            <a href="https://www.youtube.com/watch?v=WW_Uub0IcIo" target="_blank" class="resource-link">YouTube - The Problem of AI Bias</a>
            <a href="https://www.youtube.com/watch?v=Q5nBvGvs-S8" target="_blank" class="resource-link">YouTube - Responsible AI</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=9XfXfSBgsxM" target="_blank" class="resource-link">YouTube - Fairness and Accountability in AI</a>
            <a href="https://www.youtube.com/watch?v=s1-3_9j87nM" target="_blank" class="resource-link">YouTube - Designing Ethical AI Models</a>
            <a href="https://www.youtube.com/watch?v=RVoEg7AizKY" target="_blank" class="resource-link">YouTube - Bias in AI and Solutions</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.coursera.org/learn/ai-ethics" target="_blank" class="resource-link">Coursera - AI Ethics</a>
            <a href="https://www.udemy.com/course/ai-ethics-introduction/" target="_blank" class="resource-link">Udemy - Introduction to AI Ethics</a>
            <a href="https://www.edx.org/course/ethics-in-ai" target="_blank" class="resource-link">edX - Ethics in AI</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.coursera.org/learn/responsible-ai" target="_blank" class="resource-link">Coursera - Responsible AI</a>
            <a href="https://www.udacity.com/course/ai-ethics-nanodegree--nd042" target="_blank" class="resource-link">Udacity - AI Ethics Nanodegree</a>
            <a href="https://www.fast.ai/" target="_blank" class="resource-link">FastAI - Ethics of AI and Machine Learning</a>
        --></div>
    </div>
