...
<body>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
           <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://www.geeksforgeeks.org/file-handling-c/" target="_blank" class="resource-link">File Handling Basics in C++ - GeeksforGeeks</a>
            <a href="https://cplusplus.com/doc/tutorial/files/" target="_blank" class="resource-link">File Streams in C++ - Cplusplus.com</a>
            <a href="https://www.programiz.com/cpp-programming/file-handling" target="_blank" class="resource-link">Introduction to File Handling - Programiz</a>
            
            <div class="section-title">FOR ADVANCED</div>
            <a href="https://isocpp.org/wiki/faq/input-output" target="_blank" class="resource-link">Advanced File Handling - ISO C++</a>
            <a href="https://www.learncpp.com/cpp-tutorial/basic-file-io/" target="_blank" class="resource-link">Advanced File I/O - LearnCpp</a>
            <a href="https://www.udemy.com/course/mastering-file-handling-in-c/" target="_blank" class="resource-link">Master File Handling - Udemy</a>
        --></div>
 ...
 <?php
     foreach ($vadvanceLinks as $name => $url) {
         ...
         ';
            ...
            <a href="https://www.youtube.com/watch?v=OaQKTYz6mSw" target="_blank" class="resource-link">Basics of File Handling in C++ - ProgrammingKnowledge</a>
            <a href="https://www.youtube.com/watch?v=Ij3KtwSq3F4" target="_blank" class="resource-link">File I/O in C++ - CodeWithHarry</a>
            <a href="https://www.youtube.com/watch?v=wJ4cMvIzFqw" target="_blank" class="resource-link">File Streams - The Cherno</a>
            
            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=4HMUtk6dVNU" target="_blank" class="resource-link">Advanced File Handling - FreeCodeCamp</a>
            <a href="https://www.youtube.com/watch?v=fSVL2KyG4BU" target="_blank" class="resource-link">File I/O in Depth - The Net Ninja</a>
            <a href="https://www.youtube.com/watch?v=LLO8WA-7dUE" target="_blank" class="resource-link">Error Handling in File Streams - Simplilearn</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/file-handling-in-cpp-for-beginners/" target="_blank" class="resource-link">File Handling for Beginners - Udemy</a>
            <a href="https://www.coursera.org/learn/cpp-file-handling-basics" target="_blank" class="resource-link">Basics of File Handling - Coursera</a>
            <a href="https://www.codecademy.com/learn/file-handling-cpp" target="_blank" class="resource-link">Learn File Handling in C++ - Codecademy</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.udemy.com/course/advanced-file-handling-in-cpp/" target="_blank" class="resource-link">Advanced File Handling - Udemy</a>
            <a href="https://frontendmasters.com/courses/cpp-file-handling/" target="_blank" class="resource-link">File Handling Masterclass - Frontend Masters</a>
            <a href="https://www.edx.org/course/advanced-file-i-o-in-cpp" target="_blank" class="resource-link">Advanced File I/O in C++ - edX</a>
        --></div>
    </div>
