...
<head>
    ...
    <title>Skill Route - React Router</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">React Router</div>
...
?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://reactrouter.com/en/main" target="_blank" class="resource-link">React Router Documentation</a>
            <a href="https://www.freecodecamp.org/news/react-router-in-depth-71f8297f52ec/" target="_blank" class="resource-link">Understanding React Router - FreeCodeCamp</a>
            <a href="https://www.digitalocean.com/community/tutorials/react-react-router-v6" target="_blank" class="resource-link">React Router V6 - DigitalOcean</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://kentcdodds.com/blog/understanding-react-router" target="_blank" class="resource-link">Advanced React Router - Kent C. Dodds</a>
            <a href="https://reactrouter.com/en/main/routers/creating-routes" target="_blank" class="resource-link">Creating Routes in React Router</a>
            <a href="https://www.udemy.com/course/react-router/" target="_blank" class="resource-link">React Router Course - Udemy</a>
    --></div>
    ...
    ?>
            ...
            <a href="https://www.youtube.com/watch?v=Law7wfdg_ls" target="_blank" class="resource-link">React Router Tutorial for Beginners</a>
            <a href="https://www.youtube.com/watch?v=7VJpxFto-V4" target="_blank" class="resource-link">React Router - A Practical Guide</a>
            <a href="https://www.youtube.com/watch?v=QnxZ9tbLzY4" target="_blank" class="resource-link">React Router V6 - New Features</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=8Ml7kDrD2mY" target="_blank" class="resource-link">Mastering React Router</a>
            <a href="https://www.youtube.com/watch?v=ksfeKMJBrzA" target="_blank" class="resource-link">React Router Deep Dive</a>
            <a href="https://www.youtube.com/watch?v=aXf7sLY6u-0" target="_blank" class="resource-link">React Router and Navigation</a>
    --> </div>
        ...
        <div class="section-title">FOR BEGINNERS</div>
            ...
            <a href="https://www.udemy.com/course/react-the-complete-guide/" target="_blank" class="resource-link">React & Redux - Udemy</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://frontendmasters.com/courses/react-router/" target="_blank" class="resource-link">Frontend Masters - React Router</a>
            <a href="https://www.pluralsight.com/courses/react-redux-es6" target="_blank" class="resource-link">React Router Deep Dive - Pluralsight</a>
