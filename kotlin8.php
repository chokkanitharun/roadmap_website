...
<head>
    ...
    <title>Skill Route - Android Development with Kotlin</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Android Development with Kotlin</div>
...
?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://developer.android.com/kotlin" target="_blank" class="resource-link">Android Developer - Kotlin Overview</a>
            <a href="https://www.tutorialspoint.com/kotlin/kotlin_android_development.htm" target="_blank" class="resource-link">TutorialsPoint - Android Development with Kotlin</a>
            <a href="https://www.journaldev.com/22704/android-development-kotlin" target="_blank" class="resource-link">JournalDev - Kotlin for Android Development</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://www.geeksforgeeks.org/android-kotlin-development/" target="_blank" class="resource-link">GeeksforGeeks - Advanced Android Kotlin Development</a>
            <a href="https://medium.com/@hansdedecker.09/kotlin-for-android-developers-5a2f3c4b1d9f" target="_blank" class="resource-link">Medium - Kotlin for Android Developers</a>
            <a href="https://developer.android.com/guide/components/activities/overview" target="_blank" class="resource-link">Android Developer - Activities Overview</a>
        --></div>
        ...
        <div id="videos" class="slider-section" style="display: none;">
            ...
            <a href="https://www.youtube.com/watch?v=Hxe_RAKfyWU" target="_blank" class="resource-link">Kotlin for Android Development - Beginners Guide</a>
            <a href="https://www.youtube.com/watch?v=Zjdr63V8xSM" target="_blank" class="resource-link">Android Development with Kotlin - Basic Tutorial</a>
            <a href="https://www.youtube.com/watch?v=s3Yw6oQyRt0" target="_blank" class="resource-link">Learn Kotlin for Android - Full Course</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=GUwH2dy9p_0" target="_blank" class="resource-link">Advanced Kotlin for Android Development</a>
            <a href="https://www.youtube.com/watch?v=HfwO5oe20Ho" target="_blank" class="resource-link">Master Android Development with Kotlin</a>
            <a href="https://www.youtube.com/watch?v=fYPlWlqV0gs" target="_blank" class="resource-link">Advanced Kotlin Programming for Android</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/the-complete-kotlin-developer-course/" target="_blank" class="resource-link">Udemy - Complete Kotlin Developer Course</a>
            <a href="https://www.coursera.org/learn/android-app-development" target="_blank" class="resource-link">Coursera - Android App Development for Beginners</a>
            ...
            <a href="https://www.udemy.com/course/advanced-android-app-development-with-kotlin/" target="_blank" class="resource-link">Udemy - Advanced Android App Development with Kotlin</a>
            <a href="https://www.pluralsight.com/courses/kotlin-android-advanced" target="_blank" class="resource-link">Pluralsight - Advanced Kotlin for Android Development</a>
            <a href="https://www.coursera.org/specializations/android-app-development" target="_blank" class="resource-link">Coursera - Android Development Specialization</a>
        --></div>
    </div>
