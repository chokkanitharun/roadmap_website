...
<head>
    ...
    <title>Skill Route - Lifecycle Methods and useEffect</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Lifecycle Methods and useEffect</div>
...
?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://react.dev/learn/state-and-lifecycle" target="_blank" class="resource-link">State and Lifecycle - React Docs</a>
            <a href="https://reactjs.org/docs/hooks-effect.html" target="_blank" class="resource-link">Using the Effect Hook - React Docs</a>
            <a href="https://www.freecodecamp.org/news/a-complete-guide-to-useeffect-in-react/" target="_blank" class="resource-link">Complete Guide to useEffect - FreeCodeCamp</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://kentcdodds.com/blog/how-to-use-reacts-effect-hook" target="_blank" class="resource-link">How to Use React’s Effect Hook - Kent C. Dodds</a>
            <a href="https://www.telerik.com/blogs/react-lifecycle-methods-and-hooks" target="_blank" class="resource-link">React Lifecycle Methods and Hooks - Telerik</a>
            <a href="https://www.udemy.com/course/react-redux/" target="_blank" class="resource-link">React & Redux Deep Dive - Udemy</a>
    --></div>
    ...
    ?>
            ...
            <a href="https://www.youtube.com/watch?v=9JUsRU-JD8A" target="_blank" class="resource-link">React Lifecycle Methods Explained</a>
            <a href="https://www.youtube.com/watch?v=E8fUFPJw4nE" target="_blank" class="resource-link">useEffect Hook in React</a>
            <a href="https://www.youtube.com/watch?v=48dZYUuZTb0" target="_blank" class="resource-link">Mastering React useEffect</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=O4owDlf_aC4" target="_blank" class="resource-link">Advanced useEffect Patterns</a>
            <a href="https://www.youtube.com/watch?v=n0X8qfWLv9A" target="_blank" class="resource-link">React Component Lifecycle Deep Dive</a>
            <a href="https://www.youtube.com/watch?v=mZm7v4O9keQ" target="_blank" class="resource-link">Managing Side Effects in React</a>
    --></div>
...
?>
            ...
            <a href="https://scrimba.com/learn/learnreact" target="_blank" class="resource-link">Scrimba React Course</a>
            <a href="https://www.codecademy.com/learn/react-101" target="_blank" class="resource-link">Codecademy React Basics</a>
            <a href="https://www.udemy.com/course/react-the-complete-guide/" target="_blank" class="resource-link">React Basics - Udemy</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://frontendmasters.com/courses/react/" target="_blank" class="resource-link">Frontend Masters - React Lifecycle</a>
            <a href="https://www.pluralsight.com/courses/react-redux-es6" target="_blank" class="resource-link">React Lifecycle Methods and useEffect - Pluralsight</a>
            <a href="https://www.coursera.org/learn/front-end-react" target="_blank" class="resource-link">Full-Stack Development with React - Coursera</a>
    --></div>
    </div>
