...
<head>
    ...
    <title>Skill Route - Version Control with Git</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Version Control with Git</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://git-scm.com/book/en/v2" target="_blank" class="resource-link">Pro Git Book</a>
            <a href="https://www.atlassian.com/git/tutorials" target="_blank" class="resource-link">Atlassian Git Tutorials</a>
            <a href="https://www.digitalocean.com/community/tutorials/an-intuitive-guide-to-git" target="_blank" class="resource-link">DigitalOcean - Git Basics</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://www.git-scm.com/docs" target="_blank" class="resource-link">Git Documentation</a>
            <a href="https://www.tutorialspoint.com/git/git-advanced-commands.htm" target="_blank" class="resource-link">TutorialsPoint - Advanced Git Commands</a>
            <a href="https://opensource.com/article/19/11/git-submodules" target="_blank" class="resource-link">Git Submodules - OpenSource</a>
        --></div>
 ...
 <?php
     foreach ($vadvanceLinks as $name => $url) {
         ...
         ';
            ...
            <a href="https://www.youtube.com/watch?v=8oR7o5k_bFw" target="_blank" class="resource-link">YouTube - Git for Beginners</a>
            <a href="https://www.youtube.com/watch?v=SWYqp7iY_Tc" target="_blank" class="resource-link">YouTube - Git & GitHub Tutorial for Beginners</a>
            <a href="https://www.youtube.com/watch?v=RGOj5yH7o5M" target="_blank" class="resource-link">YouTube - Learn Git in 20 Minutes</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=1ffBJ4sVUb4" target="_blank" class="resource-link">YouTube - Advanced Git Features</a>
            <a href="https://www.youtube.com/watch?v=pr8lK_p9AEs" target="_blank" class="resource-link">YouTube - Git Submodules</a>
            <a href="https://www.youtube.com/watch?v=GhJJFniDdH0" target="_blank" class="resource-link">YouTube - Git Flow and Advanced Workflow</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/git-started-with-git/" target="_blank" class="resource-link">Udemy - Git Started With Git</a>
            <a href="https://www.coursera.org/learn/introduction-to-git" target="_blank" class="resource-link">Coursera - Introduction to Git</a>
            <a href="https://www.codecademy.com/learn/learn-git" target="_blank" class="resource-link">Codecademy - Learn Git</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.pluralsight.com/courses/git-advanced-usage" target="_blank" class="resource-link">Pluralsight - Advanced Git Usage</a>
            <a href="https://frontendmasters.com/courses/git/" target="_blank" class="resource-link">Frontend Masters - Git Fundamentals</a>
            <a href="https://www.linkedin.com/learning/git-essential-training" target="_blank" class="resource-link">LinkedIn Learning - Git Essential Training</a>
        --></div>
    </div>
