...
<head>
    ...
    <title>Skill Route - Authentication & Authorization</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Authentication and Authorization</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://jwt.io/introduction/" target="_blank" class="resource-link">Introduction to JWT</a>
            <a href="https://auth0.com/docs" target="_blank" class="resource-link">Auth0 Documentation</a>
            <a href="https://www.owasp.org/index.php/Authentication_Cheat_Sheet" target="_blank" class="resource-link">OWASP Authentication Cheat Sheet</a>
            
            <div class="section-title">FOR ADVANCED</div>
            <a href="https://tools.ietf.org/html/rfc6749" target="_blank" class="resource-link">OAuth 2.0 Framework</a>
            <a href="https://www.npmjs.com/package/bcrypt" target="_blank" class="resource-link">Bcrypt for Secure Password Storage</a>
            <a href="https://spring.io/guides/tutorials/spring-security-and-oauth2/" target="_blank" class="resource-link">Spring Security & OAuth2</a>
        --> </div>
        ...
        <div id="videos" class="slider-section" style="display: none;">
            ...
            <a href="https://www.youtube.com/watch?v=7Q17ubqLfaM" target="_blank" class="resource-link">JWT Authentication - Simplilearn</a>
            <a href="https://www.youtube.com/watch?v=CPbvxxslDTU" target="_blank" class="resource-link">OAuth 2.0 - Traversy Media</a>
            <a href="https://www.youtube.com/watch?v=I0qdr6PkD8A" target="_blank" class="resource-link">Password Security with Bcrypt - Tech With Tim</a>
            
            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=996OiexHze0" target="_blank" class="resource-link">Spring Security & OAuth - Amigoscode</a>
            <a href="https://www.youtube.com/watch?v=3pZ3Nh8tgTE" target="_blank" class="resource-link">Deep Dive into JWT - Fireship</a>
            <a href="https://www.youtube.com/watch?v=iLCaIVoWCE0" target="_blank" class="resource-link">Advanced Password Security - FreeCodeCamp</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/authentication-authorization-for-beginners/" target="_blank" class="resource-link">Authentication for Beginners - Udemy</a>
            <a href="https://www.udemy.com/course/oauth-2-jwt/" target="_blank" class="resource-link">OAuth 2.0 and JWT Basics - Udemy</a>
            <a href="https://www.pluralsight.com/courses/security-fundamentals" target="_blank" class="resource-link">Security Fundamentals - Pluralsight</a>
            
            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.coursera.org/learn/secure-coding-practices" target="_blank" class="resource-link">Secure Coding Practices - Coursera</a>
            <a href="https://frontendmasters.com/courses/web-security/" target="_blank" class="resource-link">Advanced Web Security - Frontend Masters</a>
            <a href="https://www.udemy.com/course/secure-api-development/" target="_blank" class="resource-link">Secure API Development - Udemy</a>
        --></div>
    </div>
