...
<head>
    ...
    <title>Skill Route - Control Flow</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Control Flow</div>
...
?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://kotlinlang.org/docs/control-flow.html" target="_blank" class="resource-link">Kotlin Official - Control Flow</a>
            <a href="https://www.javatpoint.com/kotlin-control-flow" target="_blank" class="resource-link">JavaTPoint - Control Flow in Kotlin</a>
            <a href="https://www.geeksforgeeks.org/kotlin-control-flow/" target="_blank" class="resource-link">GeeksforGeeks - Control Flow</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://kotlinlang.org/docs/reference/control-structures.html" target="_blank" class="resource-link">Kotlin Advanced - Control Structures</a>
            <a href="https://medium.com/@kotlin/control-flow-in-kotlin-advanced-implementations-d2a14582f9ea" target="_blank" class="resource-link">Medium - Advanced Control Flow in Kotlin</a>
            <a href="https://www.udemy.com/course/kotlin-programming/" target="_blank" class="resource-link">Udemy - Advanced Kotlin Programming</a>
        --></div>
        ...
        <div id="videos" class="slider-section" style="display: none;">
            ...
            <a href="https://www.youtube.com/watch?v=zOjov-2OZ0E" target="_blank" class="resource-link">Kotlin Control Flow - FreeCodeCamp</a>
            <a href="https://www.youtube.com/watch?v=hzQUlCO2mR8" target="_blank" class="resource-link">Learn Kotlin Loops & Conditionals</a>
            <a href="https://www.youtube.com/watch?v=GSsTAAQk93Q" target="_blank" class="resource-link">Kotlin for Beginners - Control Flow</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=5_F1FgTHy-Y" target="_blank" class="resource-link">Advanced Kotlin - Control Flow Techniques</a>
            <a href="https://www.youtube.com/watch?v=WYmFouYSX4U" target="_blank" class="resource-link">Kotlin Range and When Statement</a>
            <a href="https://www.youtube.com/watch?v=3KT1SHgHjrM" target="_blank" class="resource-link">Mastering Kotlin Control Flow</a>
        --> </div>
