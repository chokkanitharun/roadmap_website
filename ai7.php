...
<head>
    ...
    <title>Skill Route - Natural Language Processing (NLP)</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Natural Language Processing (NLP)</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://www.analyticsvidhya.com/blog/2020/07/natural-language-processing-nlp/" target="_blank" class="resource-link">Analytics Vidhya - Introduction to NLP</a>
            <a href="https://towardsdatascience.com/natural-language-processing-for-beginners-83b2bffb28c3" target="_blank" class="resource-link">Towards Data Science - NLP Basics</a>
            <a href="https://realpython.com/natural-language-processing-spacy-python/" target="_blank" class="resource-link">Real Python - NLP with SpaCy</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://jalammar.github.io/illustrated-word2vec/" target="_blank" class="resource-link">Jalammar - Illustrated Word2Vec</a>
            <a href="https://arxiv.org/abs/1810.04805" target="_blank" class="resource-link">Arxiv - BERT Explained</a>
            <a href="https://huggingface.co/transformers/" target="_blank" class="resource-link">Hugging Face - Transformers</a>
        --></div>
 ...
 <?php
     foreach ($vadvanceLinks as $name => $url) {
         ...
         ';
            ...
            <a href="https://www.youtube.com/watch?v=9y4H1EQ8O_s" target="_blank" class="resource-link">YouTube - NLP Basics</a>
            <a href="https://www.youtube.com/watch?v=pfB6M1an5g8" target="_blank" class="resource-link">YouTube - Tokenization and Text Processing</a>
            <a href="https://www.youtube.com/watch?v=QXZ1KJtENwI" target="_blank" class="resource-link">YouTube - Sentiment Analysis</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=fjT2YW0mP3g" target="_blank" class="resource-link">YouTube - Word Embeddings Explained</a>
            <a href="https://www.youtube.com/watch?v=8hly31xKli0" target="_blank" class="resource-link">YouTube - Transformers and BERT</a>
            <a href="https://www.youtube.com/watch?v=8uRU7cKlI4o" target="_blank" class="resource-link">YouTube - NLP with Hugging Face</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.coursera.org/learn/classification-vector-spaces-in-nlp" target="_blank" class="resource-link">Coursera - Classification & NLP Basics</a>
            <a href="https://www.udemy.com/course/natural-language-processing-with-python/" target="_blank" class="resource-link">Udemy - NLP with Python</a>
            <a href="https://www.datacamp.com/courses/natural-language-processing-fundamentals-in-python" target="_blank" class="resource-link">DataCamp - NLP Fundamentals</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.udacity.com/course/natural-language-processing-nanodegree--nd892" target="_blank" class="resource-link">Udacity - NLP Nanodegree</a>
            <a href="https://www.edx.org/course/applied-natural-language-processing" target="_blank" class="resource-link">edX - Applied NLP</a>
            <a href="https://www.kaggle.com/learn/natural-language-processing" target="_blank" class="resource-link">Kaggle - NLP Learning Path</a>
        --></div>
    </div>
