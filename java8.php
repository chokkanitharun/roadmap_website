...
<head>
    ...
    <title>Skill Route - Spring Framework</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Spring Framework</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://spring.io/" target="_blank" class="resource-link">Spring Framework - Official Site</a>
            <a href="https://www.baeldung.com/spring-tutorial" target="_blank" class="resource-link">Spring Framework Basics - Baeldung</a>
            <a href="https://www.javatpoint.com/spring-tutorial" target="_blank" class="resource-link">Spring Tutorial - JavaTpoint</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://spring.io/guides" target="_blank" class="resource-link">Spring Guides - Official</a>
            <a href="https://www.geeksforgeeks.org/spring-framework/" target="_blank" class="resource-link">Advanced Spring Concepts - GeeksforGeeks</a>
        --></div>
        ...
        <div id="videos" class="slider-section" style="display: none;">
            ...
            <a href="https://www.youtube.com/watch?v=vtPkZShrvXQ" target="_blank" class="resource-link">Spring Framework Tutorial - Telusko</a>
            <a href="https://www.youtube.com/watch?v=5UBUNsP2uU4" target="_blank" class="resource-link">Spring Boot Basics - Amigoscode</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=-qdnK2RHB7M" target="_blank" class="resource-link">Advanced Spring Framework - Java Brains</a>
            <a href="https://www.youtube.com/watch?v=xk-lUJPXfvA" target="_blank" class="resource-link">REST API with Spring Boot - freeCodeCamp</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/spring-framework-tutorial-for-beginners/" target="_blank" class="resource-link">Spring Framework for Beginners - Udemy</a>
            <a href="https://www.coursera.org/learn/spring-framework" target="_blank" class="resource-link">Spring Framework Basics - Coursera</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.udemy.com/course/spring-boot-microservices-and-restful-web-services/" target="_blank" class="resource-link">Spring Boot and Microservices - Udemy</a>
            <a href="https://www.pluralsight.com/courses/spring-framework-2" target="_blank" class="resource-link">Mastering Spring Framework - Pluralsight</a>
        --></div>
    </div>
