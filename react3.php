...
<head>
    ...
    <title>Skill Route - Components and Props</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Components and Props</div>
...
?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://react.dev/learn/your-first-component" target="_blank" class="resource-link">Your First Component - React Docs</a>
            <a href="https://www.freecodecamp.org/news/react-props-cheatsheet/" target="_blank" class="resource-link">React Props Cheat Sheet - FreeCodeCamp</a>
            <a href="https://blog.logrocket.com/getting-started-with-react-components/" target="_blank" class="resource-link">Getting Started with React Components - LogRocket</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://reactjs.org/docs/components-and-props.html" target="_blank" class="resource-link">React Components and Props - Official Docs</a>
            <a href="https://www.codecademy.com/articles/react-components-interactivity" target="_blank" class="resource-link">Component Interactivity - Codecademy</a>
            <a href="https://www.udemy.com/course/react-the-complete-guide/" target="_blank" class="resource-link">React Deep Dive - Udemy</a>
    --></div>
    ...
    ?>
            ...
            <a href="https://www.youtube.com/watch?v=w7ejDZ8SWv8" target="_blank" class="resource-link">React JS - Components and Props</a>
            <a href="https://www.youtube.com/watch?v=pnhO8UaCgxg" target="_blank" class="resource-link">Understanding React Props - Programming with Mosh</a>
            <a href="https://www.youtube.com/watch?v=Ke90Tje7VS0" target="_blank" class="resource-link">React Components Basics</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=yCnY2Av1K1w" target="_blank" class="resource-link">React Props Advanced Usage</a>
            <a href="https://www.youtube.com/watch?v=nTeuhbP7wdE" target="_blank" class="resource-link">React Functional vs Class Components</a>
            <a href="https://www.youtube.com/watch?v=iiADhChRriM" target="_blank" class="resource-link">Building Dynamic Components</a>
    --> </div>
...
?>
            ...
            <a href="https://frontendmasters.com/courses/react/" target="_blank" class="resource-link">Frontend Masters - React Components</a>
            <a href="https://www.pluralsight.com/courses/react-redux-es6" target="_blank" class="resource-link">Advanced React Components - Pluralsight</a>
