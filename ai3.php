...
<head>
    ...
    <title>Skill Route - Data Collection & Preprocessing</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Data Collection & Preprocessing</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://towardsdatascience.com/data-preprocessing-for-machine-learning-3a5b43f6f48c" target="_blank" class="resource-link">Towards Data Science - Data Preprocessing</a>
            <a href="https://www.analyticsvidhya.com/blog/2021/10/data-cleaning-techniques-you-should-know/" target="_blank" class="resource-link">Analytics Vidhya - Data Cleaning Techniques</a>
            <a href="https://scikit-learn.org/stable/modules/preprocessing.html" target="_blank" class="resource-link">Scikit-learn - Preprocessing Guide</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://www.coursera.org/learn/feature-engineering" target="_blank" class="resource-link">Coursera - Feature Engineering</a>
            <a href="https://www.kaggle.com/learn/data-cleaning" target="_blank" class="resource-link">Kaggle - Data Cleaning</a>
            <a href="https://towardsdatascience.com/data-normalization-in-machine-learning-395fdec69d02" target="_blank" class="resource-link">Towards Data Science - Data Normalization</a>
        --></div>
 ...
 <?php
     foreach ($vadvanceLinks as $name => $url) {
         ...
         ';
            ...
            <a href="https://www.youtube.com/watch?v=4z8lrTVdS1k" target="_blank" class="resource-link">YouTube - Data Cleaning in Python</a>
            <a href="https://www.youtube.com/watch?v=wAupRGRA8d0" target="_blank" class="resource-link">YouTube - Missing Data Handling</a>
            <a href="https://www.youtube.com/watch?v=VwVg9jCtqaU" target="_blank" class="resource-link">YouTube - Introduction to Data Preprocessing</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=OIo-DIOkNVg" target="_blank" class="resource-link">YouTube - Feature Engineering Tips</a>
            <a href="https://www.youtube.com/watch?v=gg6ntJQN5KA" target="_blank" class="resource-link">YouTube - Data Transformation Techniques</a>
            <a href="https://www.youtube.com/watch?v=pO6vBVtA6Rk" target="_blank" class="resource-link">YouTube - Advanced Data Cleaning</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.datacamp.com/courses/data-manipulation-with-pandas" target="_blank" class="resource-link">DataCamp - Data Manipulation with Pandas</a>
            <a href="https://www.coursera.org/learn/python-data-analysis" target="_blank" class="resource-link">Coursera - Python for Data Analysis</a>
            <a href="https://www.udemy.com/course/data-preprocessing-machine-learning/" target="_blank" class="resource-link">Udemy - Data Preprocessing for ML</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.edx.org/course/data-cleaning" target="_blank" class="resource-link">edX - Data Cleaning Course</a>
            <a href="https://www.coursera.org/learn/data-preparation-machine-learning" target="_blank" class="resource-link">Coursera - Data Preparation for ML</a>
            <a href="https://pluralsight.com/courses/cleaning-data-python" target="_blank" class="resource-link">Pluralsight - Cleaning Data with Python</a>
        --></div>
    </div>
