...
<head>
    ...
    <title>Skill Route - Java Streams & Lambda Expressions</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Java Streams & Lambda Expressions</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://www.baeldung.com/java-8-streams" target="_blank" class="resource-link">Introduction to Java Streams - Baeldung</a>
            <a href="https://www.javatpoint.com/java-8-stream" target="_blank" class="resource-link">Java 8 Stream Tutorial - JavaTpoint</a>
            <a href="https://www.tutorialspoint.com/java8/java8_lambda_expressions.htm" target="_blank" class="resource-link">Lambda Expressions in Java - TutorialsPoint</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://docs.oracle.com/javase/tutorial/collections/streams/" target="_blank" class="resource-link">Streams and Collections - Oracle Docs</a>
            <a href="https://www.geeksforgeeks.org/lambda-expressions-java-8/" target="_blank" class="resource-link">Advanced Lambda Expressions - GeeksforGeeks</a>
        --></div>
        ...
        <div id="videos" class="slider-section" style="display: none;">
            ...
            <a href="https://www.youtube.com/watch?v=t1-YZ6bF-g0" target="_blank" class="resource-link">Java Streams Basics - Amigoscode</a>
            <a href="https://www.youtube.com/watch?v=hcT8HxXIhts" target="_blank" class="resource-link">Lambda Expressions for Beginners - Telusko</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=1OpAgZvYXLQ" target="_blank" class="resource-link">Advanced Java Streams and Lambda - ProgrammingKnowledge</a>
            <a href="https://www.youtube.com/watch?v=MzV_oj6d8Bk" target="_blank" class="resource-link">Functional Programming in Java - freeCodeCamp</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/java-streams-api-tutorial/" target="_blank" class="resource-link">Java Streams API Tutorial - Udemy</a>
            <a href="https://www.coursera.org/learn/functional-programming-java" target="_blank" class="resource-link">Functional Programming in Java - Coursera</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.udemy.com/course/master-java-streams-and-lambdas/" target="_blank" class="resource-link">Mastering Java Streams and Lambdas - Udemy</a>
            <a href="https://www.pluralsight.com/courses/java-streams-lambda-expressions" target="_blank" class="resource-link">Java Streams & Lambda Expressions - Pluralsight</a>
        --></div>
    </div>
