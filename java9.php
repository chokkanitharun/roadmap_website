...
<head>
    ...
    <title>Skill Route - Database Access (JDBC/Hibernate)</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Database Access (JDBC/Hibernate)</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://docs.oracle.com/javase/tutorial/jdbc/" target="_blank" class="resource-link">JDBC Basics - Official Documentation</a>
            <a href="https://hibernate.org/" target="_blank" class="resource-link">Hibernate Official Documentation</a>
            <a href="https://www.javatpoint.com/jdbc-tutorial" target="_blank" class="resource-link">JDBC Tutorial - JavaTpoint</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://www.baeldung.com/hibernate-5" target="_blank" class="resource-link">Advanced Hibernate Concepts - Baeldung</a>
            <a href="https://www.geeksforgeeks.org/jdbc-vs-hibernate-in-java/" target="_blank" class="resource-link">JDBC vs Hibernate - GeeksforGeeks</a>
        --></div>
        ...
        <div id="videos" class="slider-section" style="display: none;">
            ...
            <a href="https://www.youtube.com/watch?v=2oL3FvV_fYc" target="_blank" class="resource-link">JDBC Basics Tutorial - Telusko</a>
            <a href="https://www.youtube.com/watch?v=sNdQZ8_gYPw" target="_blank" class="resource-link">Hibernate Basics - Amigoscode</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=GZ4d3HEmfpQ" target="_blank" class="resource-link">Advanced JDBC Tutorial</a>
            <a href="https://www.youtube.com/watch?v=EyTRrJvjqN8" target="_blank" class="resource-link">Advanced Hibernate Concepts</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/jdbc-tutorial-for-beginners/" target="_blank" class="resource-link">JDBC for Beginners - Udemy</a>
            <a href="https://www.coursera.org/learn/hibernate-java" target="_blank" class="resource-link">Hibernate Basics - Coursera</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.udemy.com/course/hibernate-advanced-concepts/" target="_blank" class="resource-link">Hibernate Advanced Concepts - Udemy</a>
            <a href="https://www.pluralsight.com/courses/hibernate" target="_blank" class="resource-link">Mastering Hibernate - Pluralsight</a>
        --></div>
    </div>
