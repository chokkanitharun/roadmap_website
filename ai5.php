...
<head>
    ...
    <title>Skill Route - Deep Learning & Neural Networks</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Deep Learning & Neural Networks</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://towardsdatascience.com/intro-to-deep-learning-3e65e515deeb" target="_blank" class="resource-link">Towards Data Science - Intro to Deep Learning</a>
            <a href="https://machinelearningmastery.com/what-is-deep-learning/" target="_blank" class="resource-link">Machine Learning Mastery - What is Deep Learning?</a>
            ...
            <a href="https://deepmind.com/learning-resources" target="_blank" class="resource-link">DeepMind - Learning Resources</a>
        --></div>
 ...
 <?php
     foreach ($vadvanceLinks as $name => $url) {
         ...
         ';
            ...
            <a href="https://www.youtube.com/watch?v=aircAruvnKk" target="_blank" class="resource-link">YouTube - Neural Networks Explained</a>
            <a href="https://www.youtube.com/watch?v=PySo_6S4ZAg" target="_blank" class="resource-link">YouTube - Introduction to TensorFlow</a>
            <a href="https://www.youtube.com/watch?v=_mFITB-nuo4" target="_blank" class="resource-link">YouTube - Deep Learning Basics</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=8oOgPUO-TBY" target="_blank" class="resource-link">YouTube - PyTorch for Beginners</a>
            <a href="https://www.youtube.com/watch?v=BrMLP2RzPzE" target="_blank" class="resource-link">YouTube - TensorFlow Advanced</a>
            <a href="https://www.youtube.com/watch?v=-z0D1a5E5_Y" target="_blank" class="resource-link">YouTube - Backpropagation Explained</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.coursera.org/learn/neural-networks-deep-learning" target="_blank" class="resource-link">Coursera - Neural Networks and Deep Learning</a>
            <a href="https://www.udacity.com/course/intro-to-tensorflow-for-deep-learning--ud187" target="_blank" class="resource-link">Udacity - Intro to TensorFlow</a>
            <a href="https://www.datacamp.com/courses/deep-learning-in-python" target="_blank" class="resource-link">DataCamp - Deep Learning in Python</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.udemy.com/course/deep-learning-a-z/" target="_blank" class="resource-link">Udemy - Deep Learning A-Z</a>
            <a href="https://www.edx.org/professional-certificate/mitx-deep-learning" target="_blank" class="resource-link">edX - MIT Deep Learning</a>
            <a href="https://pluralsight.com/courses/deep-learning" target="_blank" class="resource-link">Pluralsight - Deep Learning</a>
        --></div>
    </div>
