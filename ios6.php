...
<body>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://developer.apple.com/documentation/coredata/" target="_blank" class="resource-link">Core Data Basics - Apple Docs</a>
            <a href="https://www.hackingwithswift.com/read/12/1/saving-simple-data-userdefaults" target="_blank" class="resource-link">Saving Data with UserDefaults - Hacking with Swift</a>
            <a href="https://www.raywenderlich.com/145809/beginning-ios-persistence-tutorial" target="_blank" class="resource-link">iOS Data Persistence Guide - Ray Wenderlich</a>
            
            <div class="section-title">FOR ADVANCED</div>
            <a href="https://www.hackingwithswift.com/books/ios-swiftui/persisting-complex-data-with-core-data" target="_blank" class="resource-link">Complex Data with Core Data - Hacking with Swift</a>
            <a href="https://developer.apple.com/documentation/foundation/filemanager" target="_blank" class="resource-link">File Management in iOS - Apple Docs</a>
        --></div>
 ...
 <?php
     foreach ($vadvanceLinks as $name => $url) {
         ...
         ';
            ...
            <a href="https://www.youtube.com/watch?v=lWujXQeaY8s" target="_blank" class="resource-link">Core Data Basics - CodeWithChris</a>
            <a href="https://www.youtube.com/watch?v=joIV8FQhOEA" target="_blank" class="resource-link">UserDefaults Tutorial - iOS Academy</a>
            
            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=uwH5NAvr4Zw" target="_blank" class="resource-link">Mastering Core Data - Sean Allen</a>
            <a href="https://www.youtube.com/watch?v=zvO9P3LxDbE" target="_blank" class="resource-link">File Management in iOS - CodeWithChris</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/ios-data-persistence/" target="_blank" class="resource-link">iOS Data Persistence for Beginners - Udemy</a>
            <a href="https://www.coursera.org/learn/app-design-development" target="_blank" class="resource-link">Core Data and Persistence - Coursera</a>
            <a href="https://www.edx.org/course/introduction-to-ios-app-development" target="_blank" class="resource-link">iOS Persistence Basics - edX</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.udacity.com/course/ios-persistence-nanodegree--nd001" target="_blank" class="resource-link">Advanced iOS Persistence - Udacity</a>
            <a href="https://www.pluralsight.com/courses/ios-data-persistence" target="_blank" class="resource-link">Mastering Data Persistence - Pluralsight</a>
            <a href="https://www.lynda.com/Swift-tutorials/iOS-Core-Data-Persistence/191825-2.html" target="_blank" class="resource-link">Core Data Advanced Concepts - Lynda</a>
        --></div>
    </div>
