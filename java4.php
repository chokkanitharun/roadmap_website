...
<body>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://www.javatpoint.com/exception-handling-in-java" target="_blank" class="resource-link">Exception Handling in Java - JavaTpoint</a>
            <a href="https://www.geeksforgeeks.org/exception-handling-in-java/" target="_blank" class="resource-link">Introduction to Exception Handling - GeeksforGeeks</a>
            <a href="https://www.tutorialspoint.com/java/java_exceptions.htm" target="_blank" class="resource-link">Java Exceptions - TutorialsPoint</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://www.baeldung.com/java-exceptions" target="_blank" class="resource-link">Advanced Exception Handling - Baeldung</a>
            <a href="https://docs.oracle.com/javase/tutorial/essential/exceptions/" target="_blank" class="resource-link">Java Exception Tutorial - Oracle</a>
        --></div>
        ...
        <div id="videos" class="slider-section" style="display: none;">
            ...
            <a href="https://www.youtube.com/watch?v=5AzzVzGcPfE" target="_blank" class="resource-link">Java Exception Handling Basics - CodeWithHarry</a>
            <a href="https://www.youtube.com/watch?v=PV7vms7xMXM" target="_blank" class="resource-link">Exception Handling Tutorial - Telusko</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=uwtjz4b4kR8" target="_blank" class="resource-link">Advanced Exception Handling - freeCodeCamp</a>
            <a href="https://www.youtube.com/watch?v=yVfl5oXr3Z4" target="_blank" class="resource-link">Custom Exceptions in Java - TechLead</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/java-exceptions/" target="_blank" class="resource-link">Java Exceptions for Beginners - Udemy</a>
            <a href="https://www.coursera.org/learn/java-programming" target="_blank" class="resource-link">Java Programming: Handling Exceptions - Coursera</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.udemy.com/course/advanced-java-exceptions/" target="_blank" class="resource-link">Advanced Exception Handling in Java - Udemy</a>
            <a href="https://www.linkedin.com/learning/exception-handling-in-java" target="_blank" class="resource-link">Java Exception Handling Tips - LinkedIn Learning</a>
        --></div>
    </div>
