...
<head>
    ...
    <title>Skill Route - Frameworks & Libraries</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Frameworks and Libraries</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://expressjs.com/en/starter/hello-world.html" target="_blank" class="resource-link">Getting Started with Express</a>
            <a href="https://www.freecodecamp.org/news/introduction-to-node-and-express/" target="_blank" class="resource-link">Intro to Node.js and Express</a>
            <a href="https://www.tutorialspoint.com/expressjs/index.htm" target="_blank" class="resource-link">Express.js Tutorials - TutorialsPoint</a>
            
            <div class="section-title">FOR ADVANCED</div>
            <a href="https://expressjs.com/en/advanced/best-practice-performance.html" target="_blank" class="resource-link">Best Practices with Express.js</a>
            <a href="https://nodejs.dev/en/learn/advanced-express-js-concepts/" target="_blank" class="resource-link">Advanced Express.js Concepts</a>
            <a href="https://www.linkedin.com/learning/express-essential-training" target="_blank" class="resource-link">Express Essential Training - LinkedIn</a>
        --> </div>
        ...
        <div id="videos" class="slider-section" style="display: none;">
            ...
            <a href="https://www.youtube.com/watch?v=gnsO8-xJ8rs" target="_blank" class="resource-link">Learn Express.js in 30 Minutes - Web Dev Simplified</a>
            <a href="https://www.youtube.com/watch?v=Oe421EPjeBE" target="_blank" class="resource-link">Node.js & Express Basics - Traversy Media</a>
            <a href="https://www.youtube.com/watch?v=L72fhGm1tfE" target="_blank" class="resource-link">Express.js Crash Course - Academind</a>
            
            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=8S8joIq-jrM" target="_blank" class="resource-link">Advanced Node.js & Express Patterns</a>
            <a href="https://www.youtube.com/watch?v=b2HgOMpW_Mo" target="_blank" class="resource-link">Authentication with Express.js - CodeWithHarry</a>
            <a href="https://www.youtube.com/watch?v=QhPztUZVUAM" target="_blank" class="resource-link">Optimizing Express for Performance - TechWorld</a>
        -->  </div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/nodejs-express-mongodb-bootcamp/" target="_blank" class="resource-link">Node.js, Express & MongoDB Bootcamp - Udemy</a>
            <a href="https://www.pluralsight.com/courses/express-nodejs-web-application" target="_blank" class="resource-link">Express Web Application Development - Pluralsight</a>
            <a href="https://www.coursera.org/learn/server-side-nodejs" target="_blank" class="resource-link">Server-Side Development with Node.js - Coursera</a>
            
            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://frontendmasters.com/courses/advanced-node-js/" target="_blank" class="resource-link">Advanced Node.js - Frontend Masters</a>
            <a href="https://www.udemy.com/course/building-restful-apis-with-nodejs-and-express/" target="_blank" class="resource-link">RESTful APIs with Express - Udemy</a>
            <a href="https://egghead.io/courses/building-and-deploying-express-applications" target="_blank" class="resource-link">Building and Deploying Express Apps - Egghead.io</a>
        --></div>
    </div>
