...
<head>
    ...
    <title>Skill Route - SwiftUI Basics</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">SwiftUI Basics</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://developer.apple.com/documentation/swiftui/" target="_blank" class="resource-link">Official SwiftUI Documentation</a>
            <a href="https://www.raywenderlich.com/ios" target="_blank" class="resource-link">Ray Wenderlich - SwiftUI Tutorials</a>
            <a href="https://www.udemy.com/course/ios-12-and-swift-5-0/" target="_blank" class="resource-link">Learn SwiftUI with Swift - Udemy</a>
            
            <div class="section-title">FOR ADVANCED</div>
            <a href="https://www.hackingwithswift.com/100/swiftui" target="_blank" class="resource-link">Advanced SwiftUI Tutorials - Hacking with Swift</a>
            <a href="https://developer.apple.com/documentation/swiftui/colour" target="_blank" class="resource-link">Advanced SwiftUI Documentation</a>
        --></div>
 ...
 <?php
     foreach ($vadvanceLinks as $name => $url) {
         ...
         ';
            ...
            <a href="https://www.youtube.com/watch?v=E4sMIi3XYQo" target="_blank" class="resource-link">SwiftUI Basics - CodeWithChris</a>
            <a href="https://www.youtube.com/watch?v=5smzz0TxDOI" target="_blank" class="resource-link">SwiftUI Fundamentals - iOS Academy</a>
            
            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=3AkcM7ATVxw" target="_blank" class="resource-link">Mastering SwiftUI - iOS Academy</a>
            <a href="https://www.youtube.com/watch?v=GJ-LyyZ7_Jk" target="_blank" class="resource-link">Advanced SwiftUI Techniques - Sean Allen</a>
        --> </div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
           ...
           <!-- <div class="section-title">Course Resources for Beginners</div>
            <a href="https://www.udemy.com/course/swiftui-masterclass/" target="_blank" class="resource-link">SwiftUI Masterclass - Udemy</a>
            <a href="https://www.coursera.org/learn/swiftui" target="_blank" class="resource-link">SwiftUI for Beginners - Coursera</a>
            <a href="https://www.edx.org/course/swift-programming-language" target="_blank" class="resource-link">Swift Programming Language - edX</a>
            ...
            <a href="https://www.pluralsight.com/courses/swift-advanced-topics" target="_blank" class="resource-link">Advanced Swift Topics - Pluralsight</a>
            <a href="https://www.lynda.com/Swift-tutorials/Swift-Advanced-Topics/170085-2.html" target="_blank" class="resource-link">Advanced Swift Topics - Lynda</a>
        --></div>
    </div>
