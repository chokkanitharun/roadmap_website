...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Testing & Debugging</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            <a href="https://reactjs.org/docs/testing.html" target="_blank" class="resource-link">React Testing Documentation</a>
            <a href="https://nodejs.dev/learn/debugging-nodejs" target="_blank" class="resource-link">Debugging in Node.js</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://testing-library.com/docs/" target="_blank" class="resource-link">React Testing Library Docs</a>
            <a href="https://developer.chrome.com/docs/devtools/" target="_blank" class="resource-link">Chrome DevTools Guide</a>
            <a href="https://mochajs.org/" target="_blank" class="resource-link">Mocha - Test Framework</a>
        --></div>
 ...
 <?php
     foreach ($vadvanceLinks as $name => $url) {
         ...
         ';
            ...
            <a href="https://www.youtube.com/watch?v=jAUMS5I5ugo" target="_blank" class="resource-link">YouTube - Jest for Beginners</a>
            <a href="https://www.youtube.com/watch?v=_HttC5LNEI0" target="_blank" class="resource-link">YouTube - Debugging in Chrome DevTools</a>
            <a href="https://www.youtube.com/watch?v=5P_CMRR7K3g" target="_blank" class="resource-link">YouTube - React Testing with Jest</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=WrAekex9qks" target="_blank" class="resource-link">YouTube - Mocha Advanced Testing</a>
            <a href="https://www.youtube.com/watch?v=WBnDLk_L5Ko" target="_blank" class="resource-link">YouTube - Node.js Debugging Tips</a>
            <a href="https://www.youtube.com/watch?v=2rkEbc2EuDs" target="_blank" class="resource-link">YouTube - End-to-End Testing with Cypress</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/testing-react-with-jest/" target="_blank" class="resource-link">Udemy - Testing React with Jest</a>
            <a href="https://frontendmasters.com/courses/debugging/" target="_blank" class="resource-link">Frontend Masters - Debugging Techniques</a>
            <a href="https://www.pluralsight.com/courses/testing-javascript-applications" target="_blank" class="resource-link">Pluralsight - Testing JavaScript Applications</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.coursera.org/learn/software-testing" target="_blank" class="resource-link">Coursera - Advanced Software Testing</a>
            <a href="https://www.edx.org/course/debugging-and-troubleshooting" target="_blank" class="resource-link">edX - Debugging and Troubleshooting</a>
            <a href="https://www.codecademy.com/learn/react-testing" target="_blank" class="resource-link">Codecademy - React Testing</a>
        --></div>
    </div>
