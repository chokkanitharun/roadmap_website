...
<head>
    ...
    <title>Skill Route - Error Handling and Debugging</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Error Handling and Debugging</div>
...
?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Control_flow_and_error_handling" target="_blank" class="resource-link">Error Handling - MDN</a>
            <a href="https://www.w3schools.com/js/js_errors.asp" target="_blank" class="resource-link">JavaScript Error Handling - W3Schools</a>
            <a href="https://javascript.info/try-catch" target="_blank" class="resource-link">Try...Catch in JavaScript - JavaScript.info</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://blog.logrocket.com/debugging-javascript-applications/" target="_blank" class="resource-link">Debugging JavaScript Applications</a>
            <a href="https://rollbar.com/guides/javascript/" target="_blank" class="resource-link">Comprehensive Error Tracking - Rollbar</a>
    --></div>
    ...
    ?>
            ...
            <a href="https://www.youtube.com/watch?v=H0XScE08hy8" target="_blank" class="resource-link">Error Handling Basics - Programming with Mosh</a>
            <a href="https://www.youtube.com/watch?v=1D4FDTPU-pE" target="_blank" class="resource-link">Debugging JavaScript - The Net Ninja</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=9UAjGpgOdrE" target="_blank" class="resource-link">Advanced Debugging Techniques</a>
            <a href="https://www.youtube.com/watch?v=f7MlOYmgEKo" target="_blank" class="resource-link">Error Tracking with Sentry</a>
    --></div>
...
?>
            ...
            <a href="https://www.udemy.com/course/javascript-debugging-and-error-handling/" target="_blank" class="resource-link">JavaScript Debugging - Udemy</a>
            <a href="https://scrimba.com/learn/errorhandling" target="_blank" class="resource-link">Error Handling in JavaScript - Scrimba</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://frontendmasters.com/courses/debugging-javascript/" target="_blank" class="resource-link">Debugging JavaScript - Frontend Masters</a>
            <a href="https://www.pluralsight.com/courses/javascript-error-handling" target="_blank" class="resource-link">JavaScript Error Handling - Pluralsight</a>
    --></div>
    </div>
