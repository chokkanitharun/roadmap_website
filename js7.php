...
<head>
    ...
    <title>Skill Route - JavaScript Frameworks</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">JavaScript Frameworks</div>
...
?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://reactjs.org/docs/getting-started.html" target="_blank" class="resource-link">Getting Started with React</a>
            <a href="https://vuejs.org/guide/introduction.html" target="_blank" class="resource-link">Vue.js Guide</a>
            <a href="https://angular.io/start" target="_blank" class="resource-link">Angular Getting Started</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://react.dev/learn" target="_blank" class="resource-link">React Advanced Concepts</a>
            <a href="https://router.vuejs.org/" target="_blank" class="resource-link">Vue Router</a>
            <a href="https://angular.io/guide/advanced" target="_blank" class="resource-link">Advanced Angular Features</a>
    --></div>
    ...
    ?>
            ...
            <a href="https://www.youtube.com/watch?v=Ke90Tje7VS0" target="_blank" class="resource-link">React Tutorial for Beginners</a>
            <a href="https://www.youtube.com/watch?v=4deVCNJq3qc" target="_blank" class="resource-link">Vue.js 3 Crash Course</a>
            <a href="https://www.youtube.com/watch?v=3qBXWUpoPHo" target="_blank" class="resource-link">Angular Tutorial for Beginners</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=Law7wfdg_ls" target="_blank" class="resource-link">React Advanced Patterns</a>
            <a href="https://www.youtube.com/watch?v=FXpIoQ_rT_c" target="_blank" class="resource-link">Vue.js Advanced Tutorial</a>
            <a href="https://www.youtube.com/watch?v=foh5H_UduLM" target="_blank" class="resource-link">Advanced Angular Concepts</a>
    --></div>
...
?>
            ...
            <a href="https://www.udemy.com/course/react-the-complete-guide-incl-redux/" target="_blank" class="resource-link">React Complete Guide - Udemy</a>
            <a href="https://www.udemy.com/course/vuejs-2-the-complete-guide/" target="_blank" class="resource-link">Vue.js Complete Guide - Udemy</a>
            <a href="https://www.udemy.com/course/the-complete-guide-to-angular-2/" target="_blank" class="resource-link">Angular Complete Guide - Udemy</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://frontendmasters.com/courses/complete-react-v8/" target="_blank" class="resource-link">Complete React v8 - Frontend Masters</a>
            <a href="https://www.pluralsight.com/courses/vue-js-advanced" target="_blank" class="resource-link">Advanced Vue.js - Pluralsight</a>
            <a href="https://www.pluralsight.com/courses/angular-architecture-advanced" target="_blank" class="resource-link">Angular Advanced Concepts - Pluralsight</a>
    --></div>
    </div>
