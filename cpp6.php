...
<head>
    ...
    <title>Skill Route - Advanced C++ Features</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Advanced Cpp Features</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://www.geeksforgeeks.org/c11-smart-pointers/" target="_blank" class="resource-link">Smart Pointers in C++ - GeeksforGeeks</a>
            <a href="https://cplusplus.com/doc/tutorial/lambda/" target="_blank" class="resource-link">Lambda Expressions - Cplusplus.com</a>
            <a href="https://www.programiz.com/cpp-programming/move-semantics" target="_blank" class="resource-link">Move Semantics in C++ - Programiz</a>
            
            <div class="section-title">FOR ADVANCED</div>
            <a href="https://isocpp.org/wiki/faq/cpp11" target="_blank" class="resource-link">Advanced C++11 Features - ISO C++</a>
            <a href="https://www.learncpp.com/cpp-tutorial/introduction-to-raii/" target="_blank" class="resource-link">RAII in C++ - LearnCpp</a>
            <a href="https://www.udemy.com/course/master-advanced-cplusplus/" target="_blank" class="resource-link">Master Advanced C++ Features - Udemy</a>
        --></div>
 ...
 <?php
     foreach ($vadvanceLinks as $name => $url) {
         ...
         ';
            ...
            <a href="https://www.youtube.com/watch?v=vn6-ydvv1WA" target="_blank" class="resource-link">Introduction to Multithreading in C++ - CodeVault</a>
            <a href="https://www.youtube.com/watch?v=6pmWojisM_E" target="_blank" class="resource-link">Smart Pointers Explained - CodeWithHarry</a>
            <a href="https://www.youtube.com/watch?v=_lpFjN1Xwyg" target="_blank" class="resource-link">Lambda Expressions - The Cherno</a>
            
            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=eaFWRbciJrA" target="_blank" class="resource-link">Move Semantics Explained - FreeCodeCamp</a>
            <a href="https://www.youtube.com/watch?v=_GBgxWZMLV4" target="_blank" class="resource-link">RAII in Action - Simplilearn</a>
            <a href="https://www.youtube.com/watch?v=W4aWt4kWKoE" target="_blank" class="resource-link">Deep Dive into Multithreading - The Net Ninja</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/advanced-cpp-for-beginners/" target="_blank" class="resource-link">Advanced C++ for Beginners - Udemy</a>
            <a href="https://www.coursera.org/learn/advanced-cpp" target="_blank" class="resource-link">Basics of Advanced C++ - Coursera</a>
            <a href="https://www.codecademy.com/learn/advanced-cpp" target="_blank" class="resource-link">Learn Advanced C++ - Codecademy</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.udemy.com/course/modern-cpp-features/" target="_blank" class="resource-link">Modern C++ Features - Udemy</a>
            <a href="https://frontendmasters.com/courses/cpp-advanced-features/" target="_blank" class="resource-link">Advanced C++ Masterclass - Frontend Masters</a>
            <a href="https://www.edx.org/course/advanced-cpp-topics" target="_blank" class="resource-link">Advanced C++ Topics - edX</a>
        --></div>
    </div>
