...
<head>
    ...
    <title>Skill Route - Coroutines and Asynchronous Programming</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Coroutines and Asynchronous Programming</div>
...
?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://kotlinlang.org/docs/coroutines-overview.html" target="_blank" class="resource-link">Kotlin Official - Coroutines Overview</a>
            <a href="https://www.geeksforgeeks.org/coroutines-in-kotlin/" target="_blank" class="resource-link">GeeksforGeeks - Coroutines in Kotlin</a>
            <a href="https://www.journaldev.com/19447/kotlin-coroutines" target="_blank" class="resource-link">JournalDev - Kotlin Coroutines</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://medium.com/@deepakjadhav_51102/understanding-kotlin-coroutines-a-guide-to-asynchronous-programming-26cb65dbbe57" target="_blank" class="resource-link">Medium - Understanding Kotlin Coroutines</a>
            <a href="https://www.udemy.com/course/advanced-kotlin-coroutines/" target="_blank" class="resource-link">Udemy - Advanced Kotlin Coroutines</a>
            <a href="https://www.baeldung.com/learn-kotlin" target="_blank" class="resource-link">Baeldung - Kotlin Coroutines</a>
        --></div>
        ...
        <div id="videos" class="slider-section" style="display: none;">
            ...
            <a href="https://www.youtube.com/watch?v=4i9VThXjftI" target="_blank" class="resource-link">Kotlin Coroutines - Basics</a>
            <a href="https://www.youtube.com/watch?v=fAEw31vAZx0" target="_blank" class="resource-link">Kotlin Coroutines - Introduction</a>
            <a href="https://www.youtube.com/watch?v=54KnmiZl2GA" target="_blank" class="resource-link">Learn Kotlin Coroutines</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=Y8W8RU6xY8Q" target="_blank" class="resource-link">Master Kotlin Coroutines</a>
            <a href="https://www.youtube.com/watch?v=YNf6nL0Jl1Y" target="_blank" class="resource-link">Kotlin Coroutines for Advanced Programmers</a>
            <a href="https://www.youtube.com/watch?v=VEZ4-V2sv7E" target="_blank" class="resource-link">Coroutines in Kotlin - Asynchronous Programming</a>
        --></div>
