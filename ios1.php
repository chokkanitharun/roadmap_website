...
<head>
    ...
    <title>Skill Route - Learn Swift Basics</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Learn Swift Basics</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://www.swift.org/documentation/#the-swift-programming-language" target="_blank" class="resource-link">The Swift Programming Language Guide</a>
            <a href="https://www.raywenderlich.com/ios" target="_blank" class="resource-link">Ray Wenderlich - Swift Tutorials</a>
            <a href="https://developer.apple.com/swift/" target="_blank" class="resource-link">Apple's Swift Documentation</a>
            
            <div class="section-title">FOR ADVANCED</div>
            <a href="https://www.swiftbysundell.com/" target="_blank" class="resource-link">Swift by Sundell</a>
            <a href="https://www.hackingwithswift.com/" target="_blank" class="resource-link">Hacking with Swift - Advanced Tutorials</a>
        --></div>
 ...
 <?php
     foreach ($vadvanceLinks as $name => $url) {
         ...
         ';
            ...
            <a href="https://www.youtube.com/watch?v=F2jcPzR3rKk" target="_blank" class="resource-link">Swift Programming Tutorial - CodeWithChris</a>
            <a href="https://www.youtube.com/watch?v=lhFjxGchZ2Y" target="_blank" class="resource-link">Swift Basics - LearnCode.academy</a>
            
            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=9Qzmri1WaaE" target="_blank" class="resource-link">Advanced Swift - iOS Academy</a>
            <a href="https://www.youtube.com/watch?v=rb5bZsJXgqI" target="_blank" class="resource-link">Swift Performance Optimization - Sean Allen</a>
        --></div>
