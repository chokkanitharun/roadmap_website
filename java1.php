...
<head>
    ...
    <title>Skill Route - Core Java Basics</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Core Java Basics</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://docs.oracle.com/javase/tutorial/java/nutsandbolts/" target="_blank" class="resource-link">Java Basics - Oracle Docs</a>
            <a href="https://www.javatpoint.com/java-tutorial" target="_blank" class="resource-link">Java Tutorial - JavaTpoint</a>
            <a href="https://www.geeksforgeeks.org/java/" target="_blank" class="resource-link">Java Basics - GeeksforGeeks</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://docs.oracle.com/en/java/" target="_blank" class="resource-link">Advanced Java Topics - Oracle Docs</a>
            <a href="https://www.baeldung.com/java" target="_blank" class="resource-link">Advanced Java Programming - Baeldung</a>
        --></div>
        ...
        <div id="videos" class="slider-section" style="display: none;">
            ...
            <a href="https://www.youtube.com/watch?v=grEKMHGYyns" target="_blank" class="resource-link">Java Programming for Beginners - freeCodeCamp</a>
            <a href="https://www.youtube.com/watch?v=eIrMbAQSU34" target="_blank" class="resource-link">Learn Java in 1 Hour - Programming with Mosh</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=VN29X8daWKU" target="_blank" class="resource-link">Advanced Java Programming - Telusko</a>
            <a href="https://www.youtube.com/watch?v=AS6O1AFjNXc" target="_blank" class="resource-link">Deep Dive into Java Concepts - CodeAcademy</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/java-tutorial/" target="_blank" class="resource-link">Java for Beginners - Udemy</a>
            <a href="https://www.coursera.org/specializations/java-programming" target="_blank" class="resource-link">Java Programming Specialization - Coursera</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.udemy.com/course/advanced-java-programming/" target="_blank" class="resource-link">Advanced Java Programming - Udemy</a>
            <a href="https://www.edx.org/course/advanced-software-construction-in-java" target="_blank" class="resource-link">Advanced Software Construction in Java - edX</a>
        --></div>
    </div>
