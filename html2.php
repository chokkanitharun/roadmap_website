...
<head>
    ...
    <title>Skill Route - HTML5 Semantic Elements</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">HTML5 Semantic Elements</div>
...
?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element" target="_blank" class="resource-link">MDN - HTML Elements Reference</a>
            <a href="https://www.w3schools.com/html/html5_semantic_elements.asp" target="_blank" class="resource-link">W3Schools - HTML5 Semantic Elements</a>
            <a href="https://html.com/semantic-markup/" target="_blank" class="resource-link">HTML.com - Semantic Markup</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Guide/Using_HTML_sections_and_outlines" target="_blank" class="resource-link">MDN - HTML Sections and Outlines</a>
            <a href="https://www.smashingmagazine.com/2013/01/the-role-of-html5-semantic-elements/" target="_blank" class="resource-link">Smashing Magazine - Role of Semantic Elements</a>
            <a href="https://www.udemy.com/course/html5-web-development/" target="_blank" class="resource-link">Udemy - HTML5 Semantic Development</a>
        --></div>
        ...
        <div id="videos" class="slider-section" style="display: none;">
            ...
            <a href="https://www.youtube.com/watch?v=bJN9oJKo9V4" target="_blank" class="resource-link">HTML5 Semantic Elements Tutorial</a>
            <a href="https://www.youtube.com/watch?v=fK8mjDF8-aU" target="_blank" class="resource-link">Semantic HTML Explained</a>
            <a href="https://www.youtube.com/watch?v=dkGIA2StWbQ" target="_blank" class="resource-link">Semantic HTML Basics</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=kUMe1FH4CHE" target="_blank" class="resource-link">Advanced Semantic Markup</a>
            <a href="https://www.youtube.com/watch?v=TEXw7X8_R6k" target="_blank" class="resource-link">HTML5 and Accessibility</a>
            <a href="https://www.youtube.com/watch?v=DyE8LzP3niY" target="_blank" class="resource-link">Semantic HTML Deep Dive</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://scrimba.com/learn/html" target="_blank" class="resource-link">Scrimba - HTML Basics</a>
            <a href="https://www.udemy.com/course/html-for-beginners/" target="_blank" class="resource-link">Udemy - HTML for Beginners</a>
            ...
            <a href="https://www.udemy.com/course/html5-advanced/" target="_blank" class="resource-link">Udemy - Advanced HTML5</a>
            <a href="https://frontendmasters.com/courses/html5/" target="_blank" class="resource-link">Frontend Masters - HTML5 Mastery</a>
            <a href="https://www.coursera.org/learn/html-css-javascript-for-web-developers" target="_blank" class="resource-link">Coursera - HTML5 for Developers</a>
        --></div>
    </div>
