...
<head>
    ...
    <title>Skill Route - Mathematics for AI</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Mathematics for AI</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://www.mathsisfun.com/algebra/linear-equations.html" target="_blank" class="resource-link">Math is Fun - Linear Equations</a>
            <a href="https://www.khanacademy.org/math/calculus-1" target="_blank" class="resource-link">Khan Academy - Calculus Basics</a>
            <a href="https://towardsdatascience.com/probability-and-statistics-101-a-beginners-guide-to-ai-37801f2a68cc" target="_blank" class="resource-link">Towards Data Science - Probability for AI</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://ocw.mit.edu/courses/mathematics/18-06-linear-algebra-spring-2010/" target="_blank" class="resource-link">MIT OpenCourseWare - Linear Algebra</a>
            <a href="https://www.edx.org/course/calculus-applied" target="_blank" class="resource-link">edX - Applied Calculus</a>
            <a href="https://www.coursera.org/learn/mathematics-for-machine-learning" target="_blank" class="resource-link">Coursera - Mathematics for Machine Learning</a>
        --></div>
 ...
 <?php
     foreach ($vadvanceLinks as $name => $url) {
         ...
         ';
            ...
            <a href="https://www.youtube.com/watch?v=kjBOesZCoqc" target="_blank" class="resource-link">YouTube - Linear Algebra for Beginners</a>
            <a href="https://www.youtube.com/watch?v=WUvTyaaNkzM" target="_blank" class="resource-link">YouTube - Introduction to Calculus</a>
            <a href="https://www.youtube.com/watch?v=HZGCoVF3YvM" target="_blank" class="resource-link">YouTube - Statistics for AI</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=ZK3O402wf1c" target="_blank" class="resource-link">YouTube - MIT Linear Algebra</a>
            <a href="https://www.youtube.com/watch?v=qIpKZvgDtPI" target="_blank" class="resource-link">YouTube - Advanced Probability and Stats</a>
            <a href="https://www.youtube.com/watch?v=tIeHLnjs5U8" target="_blank" class="resource-link">YouTube - Advanced Calculus for Machine Learning</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.khanacademy.org/math/linear-algebra" target="_blank" class="resource-link">Khan Academy - Linear Algebra</a>
            <a href="https://www.udemy.com/course/statistics-for-data-science-and-business-analysis/" target="_blank" class="resource-link">Udemy - Statistics for Data Science</a>
            <a href="https://www.coursera.org/learn/probability-statistics" target="_blank" class="resource-link">Coursera - Probability & Statistics</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://ocw.mit.edu/courses/mathematics/18-02sc-multivariable-calculus-fall-2010/" target="_blank" class="resource-link">MIT - Multivariable Calculus</a>
            <a href="https://www.edx.org/course/statistical-learning" target="_blank" class="resource-link">edX - Statistical Learning</a>
            <a href="https://www.pluralsight.com/courses/math-for-data-science" target="_blank" class="resource-link">Pluralsight - Math for Data Science</a>
        --></div>
    </div>
