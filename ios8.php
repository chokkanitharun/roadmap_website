...
<head>
    ...
    <title>Skill Route - Combine Framework</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Combine Framework</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://developer.apple.com/documentation/combine" target="_blank" class="resource-link">Combine Framework - Apple Docs</a>
            <a href="https://www.hackingwithswift.com/quick-start/combine" target="_blank" class="resource-link">Getting Started with Combine - Hacking with Swift</a>
            <a href="https://www.raywenderlich.com/4517-combine-getting-started" target="_blank" class="resource-link">Combine: Getting Started - Ray Wenderlich</a>
            
            <div class="section-title">FOR ADVANCED</div>
            <a href="https://www.hackingwithswift.com/articles/216/advanced-combine" target="_blank" class="resource-link">Advanced Combine - Hacking with Swift</a>
            <a href="https://swiftwithmajid.com/2020/03/11/understanding-combine-publishers/" target="_blank" class="resource-link">Understanding Publishers - Swift with Majid</a>
        --></div>
 ...
 <?php
     foreach ($vadvanceLinks as $name => $url) {
         ...
         ';
            ...
            <a href="https://www.youtube.com/watch?v=-iJT-JO_yII" target="_blank" class="resource-link">Combine Basics - CodeWithChris</a>
            <a href="https://www.youtube.com/watch?v=FRg8XtL13JM" target="_blank" class="resource-link">Combine in iOS - Sean Allen</a>
            
            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=MHosOi7U-eQ" target="_blank" class="resource-link">Advanced Combine Concepts - iOS Academy</a>
            <a href="https://www.youtube.com/watch?v=JpvP2s3Az7o" target="_blank" class="resource-link">Reactive Programming with Combine - Code with Chris</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/introduction-to-combine-framework/" target="_blank" class="resource-link">Introduction to Combine Framework - Udemy</a>
            <a href="https://www.pluralsight.com/courses/introduction-to-combine-framework-swift" target="_blank" class="resource-link">Getting Started with Combine - Pluralsight</a>
            <a href="https://www.coursera.org/learn/swift-programming" target="_blank" class="resource-link">Combine Basics - Coursera</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.udacity.com/course/swift-reactive-programming--ud555" target="_blank" class="resource-link">Swift Reactive Programming - Udacity</a>
            <a href="https://www.lynda.com/Swift-tutorials/Using-Combine-Framework/540877-2.html" target="_blank" class="resource-link">Using Combine Framework - Lynda</a>
        --></div>
    </div>
