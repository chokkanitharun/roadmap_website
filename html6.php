...
<head>
    ...
    <title>Skill Route - Document Structure and Doctype</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Document Structure and Doctype</div>
...
?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://developer.mozilla.org/en-US/docs/Glossary/Doctype" target="_blank" class="resource-link">MDN - Understanding DOCTYPE</a>
            <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/html" target="_blank" class="resource-link">MDN - HTML Element</a>
            <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/meta" target="_blank" class="resource-link">MDN - Meta Tags</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://www.freecodecamp.org/news/the-html-head-element/" target="_blank" class="resource-link">FreeCodeCamp - The HTML Head Element</a>
            <a href="https://css-tricks.com/essential-meta-tags-social-media/" target="_blank" class="resource-link">CSS-Tricks - Essential Meta Tags</a>
            <a href="https://web.dev/html-basics/" target="_blank" class="resource-link">Web.dev - HTML Basics</a>
        --></div>
        ...
        <div id="videos" class="slider-section" style="display: none;">
            ...
            <a href="https://www.youtube.com/watch?v=G3e-cpL7ofc" target="_blank" class="resource-link">HTML DOCTYPE Explained</a>
            <a href="https://www.youtube.com/watch?v=Sqk7nzMHJJU" target="_blank" class="resource-link">HTML Basics - Structure and Elements</a>
            <a href="https://www.youtube.com/watch?v=kUMe1FH4CHE" target="_blank" class="resource-link">HTML Meta Tags Tutorial</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=a-KmQMSiYK8" target="_blank" class="resource-link">HTML5 - Doctype and Structure</a>
            <a href="https://www.youtube.com/watch?v=H82MTNI30hg" target="_blank" class="resource-link">HTML Head and Metadata in Depth</a>
            <a href="https://www.youtube.com/watch?v=pPNt1M0BXsM" target="_blank" class="resource-link">Web Page Document Structure</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/html-basics/" target="_blank" class="resource-link">Udemy - HTML Basics</a>
            <a href="https://scrimba.com/learn/html" target="_blank" class="resource-link">Scrimba - HTML Introduction</a>
            ...
            <a href="https://www.udemy.com/course/html-structure-complete-guide/" target="_blank" class="resource-link">Udemy - HTML Document Structure</a>
        --></div>
    </div>
