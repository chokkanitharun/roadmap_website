...
<head>
    ...
    <title>Skill Route - Testing in Kotlin</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Testing in Kotlin</div>
...
?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://www.baeldung.com/kotlin/testing-introduction" target="_blank" class="resource-link">Baeldung - Introduction to Testing in Kotlin</a>
            <a href="https://developer.android.com/training/testing/unit-testing" target="_blank" class="resource-link">Android Developers - Unit Testing Basics</a>
            <a href="https://junit.org/junit5/docs/current/user-guide/" target="_blank" class="resource-link">JUnit 5 User Guide</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://mockk.io/" target="_blank" class="resource-link">MockK Documentation</a>
            <a href="https://kotest.io/" target="_blank" class="resource-link">Kotest - Powerful Testing Framework</a>
            <a href="https://proandroiddev.com/kotlin-testing-cheat-sheet-88a27b4bb7c" target="_blank" class="resource-link">ProAndroidDev - Kotlin Testing Cheat Sheet</a>
        --></div>
        ...
        <div id="videos" class="slider-section" style="display: none;">
            ...
            <a href="https://www.youtube.com/watch?v=RFkRXaFpYfA" target="_blank" class="resource-link">YouTube - Unit Testing in Kotlin</a>
            <a href="https://www.youtube.com/watch?v=dRX6T_9R6Ew" target="_blank" class="resource-link">YouTube - JUnit Testing for Beginners</a>
            <a href="https://www.youtube.com/watch?v=XH8qP5YyOfw" target="_blank" class="resource-link">YouTube - Testing Android Apps with Kotlin</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=bgBy8mlYDaM" target="_blank" class="resource-link">YouTube - Advanced MockK Techniques</a>
            <a href="https://www.youtube.com/watch?v=bd5ZjYOsOc8" target="_blank" class="resource-link">YouTube - Kotlin Testing with Kotest</a>
            <a href="https://www.youtube.com/watch?v=hs5CsaRshPA" target="_blank" class="resource-link">YouTube - Testing REST APIs in Kotlin</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/kotlin-for-android-test-driven-development/" target="_blank" class="resource-link">Udemy - Kotlin for Android TDD</a>
            ...
            <a href="https://developer.android.com/courses/pathways/unit-testing" target="_blank" class="resource-link">Google - Android Unit Testing Pathway</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.udemy.com/course/advanced-kotlin-testing/" target="_blank" class="resource-link">Udemy - Advanced Kotlin Testing</a>
            <a href="https://pluralsight.com/courses/kotlin-unit-testing-basics" target="_blank" class="resource-link">Pluralsight - Kotlin Unit Testing</a>
            <a href="https://www.udemy.com/course/kotlin-android-unit-testing/" target="_blank" class="resource-link">Udemy - Kotlin Android Unit Testing</a>
        --></div>
    </div>
