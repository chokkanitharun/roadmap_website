...
<head>
    ...
    <title>Skill Route - Collections and Data Manipulation</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Collections and Data Manipulation</div>
...
?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://kotlinlang.org/docs/collections-overview.html" target="_blank" class="resource-link">Kotlin Official - Collections Overview</a>
            <a href="https://www.geeksforgeeks.org/collections-in-kotlin/" target="_blank" class="resource-link">GeeksforGeeks - Collections in Kotlin</a>
            <a href="https://www.javatpoint.com/kotlin-collections" target="_blank" class="resource-link">JavaTPoint - Kotlin Collections</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://medium.com/@deepakjadhav_51102/advanced-kotlin-collections-and-functional-programming-824aad7b9d89" target="_blank" class="resource-link">Medium - Advanced Kotlin Collections</a>
            ...
            <a href="https://www.baeldung.com/learn-kotlin" target="_blank" class="resource-link">Baeldung - Advanced Kotlin</a>
        --></div>
        ...
        <div id="videos" class="slider-section" style="display: none;">
            ...
            <a href="https://www.youtube.com/watch?v=dez6h2P50-A" target="_blank" class="resource-link">Kotlin Collections - List, Set, Map</a>
            <a href="https://www.youtube.com/watch?v=0NeqO5dbTVY" target="_blank" class="resource-link">Kotlin Collection Types Explained</a>
            <a href="https://www.youtube.com/watch?v=E95hHnyz9PU" target="_blank" class="resource-link">Learn Kotlin Collections</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=ahNfQ8J6W7Q" target="_blank" class="resource-link">Advanced Kotlin - Collection Manipulation</a>
            <a href="https://www.youtube.com/watch?v=MFxQv9fv0Dw" target="_blank" class="resource-link">Functional Programming with Kotlin</a>
            <a href="https://www.youtube.com/watch?v=gzD_hzN4Aw4" target="_blank" class="resource-link">Master Kotlin Collections</a>
        --></div>
