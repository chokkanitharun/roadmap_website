...
<head>
    ...
    <title>Skill Route - Build Tools and Version Control</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Build Tools and Version Control</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://www.geeksforgeeks.org/introduction-to-version-control/" target="_blank" class="resource-link">Version Control Basics - GeeksforGeeks</a>
            <a href="https://cmake.org/install/" target="_blank" class="resource-link">CMake Installation and Setup - CMake</a>
            <a href="https://www.tutorialspoint.com/makefile/index.htm" target="_blank" class="resource-link">Makefile Tutorial - TutorialsPoint</a>
            
            <div class="section-title">FOR ADVANCED</div>
            <a href="https://git-scm.com/book/en/v2" target="_blank" class="resource-link">Pro Git Book - Git SCM</a>
            <a href="https://www.learncpp.com/cpp-tutorial/cmake-and-makefiles/" target="_blank" class="resource-link">Advanced Makefiles and CMake - LearnCpp</a>
            <a href="https://www.udemy.com/course/git-started-with-git/" target="_blank" class="resource-link">Mastering Git - Udemy</a>
        --></div>
 ...
 <?php
     foreach ($vadvanceLinks as $name => $url) {
         ...
         ';
            ...
            <a href="https://www.youtube.com/watch?v=USjZcfj8yxE" target="_blank" class="resource-link">Git for Beginners - GitHub</a>
            <a href="https://www.youtube.com/watch?v=R8wwNxfPLVg" target="_blank" class="resource-link">Introduction to Git - Programming with Mosh</a>
            <a href="https://www.youtube.com/watch?v=Y7JrLJ6h0XA" target="_blank" class="resource-link">CMake Tutorial for Beginners - TheCherno</a>
            
            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=4T0hPHV5Vb8" target="_blank" class="resource-link">Git Advanced Topics - GitHub</a>
            <a href="https://www.youtube.com/watch?v=ksED56x4HDY" target="_blank" class="resource-link">Advanced CMake Usage - CMake</a>
            <a href="https://www.youtube.com/watch?v=8n7rLr8Tscw" target="_blank" class="resource-link">Mastering Git in Depth - FreeCodeCamp</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/git-started-with-git/" target="_blank" class="resource-link">Git Started with Git - Udemy</a>
            <a href="https://www.coursera.org/learn/using-git-and-github" target="_blank" class="resource-link">Using Git and GitHub - Coursera</a>
            ...
            <a href="https://www.udemy.com/course/advanced-cmake/" target="_blank" class="resource-link">Advanced CMake - Udemy</a>
            <a href="https://frontendmasters.com/courses/git/" target="_blank" class="resource-link">Advanced Git - Frontend Masters</a>
            <a href="https://www.edx.org/course/advanced-git-techniques" target="_blank" class="resource-link">Advanced Git Techniques - edX</a>
        --></div>
    </div>
