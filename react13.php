...
<head>
    ...
    <title>Skill Route - Testing in React</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Testing in React</div>
...
?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://reactjs.org/docs/testing.html" target="_blank" class="resource-link">React - Testing Overview</a>
            <a href="https://www.freecodecamp.org/news/testing-react-components-best-practices/" target="_blank" class="resource-link">FreeCodeCamp - Testing React Components</a>
            <a href="https://jestjs.io/docs/getting-started" target="_blank" class="resource-link">Jest - Getting Started</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://testing-library.com/docs/react-testing-library/intro/" target="_blank" class="resource-link">React Testing Library - Intro</a>
            <a href="https://kentcdodds.com/blog/common-mistakes-with-react-testing-library" target="_blank" class="resource-link">Kent C. Dodds - Common Mistakes with React Testing</a>
            <a href="https://frontendmasters.com/courses/testing-react/" target="_blank" class="resource-link">Frontend Masters - Advanced React Testing</a>
    --></div>
    ...
    ?>
            ...
            <a href="https://www.youtube.com/watch?v=ML5egqL3YFE" target="_blank" class="resource-link">React Testing Basics - Jest & React Testing Library</a>
            <a href="https://www.youtube.com/watch?v=oBM3-Al89wM" target="_blank" class="resource-link">Introduction to React Testing Library</a>
            <a href="https://www.youtube.com/watch?v=fxbAB8LcXPU" target="_blank" class="resource-link">Unit Testing with Jest</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=pFmsMNyqJ20" target="_blank" class="resource-link">Advanced React Testing Techniques</a>
            <a href="https://www.youtube.com/watch?v=8F-WQGkcprY" target="_blank" class="resource-link">Mastering React Testing Library</a>
            <a href="https://www.youtube.com/watch?v=JKOwJUM4_RM" target="_blank" class="resource-link">Best Practices for React Testing</a>
    --></div>
...
?>
            ...
            <a href="https://www.udemy.com/course/react-testing-library/" target="_blank" class="resource-link">Udemy - React Testing Library</a>
            <a href="https://scrimba.com/learn/reacttesting" target="_blank" class="resource-link">Scrimba - React Testing Basics</a>
            <a href="https://www.coursera.org/learn/react-testing" target="_blank" class="resource-link">Coursera - React Testing Essentials</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://frontendmasters.com/courses/advanced-react-testing/" target="_blank" class="resource-link">Frontend Masters - Advanced React Testing</a>
            <a href="https://egghead.io/courses/react-testing-with-jest" target="_blank" class="resource-link">Egghead - React Testing with Jest</a>
            <a href="https://www.udemy.com/course/advanced-react-testing-with-jest-and-rtl/" target="_blank" class="resource-link">Udemy - Advanced React Testing</a>
    --></div>
    </div>
