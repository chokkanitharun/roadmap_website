...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Learn about APIs</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://restfulapi.net/" target="_blank" class="resource-link">RESTful API Introduction - restfulapi.net</a>
            <a href="https://graphql.org/learn/" target="_blank" class="resource-link">GraphQL Learning Resources - Official GraphQL</a>
            <a href="https://developer.mozilla.org/en-US/docs/Web/API" target="_blank" class="resource-link">MDN Web Docs - API Basics</a>
            
            <div class="section-title">FOR ADVANCED</div>
            <a href="https://www.ics.uci.edu/~fielding/pubs/dissertation/rest_arch_style.htm" target="_blank" class="resource-link">Roy Fielding's Dissertation on REST</a>
            <a href="https://graphql.org/learn/best-practices/" target="_blank" class="resource-link">GraphQL Best Practices</a>
            <a href="https://www.postman.com/api-platform/" target="_blank" class="resource-link">API Testing with Postman</a>
        --></div>
        ...
        <div id="videos" class="slider-section" style="display: none;">
           ...
           <!-- <div class="section-title">Video Resources for Beginners</div>
            <a href="https://www.youtube.com/watch?v=Q-BpqyOT3a8" target="_blank" class="resource-link">RESTful API Crash Course - Traversy Media</a>
            <a href="https://www.youtube.com/watch?v=ed8SzALpx1Q" target="_blank" class="resource-link">GraphQL Crash Course - Academind</a>
            <a href="https://www.youtube.com/watch?v=FLnxgSZ0DG4" target="_blank" class="resource-link">API Basics - Programming with Mosh</a>
            
            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=RP_f5dMoHFc" target="_blank" class="resource-link">Building RESTful APIs - Fireship</a>
            <a href="https://www.youtube.com/watch?v=lAJWHHUz8_8" target="_blank" class="resource-link">Advanced GraphQL Features - Net Ninja</a>
            <a href="https://www.youtube.com/watch?v=YFnTWl_wnrs" target="_blank" class="resource-link">API Security Best Practices</a>
        --> </div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
           ...
           <!-- <div class="section-title">Course Resources for Beginners</div>
            <a href="https://www.udemy.com/course/rest-api/" target="_blank" class="resource-link">REST API for Beginners - Udemy</a>
            <a href="https://www.udemy.com/course/graphql-with-react/" target="_blank" class="resource-link">GraphQL with React - Udemy</a>
            <a href="https://www.udemy.com/course/api-design/" target="_blank" class="resource-link">API Design for Beginners - Udemy</a>
            
            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.coursera.org/learn/api-development" target="_blank" class="resource-link">API Development with Python - Coursera</a>
            <a href="https://frontendmasters.com/courses/graphql/" target="_blank" class="resource-link">Advanced GraphQL - Frontend Masters</a>
            <a href="https://www.udemy.com/course/advanced-api-development/" target="_blank" class="resource-link">Advanced API Development - Udemy</a>
        --></div>
    </div>
