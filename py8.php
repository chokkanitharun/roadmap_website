...
<body>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://docs.pytest.org/en/stable/getting-started.html" target="_blank" class="resource-link">Getting Started with Pytest</a>
            <a href="https://realpython.com/python-testing/" target="_blank" class="resource-link">Python Testing for Beginners - Real Python</a>
            <a href="https://www.geeksforgeeks.org/debugging-python/" target="_blank" class="resource-link">Debugging in Python - GeeksforGeeks</a>
            
            <div class="section-title">FOR ADVANCED</div>
            <a href="https://docs.pytest.org/en/stable/parametrize.html" target="_blank" class="resource-link">Advanced Pytest Parametrization</a>
            <a href="https://martinfowler.com/bliki/TestDrivenDevelopment.html" target="_blank" class="resource-link">Test-Driven Development - Martin Fowler</a>
            <a href="https://towardsdatascience.com/debugging-python-scripts-advanced-techniques-5e0063f8a1e" target="_blank" class="resource-link">Advanced Debugging Techniques - Towards Data Science</a>
        --></div>
 ...
 <?php
     foreach ($vadvanceLinks as $name => $url) {
         ...
         ';
            ...
            <a href="https://www.youtube.com/watch?v=fx2LshchV3s" target="_blank" class="resource-link">Pytest Crash Course - Corey Schafer</a>
            <a href="https://www.youtube.com/watch?v=6tNS--WetLI" target="_blank" class="resource-link">Python Unit Testing - Simplilearn</a>
            <a href="https://www.youtube.com/watch?v=aiUQfhNR6NA" target="_blank" class="resource-link">Debugging in Python - FreeCodeCamp</a>
            
            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=BRp9SwNI3uM" target="_blank" class="resource-link">Advanced Pytest Techniques - Talk Python</a>
            <a href="https://www.youtube.com/watch?v=ApGivcUv3Lk" target="_blank" class="resource-link">TDD in Python - PyCon Talk</a>
            <a href="https://www.youtube.com/watch?v=riW_pUtsWvk" target="_blank" class="resource-link">Python Debugging Advanced Tools - Edureka</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/python-unit-testing/" target="_blank" class="resource-link">Python Unit Testing with Pytest - Udemy</a>
            <a href="https://www.coursera.org/learn/unit-testing" target="_blank" class="resource-link">Unit Testing with Pytest - Coursera</a>
            <a href="https://www.datacamp.com/courses/python-unit-testing" target="_blank" class="resource-link">Unit Testing for Beginners - DataCamp</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.educative.io/courses/test-driven-development-python" target="_blank" class="resource-link">TDD in Python - Educative.io</a>
            <a href="https://frontendmasters.com/courses/python-testing/" target="_blank" class="resource-link">Advanced Python Testing - Frontend Masters</a>
            <a href="https://www.codecademy.com/learn/test-driven-development-python" target="_blank" class="resource-link">Test-Driven Development - Codecademy</a>
        --></div>
    </div>
