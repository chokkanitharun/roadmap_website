...
<body>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            <!-- <div class="section-title">FOR BEGINNERS</div>
            <a href="https://www.w3schools.com/html/default.asp" target="_blank" class="resource-link">W Schools</a>
            <a href="https://www.programiz.com/" target="_blank" class="resource-link">Programiz</a>
            <a href="https://www.tutorialspoint.com/html/index.htm" target="_blank" class="resource-link">Tutorials Point</a>
            
            <div class="section-title">FOR ADVANCED</div>
            <a href="https://www.example.com/advanced1" target="_blank" class="resource-link">Advanced Resource 1</a>
            <a href="https://www.example.com/advanced2" target="_blank" class="resource-link">Advanced Resource 2</a> -->
        </div>
...
?>
           ...
           <!-- <div class="section-title">Video Resources for Beginners</div>
            ...
            <a href="https://www.youtube.com/watch?v=G3e-cpL7ofc" target="_blank" class="resource-link">Learn HTML in 12 Minutes</a>
            
            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=srQIBu_L9c8" target="_blank" class="resource-link">CSS Grid Layout - Traversy Media</a>
            <a href="https://www.youtube.com/watch?v=2s3Klmz7Q2Q" target="_blank" class="resource-link">JavaScript Advanced Techniques</a>-->
        </div>
...
?>
          ...
          <!--  <div class="section-title">Course Resources for Beginners</div>
            <a href="https://www.udemy.com/course/learn-html5-programming/" target="_blank" class="resource-link">Udemy: HTML5 Programming</a>
            <a href="https://www.codecademy.com/learn/learn-html" target="_blank" class="resource-link">Codecademy: HTML Course</a>
            
            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.udemy.com/course/javascript-the-complete-guide/" target="_blank" class="resource-link">JavaScript - The Complete Guide</a>
            <a href="https://www.frontendmasters.com/courses/css-grid/" target="_blank" class="resource-link">Advanced CSS Grid</a>-->
        </div>
    </div>
