...
<head>
    ...
    <title>Skill Route - Testing JavaScript Applications</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Testing JavaScript Applications</div>
...
?>
            ...
            <a href="https://mochajs.org/#getting-started" target="_blank" class="resource-link">Mocha: Introduction</a>
            <a href="https://docs.cypress.io/guides/overview/why-cypress" target="_blank" class="resource-link">Cypress: Beginner's Guide</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://jestjs.io/docs/mock-functions" target="_blank" class="resource-link">Advanced Jest Mocking</a>
            <a href="https://mochajs.org/#assertions" target="_blank" class="resource-link">Assertions in Mocha</a>
            <a href="https://docs.cypress.io/guides/core-concepts/introduction-to-cypress" target="_blank" class="resource-link">Advanced Cypress Concepts</a>
    --></div>
    ...
    ?>
            ...
            <a href="https://www.youtube.com/watch?v=7r4xVDI2vho" target="_blank" class="resource-link">Jest Testing Tutorial</a>
            <a href="https://www.youtube.com/watch?v=MLTRHc5dk6s" target="_blank" class="resource-link">Mocha Crash Course</a>
            <a href="https://www.youtube.com/watch?v=5XQOK0v_YRE" target="_blank" class="resource-link">Cypress Beginner Tutorial</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=XX1WroxQdrQ" target="_blank" class="resource-link">Advanced Jest Techniques</a>
            <a href="https://www.youtube.com/watch?v=KpX9skd7Oos" target="_blank" class="resource-link">Mocha Deep Dive</a>
            <a href="https://www.youtube.com/watch?v=jX3v3N6oN5M" target="_blank" class="resource-link">Advanced Cypress Testing</a>
    --></div>
...
?>
            ...
            <a href="https://www.udemy.com/course/javascript-unit-testing/" target="_blank" class="resource-link">JavaScript Unit Testing - Udemy</a>
            <a href="https://www.udemy.com/course/cypress-web-automation-testing-from-zero-to-hero/" target="_blank" class="resource-link">Cypress from Zero to Hero - Udemy</a>
            <a href="https://www.udemy.com/course/mocha-unit-testing/" target="_blank" class="resource-link">Mocha Unit Testing - Udemy</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://frontendmasters.com/courses/testing-javascript/" target="_blank" class="resource-link">Advanced JavaScript Testing - Frontend Masters</a>
            <a href="https://www.pluralsight.com/courses/javascript-testing-mocha-chai" target="_blank" class="resource-link">Advanced Mocha Testing - Pluralsight</a>
            <a href="https://www.pluralsight.com/courses/cypress-testing-introduction" target="_blank" class="resource-link">Cypress Testing Advanced - Pluralsight</a>
    --></div>
    </div>
