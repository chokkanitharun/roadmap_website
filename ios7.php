...
<head>
    ...
    <title>Skill Route - Networking with URLSession & APIs</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Networking with URLSession and APIs</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://developer.apple.com/documentation/foundation/urlsession" target="_blank" class="resource-link">URLSession Basics - Apple Docs</a>
            <a href="https://www.hackingwithswift.com/read/10/2/using-urlsession-to-fetch-data-from-the-web" target="_blank" class="resource-link">Using URLSession - Hacking with Swift</a>
            <a href="https://www.raywenderlich.com/3244963-networking-with-urlsession-tutorial-getting-started" target="_blank" class="resource-link">Networking with URLSession - Ray Wenderlich</a>
            
            <div class="section-title">FOR ADVANCED</div>
            <a href="https://www.hackingwithswift.com/articles/117/networking-and-json-parsing-in-swift" target="_blank" class="resource-link">Networking & JSON Parsing - Hacking with Swift</a>
            <a href="https://developer.apple.com/documentation/foundation/jsondecoder" target="_blank" class="resource-link">Advanced JSON Handling - Apple Docs</a>
        --></div>
 ...
 <?php
     foreach ($vadvanceLinks as $name => $url) {
         ...
         ';
            ...
            <a href="https://www.youtube.com/watch?v=8kMg1W3jjh0" target="_blank" class="resource-link">URLSession Basics - CodeWithChris</a>
            <a href="https://www.youtube.com/watch?v=R-vF8Dq5M6M" target="_blank" class="resource-link">Fetching API Data - iOS Academy</a>
            
            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=_i-4J4LbY9I" target="_blank" class="resource-link">Advanced Networking in iOS - Sean Allen</a>
            <a href="https://www.youtube.com/watch?v=OrsDV9u26PU" target="_blank" class="resource-link">Working with APIs - CodeWithChris</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/swift-networking-with-urlsession/" target="_blank" class="resource-link">Swift Networking Basics - Udemy</a>
            <a href="https://www.coursera.org/learn/ios-app-development" target="_blank" class="resource-link">URLSession Essentials - Coursera</a>
            <a href="https://www.edx.org/course/networking-and-apis-in-ios" target="_blank" class="resource-link">Networking in iOS - edX</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.udacity.com/course/ios-networking-with-swift--ud421" target="_blank" class="resource-link">Advanced iOS Networking - Udacity</a>
            <a href="https://www.pluralsight.com/courses/ios-networking-swift" target="_blank" class="resource-link">iOS Networking with Swift - Pluralsight</a>
            <a href="https://www.lynda.com/Swift-tutorials/Networking-URLSession/540877-2.html" target="_blank" class="resource-link">Networking in Swift - Lynda</a>
        --></div>
    </div>
