...
<head>
    ...
    <title>Skill Route - Databases (MongoDB)</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Databases (MongoDB)</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://www.mongodb.com/docs/manual/" target="_blank" class="resource-link">MongoDB Official Documentation</a>
            <a href="https://www.freecodecamp.org/news/learn-mongodb-a4e119e27721/" target="_blank" class="resource-link">FreeCodeCamp - Learn MongoDB</a>
            <a href="https://www.digitalocean.com/community/tutorials/an-introduction-to-mongodb" target="_blank" class="resource-link">DigitalOcean - Introduction to MongoDB</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://www.mongodb.com/developer/" target="_blank" class="resource-link">MongoDB Developer Hub</a>
            <a href="https://university.mongodb.com/" target="_blank" class="resource-link">MongoDB University</a>
            <a href="https://www.tutorialspoint.com/mongodb/index.htm" target="_blank" class="resource-link">TutorialsPoint - Advanced MongoDB</a>
        --></div>
 ...
 <?php
     foreach ($vadvanceLinks as $name => $url) {
         ...
         ';
            ...
            <a href="https://www.youtube.com/watch?v=-56x56UppqQ" target="_blank" class="resource-link">YouTube - MongoDB Crash Course</a>
            <a href="https://www.youtube.com/watch?v=oSIv-E60NiU" target="_blank" class="resource-link">YouTube - MongoDB Basics Tutorial</a>
            <a href="https://www.youtube.com/watch?v=mv2kp_Opz8E" target="_blank" class="resource-link">YouTube - NoSQL and MongoDB for Beginners</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=vjgsJGDxBBs" target="_blank" class="resource-link">YouTube - Advanced MongoDB</a>
            <a href="https://www.youtube.com/watch?v=oRTuUZIqgrM" target="_blank" class="resource-link">YouTube - Indexing in MongoDB</a>
            <a href="https://www.youtube.com/watch?v=A3K7aFz9iWs" target="_blank" class="resource-link">YouTube - MongoDB Aggregation Framework</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/mongodb-the-complete-developers-guide/" target="_blank" class="resource-link">Udemy - MongoDB Complete Guide</a>
            <a href="https://www.codecademy.com/learn/learn-mongodb" target="_blank" class="resource-link">Codecademy - Learn MongoDB</a>
            <a href="https://www.coursera.org/learn/introduction-mongodb" target="_blank" class="resource-link">Coursera - MongoDB Basics</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://university.mongodb.com/courses/m103" target="_blank" class="resource-link">MongoDB University - Advanced Deployment</a>
            <a href="https://frontendmasters.com/courses/mongodb/" target="_blank" class="resource-link">Frontend Masters - MongoDB Fundamentals</a>
            <a href="https://www.pluralsight.com/courses/mongodb-introduction" target="_blank" class="resource-link">Pluralsight - MongoDB for Developers</a>
        --></div>
    </div>
