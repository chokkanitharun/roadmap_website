...
<head>
    ...
    <title>Skill Route - File I/O and Serialization</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">File I/O and Serialization</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://www.geeksforgeeks.org/file-handling-in-java-using-filewriter-and-filereader/" target="_blank" class="resource-link">File Handling in Java - GeeksforGeeks</a>
            <a href="https://www.javatpoint.com/java-fileoutputstream-class" target="_blank" class="resource-link">Java File I/O Basics - JavaTpoint</a>
            <a href="https://www.tutorialspoint.com/java/java_serialization.htm" target="_blank" class="resource-link">Java Serialization - TutorialsPoint</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://www.baeldung.com/java-serialization" target="_blank" class="resource-link">Advanced Serialization in Java - Baeldung</a>
            <a href="https://docs.oracle.com/javase/tutorial/essential/io/" target="_blank" class="resource-link">Java I/O Streams - Oracle</a>
        --></div>
        ...
        <div id="videos" class="slider-section" style="display: none;">
            ...
            <a href="https://www.youtube.com/watch?v=nMbnB33hDjc" target="_blank" class="resource-link">Java File Handling Basics - CodeWithHarry</a>
            <a href="https://www.youtube.com/watch?v=Fxs2Z6mUEE8" target="_blank" class="resource-link">Serialization in Java - Telusko</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=9pqM2l6LA78" target="_blank" class="resource-link">Advanced File I/O Concepts - freeCodeCamp</a>
            <a href="https://www.youtube.com/watch?v=sUbW8VxZTIU" target="_blank" class="resource-link">Deep Dive into Serialization - TechLead</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/java-file-io/" target="_blank" class="resource-link">Java File I/O for Beginners - Udemy</a>
            <a href="https://www.coursera.org/learn/java-programming" target="_blank" class="resource-link">Java Programming: File I/O - Coursera</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.udemy.com/course/advanced-java-io-and-serialization/" target="_blank" class="resource-link">Advanced Java I/O and Serialization - Udemy</a>
            <a href="https://www.linkedin.com/learning/java-io-and-serialization" target="_blank" class="resource-link">Java I/O and Serialization Tips - LinkedIn Learning</a>
        --></div>
    </div>
