...
<body>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://www.javatpoint.com/junit-tutorial" target="_blank" class="resource-link">JUnit Tutorial - JavaTpoint</a>
            <a href="https://www.baeldung.com/mockito-series" target="_blank" class="resource-link">Mockito Basics - Baeldung</a>
            <a href="https://www.jetbrains.com/help/idea/debug-java-code.html" target="_blank" class="resource-link">Debugging Java Code - JetBrains</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://www.journaldev.com/2443/junit-5-tutorial" target="_blank" class="resource-link">JUnit 5 Advanced Concepts</a>
            <a href="https://www.tutorialspoint.com/mock_testing_with_mockito" target="_blank" class="resource-link">Mock Testing with Mockito - TutorialsPoint</a>
        --></div>
        ...
        <div id="videos" class="slider-section" style="display: none;">
            ...
            <a href="https://www.youtube.com/watch?v=Rr6SO5bDEK4" target="_blank" class="resource-link">JUnit Basics Tutorial - CodeAcademy</a>
            <a href="https://www.youtube.com/watch?v=bX3V6G3qehQ" target="_blank" class="resource-link">Mockito Tutorial - Telusko</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=fx9ZXeAVfFA" target="_blank" class="resource-link">Advanced JUnit 5 Testing</a>
            <a href="https://www.youtube.com/watch?v=X5MQ5jtE6WE" target="_blank" class="resource-link">Advanced Debugging Techniques</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/junit-tutorial/" target="_blank" class="resource-link">JUnit for Beginners - Udemy</a>
            <a href="https://www.pluralsight.com/courses/mockito-mocking-advanced" target="_blank" class="resource-link">Mockito Advanced - Pluralsight</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.udemy.com/course/advanced-junit-and-mocking/" target="_blank" class="resource-link">Advanced JUnit & Mocking - Udemy</a>
            <a href="https://www.coursera.org/learn/debugging-java-programs" target="_blank" class="resource-link">Advanced Debugging in Java - Coursera</a>
        --></div>
    </div>
