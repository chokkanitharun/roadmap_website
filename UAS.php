...
<head>
    ...
    <title>Skill Route - Understand Android Studio</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Understand Android Studio</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://developer.android.com/studio/intro" target="_blank" class="resource-link">Introduction to Android Studio - Official Docs</a>
            <a href="https://www.geeksforgeeks.org/getting-started-with-android-studio/" target="_blank" class="resource-link">Getting Started with Android Studio - GeeksforGeeks</a>
            <a href="https://www.javatpoint.com/android-studio-tutorial" target="_blank" class="resource-link">Android Studio Basics - Javatpoint</a>
            
            <div class="section-title">FOR ADVANCED</div>
            <a href="https://developer.android.com/studio/debug" target="_blank" class="resource-link">Debugging Tools in Android Studio - Official Docs</a>
            <a href="https://proandroiddev.com/mastering-android-studio-tips-and-tricks-5136dd06c54" target="_blank" class="resource-link">Android Studio Tips and Tricks - ProAndroidDev</a>
        ...
        <div id="videos" class="slider-section" style="display: none;">
            ...
            <a href="https://www.youtube.com/watch?v=Iz08OTTjR04" target="_blank" class="resource-link">Introduction to Android Studio - Simplilearn</a>
            <a href="https://www.youtube.com/watch?v=fis26HvvDII" target="_blank" class="resource-link">Android Studio Tutorial for Beginners - ProgrammingKnowledge</a>
            <a href="https://www.youtube.com/watch?v=BgIJIehm6hc" target="_blank" class="resource-link">Getting Started with Android Studio - Edureka</a>
            
            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=QDM10KGrhDM" target="_blank" class="resource-link">Advanced Debugging in Android Studio - Coding in Flow</a>
            <a href="https://www.youtube.com/watch?v=2I-FShOeY_Q" target="_blank" class="resource-link">Performance Optimization with Android Studio - JetBrains</a>
            <a href="https://www.youtube.com/watch?v=nQJ8THJkzII" target="_blank" class="resource-link">Android Studio Pro Tips - Android Developers</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/android-studio-for-beginners/" target="_blank" class="resource-link">Android Studio for Beginners - Udemy</a>
            <a href="https://www.coursera.org/learn/android-app-development" target="_blank" class="resource-link">Android App Development with Android Studio - Coursera</a>
            <a href="https://www.pluralsight.com/courses/android-studio-introduction" target="_blank" class="resource-link">Introduction to Android Studio - Pluralsight</a>
            ...
            <a href="https://www.edx.org/course/android-performance" target="_blank" class="resource-link">Performance Optimization with Android Studio - edX</a>
            <a href="https://frontendmasters.com/courses/android-apps/" target="_blank" class="resource-link">Mastering Android Apps with Android Studio - Frontend Masters</a>
        --></div>
    </div>
