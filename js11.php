...
<head>
    ...
    <title>Skill Route - Deployment and CI/CD</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Deployment and CI/CD</div>
...
?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://vercel.com/docs" target="_blank" class="resource-link">Getting Started with Vercel</a>
            <a href="https://devcenter.heroku.com/start" target="_blank" class="resource-link">Heroku Basics</a>
            <a href="https://circleci.com/docs/" target="_blank" class="resource-link">Introduction to CI/CD with CircleCI</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://docs.github.com/en/actions" target="_blank" class="resource-link">GitHub Actions Documentation</a>
            <a href="https://vercel.com/guides/deploying-nextjs-to-vercel" target="_blank" class="resource-link">Deploying Next.js to Vercel</a>
            <a href="https://medium.com/devops-with-valentine/ci-cd-best-practices-2022-bd10c432ff3f" target="_blank" class="resource-link">CI/CD Best Practices</a>
    --></div>
    ...
    ?>
            ...
            <a href="https://www.youtube.com/watch?v=NhJ2miXOeDE" target="_blank" class="resource-link">Deploy JavaScript Apps with Vercel</a>
            <a href="https://www.youtube.com/watch?v=rHGz1LLtAfc" target="_blank" class="resource-link">Introduction to Heroku for Beginners</a>
            <a href="https://www.youtube.com/watch?v=nrx5tmVGArI" target="_blank" class="resource-link">CI/CD Concepts Explained</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=OX0ba0JqCHo" target="_blank" class="resource-link">Advanced GitHub Actions</a>
            <a href="https://www.youtube.com/watch?v=lV7pe03TEvg" target="_blank" class="resource-link">Vercel for Production Deployments</a>
            <a href="https://www.youtube.com/watch?v=3g3Npd2UhF4" target="_blank" class="resource-link">Mastering CI/CD Pipelines</a>
    --></div>
...
?>
            ...
            <a href="https://www.udemy.com/course/deploying-nodejs-apps/" target="_blank" class="resource-link">Deploying Node.js Apps - Udemy</a>
            <a href="https://www.codecademy.com/learn/deploying-application" target="_blank" class="resource-link">Learn Deployment - Codecademy</a>
            <a href="https://learn.microsoft.com/en-us/azure/devops/" target="_blank" class="resource-link">Azure DevOps for Beginners</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://frontendmasters.com/courses/fullstack/" target="_blank" class="resource-link">Fullstack Development with Deployment - Frontend Masters</a>
            <a href="https://www.coursera.org/specializations/devops" target="_blank" class="resource-link">DevOps and CI/CD - Coursera</a>
            <a href="https://www.pluralsight.com/courses/ci-cd-pipelines-aws" target="_blank" class="resource-link">CI/CD Pipelines on AWS - Pluralsight</a>
    --></div>
    </div>
