...
<head>
    ...
    <title>Skill Route - Forms and Controlled Components</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Forms and Controlled Components</div>
...
?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://reactjs.org/docs/forms.html" target="_blank" class="resource-link">React - Forms</a>
            <a href="https://reactjs.org/docs/forms.html#controlled-components" target="_blank" class="resource-link">React - Controlled Components</a>
            <a href="https://developer.mozilla.org/en-US/docs/Learn/Forms" target="_blank" class="resource-link">MDN - Forms</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://kentcdodds.com/blog/controlled-vs-uncontrolled-components" target="_blank" class="resource-link">Kent C. Dodds - Controlled vs Uncontrolled Components</a>
            <a href="https://www.smashingmagazine.com/2020/03/handling-forms-react/" target="_blank" class="resource-link">Smashing Magazine - Handling Forms in React</a>
            <a href="https://www.udemy.com/course/react-redux-form-validation/" target="_blank" class="resource-link">React Form Validation - Udemy</a>
    --></div>
    ...
    ?>
            ...
            <a href="https://www.youtube.com/watch?v=dCimd4FQ9KM" target="_blank" class="resource-link">React Forms - Learn to Use Forms in React</a>
            <a href="https://www.youtube.com/watch?v=J82qk8Xn2AA" target="_blank" class="resource-link">React Controlled Components</a>
            <a href="https://www.youtube.com/watch?v=KjESFJdKKY4" target="_blank" class="resource-link">MDN - Forms and Form Validation</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=Z07ToY7N2Zk" target="_blank" class="resource-link">Advanced React Form Validation</a>
            <a href="https://www.youtube.com/watch?v=Rb-JFTw4kQ8" target="_blank" class="resource-link">React Form Handling and Validation - Advanced Concepts</a>
            <a href="https://www.youtube.com/watch?v=1vAq3DlkRTY" target="_blank" class="resource-link">Controlled Components and Validation in React</a>
    --></div>
