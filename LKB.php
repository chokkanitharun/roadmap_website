...
<head>
    ...
    <title>Skill Route - Learn Kotlin Basics</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Learn Kotlin Basics</div>
...
?>
            ...
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://kotlinlang.org/docs/getting-started.html" target="_blank" class="resource-link">Getting Started with Kotlin - Official Docs</a>
            <a href="https://www.geeksforgeeks.org/kotlin-programming-language-introduction/" target="_blank" class="resource-link">Kotlin Basics - GeeksforGeeks</a>
            <a href="https://developer.android.com/kotlin/first" target="_blank" class="resource-link">First Steps with Kotlin - Android Developers</a>
            
            <div class="section-title">FOR ADVANCED</div>
            <a href="https://kotlinlang.org/docs/reference/" target="_blank" class="resource-link">Kotlin Reference - Official Docs</a>
            <a href="https://www.raywenderlich.com/25826444-kotlin-fundamentals" target="_blank" class="resource-link">Kotlin Fundamentals - Ray Wenderlich</a>
            <a href="https://proandroiddev.com/kotlin-programming-tips-and-tricks-91e8c7764ed2" target="_blank" class="resource-link">Kotlin Tips and Tricks - ProAndroidDev</a>
        --></div>
        ...
        <div id="videos" class="slider-section" style="display: none;">
            ...
            <a href="https://www.youtube.com/watch?v=H_oGi8uuDpA" target="_blank" class="resource-link">Kotlin for Beginners - FreeCodeCamp</a>
            <a href="https://www.youtube.com/watch?v=EExSSotojVI" target="_blank" class="resource-link">Kotlin Crash Course - Traversy Media</a>
            <a href="https://www.youtube.com/watch?v=Wy7zLVTNYpE" target="_blank" class="resource-link">Kotlin Basics - Programming with Mosh</a>
            
            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=KQOIHRD9w_o" target="_blank" class="resource-link">Kotlin Advanced Programming - Simplilearn</a>
            <a href="https://www.youtube.com/watch?v=6P20npkvcb8" target="_blank" class="resource-link">Functional Programming in Kotlin - JetBrains</a>
            <a href="https://www.youtube.com/watch?v=TCZlhFKI9Pk" target="_blank" class="resource-link">Kotlin for Professionals - CodeAcademy</a>
        --> </div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
           ...
           <!--<div class="section-title">Course Resources for Beginners</div>
            <a href="https://www.udemy.com/course/kotlin-for-beginners/" target="_blank" class="resource-link">Kotlin for Beginners - Udemy</a>
            <a href="https://www.coursera.org/learn/kotlin-for-java-developers" target="_blank" class="resource-link">Kotlin for Java Developers - Coursera</a>
            <a href="https://www.pluralsight.com/courses/kotlin-getting-started" target="_blank" class="resource-link">Getting Started with Kotlin - Pluralsight</a>
            
            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://frontendmasters.com/courses/kotlin-programming/" target="_blank" class="resource-link">Kotlin Programming - Frontend Masters</a>
            <a href="https://www.udemy.com/course/advanced-kotlin/" target="_blank" class="resource-link">Advanced Kotlin Programming - Udemy</a>
            <a href="https://www.edx.org/course/kotlin-advanced-programming" target="_blank" class="resource-link">Kotlin Advanced Programming - edX</a>
        --></div>
    </div>
