...
<head>
    ...
    <title>Skill Route - HTML Basics</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">HTML Basics</div>
...
?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://developer.mozilla.org/en-US/docs/Web/HTML" target="_blank" class="resource-link">MDN - HTML Basics</a>
            <a href="https://www.w3schools.com/html/" target="_blank" class="resource-link">W3Schools - Learn HTML</a>
            <a href="https://html.com/" target="_blank" class="resource-link">HTML.com - HTML Tutorials</a>
            ...
            <a href="https://www.smashingmagazine.com/2019/02/html5-guide/" target="_blank" class="resource-link">Smashing Magazine - HTML5 Guide</a>
            <a href="https://www.udemy.com/course/html5-web-development/" target="_blank" class="resource-link">Udemy - HTML5 Web Development</a>
        --></div>
        ...
        <div id="videos" class="slider-section" style="display: none;">
            ...
            <a href="https://www.youtube.com/watch?v=UB1O30fR-EE" target="_blank" class="resource-link">HTML Full Course - FreeCodeCamp</a>
            <a href="https://www.youtube.com/watch?v=pQN-pnXPaVg" target="_blank" class="resource-link">HTML Crash Course for Beginners</a>
            <a href="https://www.youtube.com/watch?v=bWPMSSsVdPk" target="_blank" class="resource-link">HTML Tutorial for Beginners</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=UB1O30fR-EE" target="_blank" class="resource-link">Advanced HTML5 Features</a>
            <a href="https://www.youtube.com/watch?v=s2z0gGhfYUI" target="_blank" class="resource-link">Deep Dive into HTML5</a>
            <a href="https://www.youtube.com/watch?v=hdI2bqOjy3c" target="_blank" class="resource-link">Modern HTML & CSS</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.coursera.org/learn/html-css-javascript-for-web-developers" target="_blank" class="resource-link">Coursera - Advanced Web Development</a>
        --></div>
    </div>
