...
<body>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://www.javatpoint.com/java-oops-concepts" target="_blank" class="resource-link">OOP Concepts in Java - JavaTpoint</a>
            <a href="https://www.geeksforgeeks.org/object-oriented-programming-oops-concept-in-java/" target="_blank" class="resource-link">Introduction to OOP - GeeksforGeeks</a>
            <a href="https://www.tutorialspoint.com/java/java_object_oriented.htm" target="_blank" class="resource-link">Java OOP - TutorialsPoint</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://www.baeldung.com/java-oop" target="_blank" class="resource-link">Advanced OOP Concepts - Baeldung</a>
            <a href="https://docs.oracle.com/javase/tutorial/java/IandI/" target="_blank" class="resource-link">Inheritance and Interfaces - Oracle Docs</a>
        --></div>
        ...
        <div id="videos" class="slider-section" style="display: none;">
            ...
            <a href="https://www.youtube.com/watch?v=EiOglTERPEo" target="_blank" class="resource-link">Java OOP Basics - Programming with Mosh</a>
            <a href="https://www.youtube.com/watch?v=8cm1x4bC610" target="_blank" class="resource-link">OOP in Java - freeCodeCamp</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=U5XWTBK2tf4" target="_blank" class="resource-link">Advanced OOP Concepts - Telusko</a>
            <a href="https://www.youtube.com/watch?v=0h-8UNuhKzI" target="_blank" class="resource-link">Mastering OOP in Java - CodeAcademy</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/java-the-complete-java-developer-course/" target="_blank" class="resource-link">Complete Java Developer Course - Udemy</a>
            <a href="https://www.coursera.org/learn/object-oriented-java" target="_blank" class="resource-link">Object-Oriented Programming in Java - Coursera</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.udemy.com/course/java-object-oriented-programming/" target="_blank" class="resource-link">Advanced OOP in Java - Udemy</a>
            <a href="https://www.edx.org/course/software-construction-object-oriented-design" target="_blank" class="resource-link">Object-Oriented Design - edX</a>
        --></div>
    </div>
