...
?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://redux.js.org/introduction/getting-started" target="_blank" class="resource-link">Getting Started with Redux</a>
            <a href="https://vuex.vuejs.org/guide/" target="_blank" class="resource-link">Vuex Documentation</a>
            <a href="https://react.dev/learn/state-a-guide-to-react-context" target="_blank" class="resource-link">React Context Guide</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://redux.js.org/recipes/usage-with-typescript" target="_blank" class="resource-link">Redux with TypeScript</a>
            <a href="https://vuex.vuejs.org/advanced/" target="_blank" class="resource-link">Vuex Advanced Features</a>
            <a href="https://kentcdodds.com/blog/application-state-management-with-react" target="_blank" class="resource-link">Advanced State Management in React</a>
    --></div>
    ...
    ?>
            ...
            <a href="https://www.youtube.com/watch?v=CVpUuw9XSjY" target="_blank" class="resource-link">Redux Tutorial for Beginners</a>
            <a href="https://www.youtube.com/watch?v=5lVQgZzLMHc" target="_blank" class="resource-link">Vuex Crash Course</a>
            <a href="https://www.youtube.com/watch?v=35lXWvCuM8o" target="_blank" class="resource-link">React Context API Tutorial</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=6fNy0iD3hsk" target="_blank" class="resource-link">Redux Advanced Usage</a>
            <a href="https://www.youtube.com/watch?v=NLuZd8I66iQ" target="_blank" class="resource-link">Advanced Vuex Tutorial</a>
            <a href="https://www.youtube.com/watch?v=kjQ4OU8opqg" target="_blank" class="resource-link">Advanced State Management in React</a>
    --></div>
...
?>
            ...
            <a href="https://www.udemy.com/course/redux-tutorial/" target="_blank" class="resource-link">Redux Mastery - Udemy</a>
            <a href="https://www.udemy.com/course/vuejs-vuex/" target="_blank" class="resource-link">Vuex Masterclass - Udemy</a>
            <a href="https://www.udemy.com/course/react-context-api-guide/" target="_blank" class="resource-link">React Context API Guide - Udemy</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://frontendmasters.com/courses/redux-fundamentals/" target="_blank" class="resource-link">Redux Fundamentals - Frontend Masters</a>
            <a href="https://frontendmasters.com/courses/vuex/" target="_blank" class="resource-link">Advanced Vuex - Frontend Masters</a>
            <a href="https://frontendmasters.com/courses/react-state/" target="_blank" class="resource-link">Advanced State Management in React - Frontend Masters</a>
    --></div>
    </div>
