...
<head>
    ...
    <title>Skill Route - Advanced HTML: Microdata and Metadata</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Advanced HTML: Microdata and Metadata</div>
...
?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/meta" target="_blank" class="resource-link">MDN - Metadata and Meta Tags</a>
            <a href="https://www.semrush.com/blog/html-microdata-guide/" target="_blank" class="resource-link">SEMRush - Microdata Guide</a>
            <a href="https://web.dev/structured-data/" target="_blank" class="resource-link">Web.dev - Structured Data Basics</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://schema.org/docs/gs.html" target="_blank" class="resource-link">Schema.org - Getting Started</a>
            <a href="https://yoast.com/structured-data-schema-json-ld/" target="_blank" class="resource-link">Yoast - Structured Data and JSON-LD</a>
            <a href="https://www.smashingmagazine.com/2017/03/metadata-microdata-markup-guide-seo/" target="_blank" class="resource-link">Smashing Magazine - Metadata and Microdata Guide</a>
        --></div>
        ...
        <div id="videos" class="slider-section" style="display: none;">
            ...
            <a href="https://www.youtube.com/watch?v=FtQi5nE0f5w" target="_blank" class="resource-link">Metadata Basics for HTML</a>
            <a href="https://www.youtube.com/watch?v=eg1U5kIit6Q" target="_blank" class="resource-link">Introduction to Microdata</a>
            <a href="https://www.youtube.com/watch?v=B7kXn-xIfrA" target="_blank" class="resource-link">HTML Metadata and Microdata Explained</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=aHeTj0Rf9SA" target="_blank" class="resource-link">Advanced Metadata and SEO</a>
            <a href="https://www.youtube.com/watch?v=Z5uDyeG-DmE" target="_blank" class="resource-link">Using Schema.org for Structured Data</a>
            <a href="https://www.youtube.com/watch?v=FsD9wZJpTQU" target="_blank" class="resource-link">JSON-LD for SEO</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/html-for-beginners/" target="_blank" class="resource-link">Udemy - HTML Basics</a>
            <a href="https://www.codecademy.com/learn/learn-html" target="_blank" class="resource-link">Codecademy - Learn HTML</a>
            <a href="https://www.coursera.org/learn/html-css-javascript-for-web-developers" target="_blank" class="resource-link">Coursera - HTML Essentials</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://frontendmasters.com/courses/html-structure-data/" target="_blank" class="resource-link">Frontend Masters - Structured Data and Metadata</a>
            <a href="https://www.udemy.com/course/seo-for-beginners/" target="_blank" class="resource-link">Udemy - Advanced HTML SEO Techniques</a>
            <a href="https://www.linkedin.com/learning/html-seo-and-microdata/" target="_blank" class="resource-link">LinkedIn Learning - SEO and Microdata</a>
        --></div>
    </div>
