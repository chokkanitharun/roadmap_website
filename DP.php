...
<head>
    ...
    <title>Skill Route - Data Persistence</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Data Persistence</div>
...
?>
            ...
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://developer.android.com/training/data-storage" target="_blank" class="resource-link">Data Storage Overview - Official Guide</a>
            <a href="https://www.geeksforgeeks.org/sharedpreferences-in-android-with-examples/" target="_blank" class="resource-link">SharedPreferences in Android - GeeksforGeeks</a>
            <a href="https://www.geeksforgeeks.org/sqlite-in-android/" target="_blank" class="resource-link">SQLite Database in Android - GeeksforGeeks</a>
            
            <div class="section-title">FOR ADVANCED</div>
            <a href="https://developer.android.com/jetpack/androidx/releases/room" target="_blank" class="resource-link">Room Database - Official Guide</a>
            <a href="https://medium.com/androiddevelopers/room-simplified-34c6bbf986e2" target="_blank" class="resource-link">Simplifying Room Database - Medium</a>
            <a href="https://proandroiddev.com/mastering-room-architecture-on-android-d179b1234d69" target="_blank" class="resource-link">Mastering Room Architecture - ProAndroidDev</a>
        --></div>
...
?>
            ...
            <a href="https://www.youtube.com/watch?v=cp2rL3sAFmI" target="_blank" class="resource-link">Introduction to Data Persistence - Simplilearn</a>
            <a href="https://www.youtube.com/watch?v=RfzVfzlG4xA" target="_blank" class="resource-link">SharedPreferences in Android - Code With Harry</a>
            <a href="https://www.youtube.com/watch?v=gfsowjoU5dU" target="_blank" class="resource-link">Working with SQLite Databases - Edureka</a>
            
            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=hlgXAB9Lc6Y" target="_blank" class="resource-link">Room Database - Android Developers</a>
            <a href="https://www.youtube.com/watch?v=lwAvI3WDXBY" target="_blank" class="resource-link">Advanced Room Database Concepts - TechWithTim</a>
            <a href="https://www.youtube.com/watch?v=qOF92q5I_BU" target="_blank" class="resource-link">Optimizing Room Database - ProgrammingKnowledge</a>
        --></div>
...
?>
            ...
            <a href="https://www.udemy.com/course/android-local-database-with-room/" target="_blank" class="resource-link">Android Local Database with Room - Udemy</a>
            <a href="https://www.coursera.org/learn/android-programming" target="_blank" class="resource-link">Android Programming Basics - Coursera</a>
            <a href="https://www.pluralsight.com/courses/android-data-storage-techniques" target="_blank" class="resource-link">Android Data Storage - Pluralsight</a>
            
            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.udemy.com/course/android-room-database-advanced/" target="_blank" class="resource-link">Room Database Advanced Techniques - Udemy</a>
            <a href="https://frontendmasters.com/courses/android-room-database/" target="_blank" class="resource-link">Room Database Masterclass - Frontend Masters</a>
            <a href="https://www.edx.org/course/android-data-persistence" target="_blank" class="resource-link">Android Data Persistence - edX</a>
        --></div>
    </div>
