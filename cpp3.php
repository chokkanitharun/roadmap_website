...
<head>
    ...
    <title>Skill Route - Memory Management</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Memory Management</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://www.geeksforgeeks.org/memory-management-in-c/" target="_blank" class="resource-link">Memory Management in C++ - GeeksforGeeks</a>
            <a href="https://cplusplus.com/doc/tutorial/dynamic/" target="_blank" class="resource-link">Dynamic Memory in C++ - Cplusplus.com</a>
            <a href="https://www.programiz.com/cpp-programming/dynamic-memory" target="_blank" class="resource-link">Dynamic Memory Allocation in C++ - Programiz</a>
            
            <div class="section-title">FOR ADVANCED</div>
            <a href="https://isocpp.org/wiki/faq/dynamic-memory" target="_blank" class="resource-link">Advanced Memory Management - ISO C++</a>
            <a href="https://www.learncpp.com/cpp-tutorial/smart-pointers/" target="_blank" class="resource-link">Smart Pointers in C++ - LearnCpp</a>
            <a href="https://www.udemy.com/course/advanced-memory-management-in-cpp/" target="_blank" class="resource-link">Advanced Memory Management in C++ - Udemy</a>
        --></div>
 ...
 <?php
     foreach ($vadvanceLinks as $name => $url) {
         ...
         ';
            ...
            <a href="https://www.youtube.com/watch?v=9UgsqZnpMCw" target="_blank" class="resource-link">Memory Management in C++ - CodeBeauty</a>
            <a href="https://www.youtube.com/watch?v=2IuQuAe61rY" target="_blank" class="resource-link">Dynamic Memory Basics - ProgrammingKnowledge</a>
            <a href="https://www.youtube.com/watch?v=I4gZVMbhKe4" target="_blank" class="resource-link">Pointers and Memory Management - Simplilearn</a>
            
            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=uCH_fR1nED8" target="_blank" class="resource-link">Advanced Memory Management in C++ - FreeCodeCamp</a>
            <a href="https://www.youtube.com/watch?v=vmbILlrsWGQ" target="_blank" class="resource-link">C++ Smart Pointers - The Cherno</a>
            <a href="https://www.youtube.com/watch?v=MUUNPyyA1XQ" target="_blank" class="resource-link">Efficient Memory Management Techniques - Udemy</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/memory-management-cpp-basics/" target="_blank" class="resource-link">Memory Management Basics - Udemy</a>
            <a href="https://www.coursera.org/learn/memory-management-in-cpp" target="_blank" class="resource-link">Memory Management in C++ - Coursera</a>
            <a href="https://www.codecademy.com/learn/cplusplus-pointers" target="_blank" class="resource-link">Pointers and Memory in C++ - Codecademy</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.udemy.com/course/advanced-memory-techniques-in-cpp/" target="_blank" class="resource-link">Advanced Memory Techniques in C++ - Udemy</a>
            <a href="https://frontendmasters.com/courses/cpp-memory-management/" target="_blank" class="resource-link">Memory Management Masterclass - Frontend Masters</a>
            <a href="https://www.edx.org/course/cpp-memory-management-techniques" target="_blank" class="resource-link">C++ Memory Management - edX</a>
        --></div>
    </div>
