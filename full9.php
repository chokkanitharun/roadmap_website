...
<head>
    ...
    <title>Skill Route - Deployment & DevOps Basics</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Deployment & DevOps Basics</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://vercel.com/docs" target="_blank" class="resource-link">Vercel Documentation</a>
            ...
            <a href="https://circleci.com/docs/" target="_blank" class="resource-link">CircleCI Documentation</a>
        --></div>
 ...
 <?php
     foreach ($vadvanceLinks as $name => $url) {
         ...
         ';
            ...
            <a href="https://www.youtube.com/watch?v=RljEVCdRoMA" target="_blank" class="resource-link">YouTube - Deploying on Vercel</a>
            <a href="https://www.youtube.com/watch?v=fBbSxUeOQ7A" target="_blank" class="resource-link">YouTube - Deploying on Heroku</a>
            <a href="https://www.youtube.com/watch?v=zYXif4h_sqU" target="_blank" class="resource-link">YouTube - AWS Basics</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=hgz1RY0Kn2Q" target="_blank" class="resource-link">YouTube - CI/CD Explained</a>
            <a href="https://www.youtube.com/watch?v=fS8KQNUqwrs" target="_blank" class="resource-link">YouTube - Docker for Beginners</a>
            <a href="https://www.youtube.com/watch?v=6sqB_aW-QXk" target="_blank" class="resource-link">YouTube - Advanced DevOps Practices</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/deploying-to-heroku/" target="_blank" class="resource-link">Udemy - Deploying to Heroku</a>
            <a href="https://www.udemy.com/course/aws-essentials/" target="_blank" class="resource-link">Udemy - AWS Essentials</a>
            <a href="https://frontendmasters.com/courses/intro-to-ci-cd/" target="_blank" class="resource-link">Frontend Masters - Introduction to CI/CD</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.pluralsight.com/courses/docker-deployment" target="_blank" class="resource-link">Pluralsight - Docker Deployment</a>
            <a href="https://www.coursera.org/specializations/devops" target="_blank" class="resource-link">Coursera - DevOps Specialization</a>
            <a href="https://www.edx.org/course/ci-cd-pipelines-with-jenkins" target="_blank" class="resource-link">edX - CI/CD Pipelines with Jenkins</a>
        --></div>
    </div>
