...
<head>
    ...
    <title>Skill Route - Design Patterns</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Design Patterns</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://www.geeksforgeeks.org/design-patterns-set-1-introduction/" target="_blank" class="resource-link">Introduction to Design Patterns - GeeksforGeeks</a>
            <a href="https://refactoring.guru/design-patterns" target="_blank" class="resource-link">Design Patterns Basics - Refactoring Guru</a>
            <a href="https://www.programiz.com/cpp-programming/design-patterns" target="_blank" class="resource-link">Design Patterns in C++ - Programiz</a>
            
            <div class="section-title">FOR ADVANCED</div>
            <a href="https://sourcemaking.com/design_patterns" target="_blank" class="resource-link">Advanced Design Patterns - SourceMaking</a>
            <a href="https://www.learncpp.com/cpp-tutorial/introduction-to-design-patterns/" target="_blank" class="resource-link">Learn Design Patterns - LearnCpp</a>
            <a href="https://www.udemy.com/course/mastering-design-patterns-in-cpp/" target="_blank" class="resource-link">Master Design Patterns in C++ - Udemy</a>
        --></div>
 ...
 <?php
     foreach ($vadvanceLinks as $name => $url) {
         ...
         ';
            ...
            <a href="https://www.youtube.com/watch?v=HhVx0-I2GoA" target="_blank" class="resource-link">Introduction to Design Patterns - Programming with Mosh</a>
            <a href="https://www.youtube.com/watch?v=wlb5l2fi-F8" target="_blank" class="resource-link">Learn Design Patterns - CodeWithHarry</a>
            <a href="https://www.youtube.com/watch?v=NuPp6f4e5EA" target="_blank" class="resource-link">Design Patterns Basics - The Cherno</a>
            
            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=bg4z3aFZrMs" target="_blank" class="resource-link">Advanced Design Patterns - FreeCodeCamp</a>
            <a href="https://www.youtube.com/watch?v=8cV4ZvHXQL4" target="_blank" class="resource-link">Implementing Patterns in C++ - Simplilearn</a>
            <a href="https://www.youtube.com/watch?v=U46KzsDlrj4" target="_blank" class="resource-link">Design Patterns in Practice - The Net Ninja</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/design-patterns-cpp-for-beginners/" target="_blank" class="resource-link">Design Patterns for Beginners - Udemy</a>
            <a href="https://www.coursera.org/learn/cpp-design-patterns" target="_blank" class="resource-link">Design Patterns Basics - Coursera</a>
            <a href="https://www.codecademy.com/learn/cpp-design-patterns" target="_blank" class="resource-link">Learn Design Patterns in C++ - Codecademy</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.udemy.com/course/mastering-cpp-design-patterns/" target="_blank" class="resource-link">Mastering C++ Design Patterns - Udemy</a>
            <a href="https://frontendmasters.com/courses/cpp-design-patterns/" target="_blank" class="resource-link">Design Patterns Masterclass - Frontend Masters</a>
            <a href="https://www.edx.org/course/cplusplus-design-patterns" target="_blank" class="resource-link">Advanced Design Patterns in C++ - edX</a>
        --></div>
    </div>
