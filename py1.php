...
<head>
    ...
    <title>Skill Route - Python Basics</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Python Basics</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://www.w3schools.com/python/python_intro.asp" target="_blank" class="resource-link">Python Introduction - W3Schools</a>
            <a href="https://www.geeksforgeeks.org/python-basics/" target="_blank" class="resource-link">Python Basics - GeeksforGeeks</a>
            <a href="https://realpython.com/python-first-steps/" target="_blank" class="resource-link">First Steps with Python - Real Python</a>
            
            <div class="section-title">FOR ADVANCED</div>
            <a href="https://www.learnpython.org/" target="_blank" class="resource-link">Learn Python Interactive Tutorial</a>
            <a href="https://docs.python.org/3/tutorial/" target="_blank" class="resource-link">Python Official Documentation - Tutorial</a>
            <a href="https://automatetheboringstuff.com/" target="_blank" class="resource-link">Automate the Boring Stuff with Python</a>
        --></div>
 ...
 <?php
     foreach ($vadvanceLinks as $name => $url) {
         ...
         ';
            ...
            <a href="https://www.youtube.com/watch?v=rfscVS0vtbw" target="_blank" class="resource-link">Python Full Course for Beginners - FreeCodeCamp</a>
            <a href="https://www.youtube.com/watch?v=kqtD5dpn9C8" target="_blank" class="resource-link">Python Basics - Programming with Mosh</a>
            <a href="https://www.youtube.com/watch?v=YYXdXT2l-Gg" target="_blank" class="resource-link">Learn Python in 1 Hour - Tech with Tim</a>
            
            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=f79MRyMsjrQ" target="_blank" class="resource-link">Python Official Tutorials - Corey Schafer</a>
            <a href="https://www.youtube.com/watch?v=1Lfv5tUGsn8" target="_blank" class="resource-link">Python Advanced Concepts - FreeCodeCamp</a>
            <a href="https://www.youtube.com/watch?v=gOetkGkbMXY" target="_blank" class="resource-link">Understanding Python Loops - Edureka</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.coursera.org/specializations/python" target="_blank" class="resource-link">Python for Everybody - Coursera</a>
            <a href="https://www.udemy.com/course/python-the-complete-python-developer-course/" target="_blank" class="resource-link">Complete Python Developer - Udemy</a>
            <a href="https://www.codecademy.com/learn/learn-python-3" target="_blank" class="resource-link">Learn Python 3 - Codecademy</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.datacamp.com/tracks/python" target="_blank" class="resource-link">Python Tracks - DataCamp</a>
            <a href="https://www.edx.org/course/python-basics-for-data-science" target="_blank" class="resource-link">Python Basics for Data Science - edX</a>
            <a href="https://frontendmasters.com/courses/complete-intro-python/" target="_blank" class="resource-link">Complete Intro to Python - Frontend Masters</a>
        --></div>
    </div>
