...
<head>
    ...
    <title>Skill Route - JavaScript ES6+ Features</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">JavaScript ES6+ Features</div>
...
?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Functions/Arrow_functions" target="_blank" class="resource-link">Arrow Functions - MDN</a>
            <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Destructuring_assignment" target="_blank" class="resource-link">Destructuring in JavaScript - MDN</a>
            <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Using_promises" target="_blank" class="resource-link">Promises in JavaScript - MDN</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://javascript.info/async-await" target="_blank" class="resource-link">Async/Await Deep Dive - JavaScript.info</a>
            <a href="https://exploringjs.com/es6/" target="_blank" class="resource-link">Exploring ES6 - Advanced Topics</a>
--></div>
    ...
    ?>
            ...
            <a href="https://www.youtube.com/watch?v=NCwa_xi0Uuc" target="_blank" class="resource-link">Understanding Arrow Functions</a>
            <a href="https://www.youtube.com/watch?v=niUpk9N93k8" target="_blank" class="resource-link">Promises Explained - Academind</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=vn3tm0quoqE" target="_blank" class="resource-link">Async/Await in JavaScript - Fireship</a>
            <a href="https://www.youtube.com/watch?v=MGhw6XliFgo" target="_blank" class="resource-link">JavaScript Modules Explained - Traversy Media</a>
--></div>
...
?>
            ...
            <a href="https://www.udemy.com/course/modern-javascript-from-the-beginning/" target="_blank" class="resource-link">Modern JavaScript from the Beginning - Udemy</a>
            <a href="https://scrimba.com/learn/es6" target="_blank" class="resource-link">JavaScript ES6 Basics - Scrimba</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://frontendmasters.com/courses/javascript-es6/" target="_blank" class="resource-link">JavaScript ES6+ - Frontend Masters</a>
            <a href="https://www.pluralsight.com/courses/javascript-fundamentals-es6" target="_blank" class="resource-link">JavaScript Fundamentals ES6+ - Pluralsight</a>
--></div>
    </div>
