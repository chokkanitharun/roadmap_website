...
?>
            <!--<a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide" target="_blank" class="resource-link">JavaScript Guide - MDN</a>
            <a href="https://javascript.info/" target="_blank" class="resource-link">JavaScript Info</a>
            <a href="https://blog.logrocket.com/a-guide-to-es6-arrow-functions/" target="_blank" class="resource-link">Guide to ES6 Arrow Functions</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://tc39.es/ecma262/" target="_blank" class="resource-link">ECMAScript Specification</a>
            <a href="https://medium.com/javascript-in-plain-english/async-await-explained-cfdce2594d9c" target="_blank" class="resource-link">Understanding Async/Await</a>
            <a href="https://blog.bitsrc.io/javascript-destructuring-8d84991e91c9" target="_blank" class="resource-link">Advanced Destructuring in JavaScript</a>
    --></div>
    ...
    ?>
            ...
            <a href="https://www.youtube.com/watch?v=W6NZfCO5SIk" target="_blank" class="resource-link">JavaScript Basics Tutorial</a>
            <a href="https://www.youtube.com/watch?v=NCwa_xi0Uuc" target="_blank" class="resource-link">Promises in JavaScript</a>
            <a href="https://www.youtube.com/watch?v=V_Kr9OSfDeU" target="_blank" class="resource-link">Understanding Async/Await</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=ukwnU7P8bZs" target="_blank" class="resource-link">Mastering JavaScript Destructuring</a>
            <a href="https://www.youtube.com/watch?v=jV8B24rSN5o" target="_blank" class="resource-link">ES6+ Features Deep Dive</a>
            <a href="https://www.youtube.com/watch?v=3YcGJ31bKXY" target="_blank" class="resource-link">Functional Programming in JavaScript</a>
    --></div>
...
?>
            ...
            <a href="https://www.codecademy.com/learn/introduction-to-javascript" target="_blank" class="resource-link">JavaScript Course - Codecademy</a>
            <a href="https://scrimba.com/learn/learnjavascript" target="_blank" class="resource-link">Scrimba JavaScript Course</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://frontendmasters.com/courses/js-fundamentals/" target="_blank" class="resource-link">JavaScript Fundamentals - Frontend Masters</a>
            <a href="https://www.pluralsight.com/courses/javascript-es6" target="_blank" class="resource-link">ES6 and Beyond - Pluralsight</a>
            <a href="https://www.coursera.org/learn/javascript" target="_blank" class="resource-link">Advanced JavaScript Concepts - Coursera</a>
    --></div>
    </div>
