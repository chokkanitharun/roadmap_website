...
<head>
    ...
    <title>Skill Route - Data Science & Machine Learning</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Data Science and Machine Learning</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://scikit-learn.org/stable/tutorial/basic/tutorial.html" target="_blank" class="resource-link">Scikit-Learn Basic Tutorial</a>
            <a href="https://www.tensorflow.org/tutorials" target="_blank" class="resource-link">TensorFlow Tutorials - Official Docs</a>
            <a href="https://keras.io/getting_started/" target="_blank" class="resource-link">Getting Started with Keras</a>
            
            <div class="section-title">FOR ADVANCED</div>
            <a href="https://scikit-learn.org/stable/auto_examples/index.html" target="_blank" class="resource-link">Scikit-Learn Advanced Examples</a>
            <a href="https://www.tensorflow.org/guide" target="_blank" class="resource-link">TensorFlow Guide - Advanced Topics</a>
            <a href="https://keras.io/examples/" target="_blank" class="resource-link">Keras Examples - Official Docs</a>
        --></div>
 ...
 <?php
     foreach ($vadvanceLinks as $name => $url) {
         ...
         ';
            ...
            <a href="https://www.youtube.com/watch?v=GvtNyOzGogc" target="_blank" class="resource-link">Scikit-Learn Crash Course - Edureka</a>
            <a href="https://www.youtube.com/watch?v=tPYj3fFJGjk" target="_blank" class="resource-link">TensorFlow Basics - FreeCodeCamp</a>
            <a href="https://www.youtube.com/watch?v=f5OET0DaIoU" target="_blank" class="resource-link">Keras Introduction - Simplilearn</a>
            
            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=0Wt1pnWVlzI" target="_blank" class="resource-link">Advanced Machine Learning - Tech with Tim</a>
            <a href="https://www.youtube.com/watch?v=GZbA8zTRF6c" target="_blank" class="resource-link">TensorFlow Deep Learning - Sentdex</a>
            <a href="https://www.youtube.com/watch?v=ueU7RtmBfJ0" target="_blank" class="resource-link">Mastering Keras - Corey Schafer</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/data-science-for-beginners/" target="_blank" class="resource-link">Data Science for Beginners - Udemy</a>
            <a href="https://www.coursera.org/learn/machine-learning" target="_blank" class="resource-link">Machine Learning by Andrew Ng - Coursera</a>
            <a href="https://www.datacamp.com/courses/intro-to-machine-learning-with-scikit-learn" target="_blank" class="resource-link">Intro to ML with Scikit-Learn - DataCamp</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.educative.io/courses/advanced-machine-learning" target="_blank" class="resource-link">Advanced Machine Learning - Educative.io</a>
            <a href="https://frontendmasters.com/courses/tensorflow/" target="_blank" class="resource-link">TensorFlow Advanced - Frontend Masters</a>
            <a href="https://www.codecademy.com/learn/advanced-machine-learning" target="_blank" class="resource-link">Advanced ML Concepts - Codecademy</a>
        --></div>
    </div>
