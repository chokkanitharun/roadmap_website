...
<head>
    ...
    <title>Skill Route - DOM Manipulation</title>
    <style>
...
?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://developer.mozilla.org/en-US/docs/Web/API/Document_Object_Model" target="_blank" class="resource-link">Introduction to DOM - MDN</a>
            <a href="https://www.w3schools.com/js/js_htmldom.asp" target="_blank" class="resource-link">JavaScript HTML DOM - W3Schools</a>
            <a href="https://www.javascripttutorial.net/javascript-dom/" target="_blank" class="resource-link">JavaScript DOM Tutorial</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://javascript.info/dom-nodes" target="_blank" class="resource-link">Deep Dive into DOM Nodes</a>
            <a href="https://medium.com/javascript-in-plain-english/dom-manipulation-best-practices-9c93c4f7229" target="_blank" class="resource-link">DOM Manipulation Best Practices</a>
    --></div>
    ...
    ?>
            ...
            <a href="https://www.youtube.com/watch?v=wiozYyXQEVk" target="_blank" class="resource-link">JavaScript DOM Crash Course - Traversy Media</a>
            <a href="https://www.youtube.com/watch?v=0ik6X4DJKCc" target="_blank" class="resource-link">DOM Manipulation Basics - The Net Ninja</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=W6NZfCO5SIk" target="_blank" class="resource-link">Advanced DOM Techniques</a>
            <a href="https://www.youtube.com/watch?v=-uRc4UMcUyk" target="_blank" class="resource-link">Efficient DOM Manipulation - Fireship</a>
    --></div>
...
?>
            ...
            <a href="https://www.udemy.com/course/javascript-dom-tutorial/" target="_blank" class="resource-link">JavaScript DOM Basics - Udemy</a>
            <a href="https://www.codecademy.com/learn/learn-intermediate-javascript" target="_blank" class="resource-link">Intermediate JavaScript - Codecademy</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://frontendmasters.com/courses/javascript-dom/" target="_blank" class="resource-link">DOM Manipulation Advanced Techniques - Frontend Masters</a>
            <a href="https://www.pluralsight.com/courses/javascript-html-dom-manipulation" target="_blank" class="resource-link">JavaScript DOM Manipulation - Pluralsight</a>
    --></div>
    </div>
