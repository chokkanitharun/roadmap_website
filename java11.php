...
<body>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://www.baeldung.com/learn-maven" target="_blank" class="resource-link">Maven Tutorial - Baeldung</a>
            <a href="https://spring.io/guides/gs/maven/" target="_blank" class="resource-link">Getting Started with Maven - Spring</a>
            <a href="https://git-scm.com/book/en/v2" target="_blank" class="resource-link">Pro Git - Official Book</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://www.baeldung.com/gradle" target="_blank" class="resource-link">Gradle Advanced Concepts - Baeldung</a>
            <a href="https://www.atlassian.com/git/tutorials" target="_blank" class="resource-link">Advanced Git Tutorials - Atlassian</a>
        --></div>
        ...
        <div id="videos" class="slider-section" style="display: none;">
            ...
            <a href="https://www.youtube.com/watch?v=1uaXN-nEx38" target="_blank" class="resource-link">Maven Tutorial for Beginners</a>
            <a href="https://www.youtube.com/watch?v=fzA1D0nDRFc" target="_blank" class="resource-link">Getting Started with Gradle</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=5dGV7lY0OdE" target="_blank" class="resource-link">Advanced Maven Concepts</a>
            <a href="https://www.youtube.com/watch?v=HgpiRaDpSkE" target="_blank" class="resource-link">Advanced Git Tutorial</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/apache-maven/" target="_blank" class="resource-link">Apache Maven - Udemy</a>
            <a href="https://www.udemy.com/course/gradle-for-beginners/" target="_blank" class="resource-link">Gradle for Beginners - Udemy</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.udemy.com/course/advanced-git-and-github/" target="_blank" class="resource-link">Advanced Git and GitHub - Udemy</a>
            <a href="https://www.coursera.org/learn/gradle" target="_blank" class="resource-link">Gradle for Developers - Coursera</a>
        --></div>
    </div>
