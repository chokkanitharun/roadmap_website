...
<head>
    ...
    <title>Skill Route - Advanced Kotlin Features</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Advanced Kotlin Features</div>
...
?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://kotlinlang.org/docs/inline-functions.html" target="_blank" class="resource-link">Kotlin Docs - Inline Functions</a>
            <a href="https://www.baeldung.com/kotlin/dsl" target="_blank" class="resource-link">Baeldung - Kotlin DSL Introduction</a>
            <a href="https://www.tutorialspoint.com/kotlin/kotlin_extension_functions.htm" target="_blank" class="resource-link">TutorialsPoint - Extension Functions</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://proandroiddev.com/advanced-kotlin-features-40f090312f3" target="_blank" class="resource-link">ProAndroidDev - Advanced Kotlin Features</a>
            <a href="https://medium.com/androiddevelopers/kotlin-dsl-introduction-3c5d26ae7b3" target="_blank" class="resource-link">Medium - Kotlin DSL</a>
            <a href="https://blog.kotlin-academy.com/type-safe-builders-in-kotlin-a62756c76e" target="_blank" class="resource-link">Kotlin Academy - Type-Safe Builders</a>
        --></div>
        ...
        <div id="videos" class="slider-section" style="display: none;">
            ...
            <a href="https://www.youtube.com/watch?v=eyOVCrt_zFg" target="_blank" class="resource-link">YouTube - Inline Functions in Kotlin</a>
            <a href="https://www.youtube.com/watch?v=CnEJFRrGJAo" target="_blank" class="resource-link">YouTube - Kotlin DSL Basics</a>
            <a href="https://www.youtube.com/watch?v=JgfyBdNSCZ8" target="_blank" class="resource-link">YouTube - Extension Functions Tutorial</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=o4u8X9Sx7OM" target="_blank" class="resource-link">YouTube - Advanced Kotlin Inline Functions</a>
            <a href="https://www.youtube.com/watch?v=vs57b21e7FQ" target="_blank" class="resource-link">YouTube - Kotlin DSL for Professionals</a>
            <a href="https://www.youtube.com/watch?v=Ehz8FfDncuM" target="_blank" class="resource-link">YouTube - Advanced Extension Functions</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/kotlin-advanced-features/" target="_blank" class="resource-link">Udemy - Kotlin Advanced Features</a>
            <a href="https://pluralsight.com/courses/kotlin-advanced-programming" target="_blank" class="resource-link">Pluralsight - Advanced Programming in Kotlin</a>
            <a href="https://www.coursera.org/learn/advanced-kotlin-programming" target="_blank" class="resource-link">Coursera - Advanced Kotlin Programming</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.udemy.com/course/kotlin-advanced/" target="_blank" class="resource-link">Udemy - Kotlin Masterclass</a>
            <a href="https://www.linkedin.com/learning/advanced-kotlin-programming/" target="_blank" class="resource-link">LinkedIn Learning - Advanced Kotlin</a>
            <a href="https://kotlin-academy.teachable.com/p/kotlin-advanced-programming" target="_blank" class="resource-link">Kotlin Academy - Advanced Kotlin Programming</a>
        --></div>
    </div>
