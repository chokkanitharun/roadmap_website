...
<head>
    ...
    <title>Skill Route - Python Libraries</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Python Libraries</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://realpython.com/numpy-python/" target="_blank" class="resource-link">NumPy Basics - Real Python</a>
            <a href="https://pandas.pydata.org/docs/getting_started/index.html" target="_blank" class="resource-link">Pandas Getting Started - Official Docs</a>
            <a href="https://matplotlib.org/stable/users/getting_started/index.html" target="_blank" class="resource-link">Matplotlib Introduction - Matplotlib Docs</a>
            
            <div class="section-title">FOR ADVANCED</div>
            <a href="https://towardsdatascience.com/numpy-advanced-tips-and-tricks-1c8b52b9c493" target="_blank" class="resource-link">Advanced NumPy Tips - Towards Data Science</a>
            <a href="https://realpython.com/pandas-techniques/" target="_blank" class="resource-link">Advanced Pandas Techniques - Real Python</a>
            <a href="https://matplotlib.org/stable/tutorials/advanced/index.html" target="_blank" class="resource-link">Advanced Matplotlib - Official Docs</a>
        --></div>
 ...
 <?php
     foreach ($vadvanceLinks as $name => $url) {
         ...
         ';
            ...
            <a href="https://www.youtube.com/watch?v=QUT1VHiLmmI" target="_blank" class="resource-link">NumPy Basics - Corey Schafer</a>
            <a href="https://www.youtube.com/watch?v=vmEHCJofslg" target="_blank" class="resource-link">Getting Started with Pandas - FreeCodeCamp</a>
            <a href="https://www.youtube.com/watch?v=vZBCTc9zHtI" target="_blank" class="resource-link">Matplotlib Basics - Tech With Tim</a>
            
            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=4vLm_lTL6g4" target="_blank" class="resource-link">Advanced NumPy Techniques - Sentdex</a>
            <a href="https://www.youtube.com/watch?v=zpplBQiKMNU" target="_blank" class="resource-link">Advanced Pandas Tips - Edureka</a>
            <a href="https://www.youtube.com/watch?v=8vSkZRkCIdU" target="_blank" class="resource-link">Mastering Matplotlib - Clever Programmer</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/python-numpy-and-pandas-for-beginners/" target="_blank" class="resource-link">NumPy and Pandas Basics - Udemy</a>
            <a href="https://www.coursera.org/learn/data-visualization-python" target="_blank" class="resource-link">Data Visualization with Matplotlib - Coursera</a>
            <a href="https://www.datacamp.com/courses/data-manipulation-with-pandas" target="_blank" class="resource-link">Data Manipulation with Pandas - DataCamp</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.educative.io/courses/numpy-and-pandas-advanced" target="_blank" class="resource-link">NumPy and Pandas Advanced - Educative.io</a>
            <a href="https://frontendmasters.com/courses/python-visualization/" target="_blank" class="resource-link">Advanced Visualization with Matplotlib - Frontend Masters</a>
            <a href="https://www.codecademy.com/learn/advanced-pandas" target="_blank" class="resource-link">Advanced Pandas Techniques - Codecademy</a>
        --></div>
    </div>
