...
?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://www.javascript.info/" target="_blank" class="resource-link">JavaScript.info - Basics</a>
            <a href="https://www.w3schools.com/js/" target="_blank" class="resource-link">W3Schools JavaScript Tutorial</a>
            <a href="https://developer.mozilla.org/en-US/docs/Learn/JavaScript/First_steps" target="_blank" class="resource-link">MDN Web Docs - JavaScript First Steps</a>
            
            <div class="section-title">FOR ADVANCED</div>
            <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide" target="_blank" class="resource-link">MDN - JavaScript Guide</a>
            <a href="https://eloquentjavascript.net/" target="_blank" class="resource-link">Eloquent JavaScript - Advanced Concepts</a>-->
        </div>
...
?>
            ...
            <a href="https://www.youtube.com/watch?v=W6NZfCO5SIk" target="_blank" class="resource-link">JavaScript Crash Course for Beginners</a>
            <a href="https://www.youtube.com/watch?v=hdI2bqOjy3c" target="_blank" class="resource-link">JavaScript Basics - Traversy Media</a>
            
            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=2pL28CcEijU" target="_blank" class="resource-link">JavaScript ES6 - Arrow Functions, Promises</a>
            <a href="https://www.youtube.com/watch?v=0XSDAup85SA" target="_blank" class="resource-link">Advanced DOM Manipulation - Traversy Media</a>
-->  </div>
...
?>
         ...
         <!--   <div class="section-title">Course Resources for Beginners</div>
            <a href="https://www.freecodecamp.org/learn/javascript-algorithms-and-data-structures/" target="_blank" class="resource-link">FreeCodeCamp - JavaScript Basics</a>
            <a href="https://www.codecademy.com/learn/introduction-to-javascript" target="_blank" class="resource-link">Codecademy: JavaScript Fundamentals</a>
            
            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.udemy.com/course/advanced-javascript-concepts/" target="_blank" class="resource-link">Advanced JavaScript Concepts - Udemy</a>
            <a href="https://frontendmasters.com/courses/javascript-hard-parts/" target="_blank" class="resource-link">JavaScript: The Hard Parts - Frontend Masters</a>
--> </div>
    </div>
