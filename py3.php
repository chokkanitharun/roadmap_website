...
<head>
    ...
    <title>Skill Route - Object-Oriented Programming (OOP)</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Object-Oriented Programming (OOP)</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://www.geeksforgeeks.org/object-oriented-programming-in-python/" target="_blank" class="resource-link">Introduction to OOP - GeeksforGeeks</a>
            <a href="https://realpython.com/python3-object-oriented-programming/" target="_blank" class="resource-link">Python OOP Basics - Real Python</a>
            <a href="https://www.programiz.com/python-programming/object-oriented-programming" target="_blank" class="resource-link">OOP Concepts in Python - Programiz</a>
            
            <div class="section-title">FOR ADVANCED</div>
            <a href="https://www.udacity.com/blog/2021/01/python-oop.html" target="_blank" class="resource-link">Advanced OOP Concepts - Udacity</a>
            <a href="https://www.educba.com/python-oops/" target="_blank" class="resource-link">Deep Dive into Python OOP - Educba</a>
            <a href="https://python-course.eu/oop/" target="_blank" class="resource-link">Advanced OOP Topics - Python Course</a>
        --></div>
 ...
 <?php
     foreach ($vadvanceLinks as $name => $url) {
         ...
         ';
            ...
            <a href="https://www.youtube.com/watch?v=JeznW_7DlB0" target="_blank" class="resource-link">OOP Concepts in Python - Programming with Mosh</a>
            <a href="https://www.youtube.com/watch?v=RSl87lqOXDE" target="_blank" class="resource-link">Python OOP Fundamentals - Corey Schafer</a>
            <a href="https://www.youtube.com/watch?v=ZDa-Z5JzLYM" target="_blank" class="resource-link">Introduction to OOP - FreeCodeCamp</a>
            
            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=BWUIZ7eE5_M" target="_blank" class="resource-link">Advanced OOP Techniques - Clever Programmer</a>
            <a href="https://www.youtube.com/watch?v=mrx12kW2eUA" target="_blank" class="resource-link">Deep Dive into OOP Concepts - Edureka</a>
            <a href="https://www.youtube.com/watch?v=qiSCMNBIP2g" target="_blank" class="resource-link">Mastering OOP - CS Dojo</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/python-object-oriented-programming-for-beginners/" target="_blank" class="resource-link">OOP for Beginners - Udemy</a>
            <a href="https://www.coursera.org/learn/python-object-oriented-programming" target="_blank" class="resource-link">Coursera OOP Basics</a>
            <a href="https://www.codecademy.com/learn/learn-python-3" target="_blank" class="resource-link">Python OOP Path - Codecademy</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.educative.io/courses/python-object-oriented-programming" target="_blank" class="resource-link">Educative.io Advanced OOP</a>
            <a href="https://frontendmasters.com/courses/python-oop/" target="_blank" class="resource-link">OOP Masterclass - Frontend Masters</a>
            <a href="https://www.datacamp.com/courses/advanced-object-oriented-programming-in-python" target="_blank" class="resource-link">Advanced OOP in Python - DataCamp</a>
        --></div>
    </div>
