...
<head>
    ...
    <title>Skill Route - HTML SEO Basics</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">HTML SEO Basics</div>
...
?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://developer.mozilla.org/en-US/docs/Web/HTML" target="_blank" class="resource-link">MDN - HTML SEO Basics</a>
            <a href="https://moz.com/learn/seo/meta-tags" target="_blank" class="resource-link">Moz - Guide to Meta Tags</a>
            <a href="https://www.semrush.com/blog/seo-html-basics/" target="_blank" class="resource-link">SEMrush - SEO HTML Basics</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://ahrefs.com/blog/on-page-seo/" target="_blank" class="resource-link">Ahrefs - On-Page SEO Guide</a>
            <a href="https://developers.google.com/search/docs/beginner/seo-starter-guide" target="_blank" class="resource-link">Google - SEO Starter Guide</a>
            <a href="https://www.searchenginejournal.com/html-seo/413694/" target="_blank" class="resource-link">Search Engine Journal - Advanced HTML SEO</a>
        --></div>
        ...
        <div id="videos" class="slider-section" style="display: none;">
            ...
            <a href="https://www.youtube.com/watch?v=DvwS7cV9GmQ" target="_blank" class="resource-link">Introduction to SEO</a>
            <a href="https://www.youtube.com/watch?v=yFsYy2PR6vk" target="_blank" class="resource-link">SEO for Beginners</a>
            <a href="https://www.youtube.com/watch?v=ncHpOZFEYH4" target="_blank" class="resource-link">HTML Basics for SEO</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=4fXI0tPqv3o" target="_blank" class="resource-link">Advanced SEO Techniques</a>
            <a href="https://www.youtube.com/watch?v=OtY2d95iv8A" target="_blank" class="resource-link">SEO and Semantic HTML</a>
            <a href="https://www.youtube.com/watch?v=u0gglUavZAY" target="_blank" class="resource-link">Meta Tags and Heading Structures</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/seo-training/" target="_blank" class="resource-link">Udemy - SEO Training for Beginners</a>
            <a href="https://www.coursera.org/learn/search-engine-optimization" target="_blank" class="resource-link">Coursera - Search Engine Optimization</a>
            <a href="https://www.codecademy.com/learn/learn-seo" target="_blank" class="resource-link">Codecademy - Learn SEO</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://frontendmasters.com/courses/modern-seo/" target="_blank" class="resource-link">Frontend Masters - Modern SEO</a>
            <a href="https://www.udemy.com/course/advanced-seo-strategies/" target="_blank" class="resource-link">Udemy - Advanced SEO Strategies</a>
            <a href="https://www.linkedin.com/learning/seo-foundations-3/" target="_blank" class="resource-link">LinkedIn Learning - SEO Foundations</a>
        --></div>
    </div>
