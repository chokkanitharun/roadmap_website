...
<body>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://www.geeksforgeeks.org/unit-testing-in-software-engineering/" target="_blank" class="resource-link">Unit Testing in Software Engineering - GeeksforGeeks</a>
            <a href="https://www.tutorialspoint.com/software_testing/index.htm" target="_blank" class="resource-link">Software Testing Basics - TutorialsPoint</a>
            <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Debugging" target="_blank" class="resource-link">Debugging Guide - MDN</a>
            
            <div class="section-title">FOR ADVANCED</div>
            <a href="https://testing.googleblog.com/" target="_blank" class="resource-link">Google Testing Blog</a>
            <a href="https://martinfowler.com/articles/microservice-testing/" target="_blank" class="resource-link">Microservices Testing Strategies - Martin Fowler</a>
            <a href="https://www.linkedin.com/learning/software-debugging-techniques" target="_blank" class="resource-link">Software Debugging Techniques - LinkedIn Learning</a>
        --></div>
        ...
        <div id="videos" class="slider-section" style="display: none;">
            ...
            <a href="https://www.youtube.com/watch?v=ZzQfUA4TVOA" target="_blank" class="resource-link">Unit Testing Basics - FreeCodeCamp</a>
            <a href="https://www.youtube.com/watch?v=l7HkL-uMhSk" target="_blank" class="resource-link">Debugging Tips for Developers - Traversy Media</a>
            <a href="https://www.youtube.com/watch?v=Jv2uxzhPFl4" target="_blank" class="resource-link">Integration Testing Guide - edureka!</a>
            
            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=p7dIsjLpwhY" target="_blank" class="resource-link">End-to-End Testing with Cypress - TechWorld</a>
            <a href="https://www.youtube.com/watch?v=_4sP7IMQpBo" target="_blank" class="resource-link">Debugging JavaScript Like a Pro - Fireship</a>
            <a href="https://www.youtube.com/watch?v=lkdwvELhLXo" target="_blank" class="resource-link">Testing Strategies for APIs - Simplilearn</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/software-testing-for-beginners/" target="_blank" class="resource-link">Software Testing for Beginners - Udemy</a>
            <a href="https://www.coursera.org/learn/introduction-software-testing" target="_blank" class="resource-link">Introduction to Software Testing - Coursera</a>
            <a href="https://www.pluralsight.com/courses/javascript-debugging" target="_blank" class="resource-link">JavaScript Debugging - Pluralsight</a>
            
            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://frontendmasters.com/courses/testing-javascript/" target="_blank" class="resource-link">Testing JavaScript - Frontend Masters</a>
            <a href="https://www.udemy.com/course/testing-and-debugging-in-backend/" target="_blank" class="resource-link">Testing and Debugging Backend - Udemy</a>
            <a href="https://www.edx.org/course/testing-and-debugging-applications" target="_blank" class="resource-link">Testing & Debugging Applications - edX</a>
        --></div>
    </div>
