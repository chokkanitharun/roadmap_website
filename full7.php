...
<head>
    ...
    <title>Skill Route - RESTful APIs & GraphQL</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">RESTful APIs & GraphQL</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://www.restapitutorial.com/" target="_blank" class="resource-link">REST API Tutorial</a>
            <a href="https://graphql.org/learn/" target="_blank" class="resource-link">GraphQL Official Documentation</a>
            <a href="https://www.freecodecamp.org/news/rest-api-tutorial-rest-client/" target="_blank" class="resource-link">FreeCodeCamp - REST API Basics</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://graphql.org/code/" target="_blank" class="resource-link">GraphQL Tools and Libraries</a>
            <a href="https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API" target="_blank" class="resource-link">MDN - Fetch API</a>
            <a href="https://www.tutorialspoint.com/graphql/index.htm" target="_blank" class="resource-link">TutorialsPoint - Advanced GraphQL</a>
        --></div>
 ...
 <?php
     foreach ($vadvanceLinks as $name => $url) {
         ...
         ';
            ...
            <a href="https://www.youtube.com/watch?v=Q-BpqyOT3a8" target="_blank" class="resource-link">YouTube - REST API Crash Course</a>
            <a href="https://www.youtube.com/watch?v=ZQL7tL2S0oQ" target="_blank" class="resource-link">YouTube - GraphQL Tutorial</a>
            <a href="https://www.youtube.com/watch?v=fgTGADljAeg" target="_blank" class="resource-link">YouTube - REST API Basics</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=PoRJizFvM7s" target="_blank" class="resource-link">YouTube - REST API Advanced</a>
            <a href="https://www.youtube.com/watch?v=ed8SzALpx1Q" target="_blank" class="resource-link">YouTube - GraphQL Deep Dive</a>
            <a href="https://www.youtube.com/watch?v=6lQZcSp9uMg" target="_blank" class="resource-link">YouTube - Advanced REST and GraphQL</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/rest-api/" target="_blank" class="resource-link">Udemy - REST API for Beginners</a>
            <a href="https://www.udemy.com/course/graphql-with-react/" target="_blank" class="resource-link">Udemy - GraphQL with React</a>
            <a href="https://www.codecademy.com/learn/graphql" target="_blank" class="resource-link">Codecademy - Learn GraphQL</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.coursera.org/learn/graphql-advanced" target="_blank" class="resource-link">Coursera - Advanced GraphQL</a>
            <a href="https://frontendmasters.com/courses/rest-graphql/" target="_blank" class="resource-link">Frontend Masters - REST and GraphQL</a>
            <a href="https://www.pluralsight.com/courses/graphql-introduction" target="_blank" class="resource-link">Pluralsight - GraphQL for Developers</a>
        --></div>
    </div>
