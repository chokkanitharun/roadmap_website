...
<head>
    ...
    <title>Skill Route - Version Control & Collaboration</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Version Control & Collaboration</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://git-scm.com/book/en/v2" target="_blank" class="resource-link">Pro Git Book - Learn Git Basics</a>
            <a href="https://www.freecodecamp.org/news/what-is-version-control-and-why-should-you-use-it/" target="_blank" class="resource-link">What is Version Control? - FreeCodeCamp</a>
            <a href="https://guides.github.com/activities/hello-world/" target="_blank" class="resource-link">GitHub Hello World Guide</a>
            
            <div class="section-title">FOR ADVANCED</div>
            <a href="https://www.atlassian.com/git/tutorials/advanced-overview" target="_blank" class="resource-link">Advanced Git Tutorials - Atlassian</a>
            <a href="https://github.com/git-tips/tips" target="_blank" class="resource-link">Git Tips & Tricks</a>
            <a href="https://www.digitalocean.com/community/tutorials/how-to-use-git-rebase" target="_blank" class="resource-link">Mastering Git Rebase - DigitalOcean</a>
        --></div>
 ...
 <?php
     foreach ($vadvanceLinks as $name => $url) {
         ...
         ';
            ...
            <a href="https://www.youtube.com/watch?v=RGOj5yH7evk" target="_blank" class="resource-link">Git and GitHub for Beginners - FreeCodeCamp</a>
            <a href="https://www.youtube.com/watch?v=HVsySz-h9r4" target="_blank" class="resource-link">Git Tutorial for Beginners - Learn Code Academy</a>
            <a href="https://www.youtube.com/watch?v=oFYyTZwMyAg" target="_blank" class="resource-link">GitHub Collaboration Explained - The Net Ninja</a>
            
            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=CRlGDDprdOQ" target="_blank" class="resource-link">Advanced Git Commands - Fireship</a>
            <a href="https://www.youtube.com/watch?v=JhKoj-H8GQU" target="_blank" class="resource-link">Git Rebase vs Merge - GitKraken</a>
            <a href="https://www.youtube.com/watch?v=tLPmU5kM29E" target="_blank" class="resource-link">Git Workflows - Academind</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/git-and-github-bootcamp/" target="_blank" class="resource-link">Git and GitHub Bootcamp - Udemy</a>
            <a href="https://www.codecademy.com/learn/learn-git" target="_blank" class="resource-link">Learn Git - Codecademy</a>
            <a href="https://www.coursera.org/learn/introduction-git-github" target="_blank" class="resource-link">Introduction to Git and GitHub - Coursera</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://frontendmasters.com/courses/git-in-depth/" target="_blank" class="resource-link">Git In-Depth - Frontend Masters</a>
            <a href="https://www.pluralsight.com/courses/git-advanced" target="_blank" class="resource-link">Advanced Git - Pluralsight</a>
            <a href="https://www.educative.io/courses/advanced-git" target="_blank" class="resource-link">Advanced Git Concepts - Educative.io</a>
        --></div>
    </div>
