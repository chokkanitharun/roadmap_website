...
<head>
    ...
    <title>Skill Route - Computer Vision</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Computer Vision</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://www.analyticsvidhya.com/blog/2021/01/introduction-to-computer-vision/" target="_blank" class="resource-link">Analytics Vidhya - Introduction to Computer Vision</a>
            <a href="https://towardsdatascience.com/understanding-computer-vision-basics-341d5f552e83" target="_blank" class="resource-link">Towards Data Science - Computer Vision Basics</a>
            <a href="https://www.geeksforgeeks.org/computer-vision-basics/" target="_blank" class="resource-link">GeeksforGeeks - Computer Vision Overview</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://cs231n.github.io/" target="_blank" class="resource-link">Stanford - CS231n: Convolutional Neural Networks</a>
            <a href="https://arxiv.org/pdf/1409.1556.pdf" target="_blank" class="resource-link">Arxiv - Deep Learning for Vision Tasks</a>
            <a href="https://www.cv-foundation.org/" target="_blank" class="resource-link">CVPR - Latest Research Papers</a>
        --></div>
 ...
 <?php
     foreach ($vadvanceLinks as $name => $url) {
         ...
         ';
            ...
            <a href="https://www.youtube.com/watch?v=4eIBisqx9_g" target="_blank" class="resource-link">YouTube - Basics of Computer Vision</a>
            <a href="https://www.youtube.com/watch?v=5od1Akkc2rk" target="_blank" class="resource-link">YouTube - OpenCV for Beginners</a>
            <a href="https://www.youtube.com/watch?v=mT4JG9sRuqo" target="_blank" class="resource-link">YouTube - Image Processing Concepts</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=aircAruvnKk" target="_blank" class="resource-link">YouTube - Convolutional Neural Networks Explained</a>
            <a href="https://www.youtube.com/watch?v=PmZ29Vta7Vc" target="_blank" class="resource-link">YouTube - Object Detection with YOLO</a>
            <a href="https://www.youtube.com/watch?v=oLvmL_4cMbc" target="_blank" class="resource-link">YouTube - Semantic Segmentation</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.coursera.org/learn/introduction-computer-vision" target="_blank" class="resource-link">Coursera - Introduction to Computer Vision</a>
            <a href="https://www.udemy.com/course/python-for-computer-vision-with-opencv-and-deep-learning/" target="_blank" class="resource-link">Udemy - Computer Vision with OpenCV</a>
            <a href="https://www.edx.org/course/introduction-to-computer-vision-with-openvino" target="_blank" class="resource-link">edX - Computer Vision with OpenVINO</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.udacity.com/course/computer-vision-nanodegree--nd891" target="_blank" class="resource-link">Udacity - Computer Vision Nanodegree</a>
            <a href="https://www.kaggle.com/learn/computer-vision" target="_blank" class="resource-link">Kaggle - Computer Vision Path</a>
            <a href="https://www.fast.ai/" target="_blank" class="resource-link">FastAI - Deep Learning for Vision</a>
        --> </div>
    </div>
