...
<head>
    ...
    <title>Skill Route - Cloud Service Providers</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Cloud Service Providers</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            <a href="https://aws.amazon.com/what-is-aws/" target="_blank" class="resource-link">AWS - What is AWS?</a>
            <a href="https://learn.microsoft.com/en-us/azure/azure-overview/what-is-azure" target="_blank" class="resource-link">Microsoft Azure - What is Azure?</a>
            <a href="https://cloud.google.com/what-is-cloud-computing" target="_blank" class="resource-link">Google Cloud - What is Google Cloud?</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://aws.amazon.com/executive-insights/" target="_blank" class="resource-link">AWS - Executive Insights on Cloud</a>
            <a href="https://azure.microsoft.com/en-us/resources/cloud-computing-resources/" target="_blank" class="resource-link">Azure - Cloud Computing Resources</a>
            <a href="https://cloud.google.com/solutions" target="_blank" class="resource-link">Google Cloud - Cloud Solutions</a>
        </div>

        <!-- Video Resources Section -->
        <div id="videos" class="slider-section" style="display: none;">
            <div class="section-title">Video Resources for Beginners</div>
            <a href="https://www.youtube.com/watch?v=Ia-UEYYR44s" target="_blank" class="resource-link">YouTube - Introduction to AWS</a>
            <a href="https://www.youtube.com/watch?v=TXQ1OLQ9Rg8" target="_blank" class="resource-link">YouTube - Introduction to Microsoft Azure</a>
            <a href="https://www.youtube.com/watch?v=8nVsMFAAKhQ" target="_blank" class="resource-link">YouTube - Introduction to Google Cloud</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=E2X2eylJ1ts" target="_blank" class="resource-link">YouTube - AWS Cloud Architect Deep Dive</a>
            <a href="https://www.youtube.com/watch?v=MS9CUjwklvQ" target="_blank" class="resource-link">YouTube - Microsoft Azure Advanced Features</a>
            <a href="https://www.youtube.com/watch?v=QK0vJjfeGmY" target="_blank" class="resource-link">YouTube - Google Cloud Advanced Concepts</a>
        </div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/az-900-microsoft-azure-fundamentals/" target="_blank" class="resource-link">Udemy - Microsoft Azure Fundamentals</a>
            ...
            <a href="https://www.coursera.org/specializations/google-cloud" target="_blank" class="resource-link">Coursera - Google Cloud Specialization</a>
