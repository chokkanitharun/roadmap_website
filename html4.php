...
<head>
    ...
    <title>Skill Route - Tables and Lists</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Tables and Lists</div>
...
?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/table" target="_blank" class="resource-link">MDN - Table Element</a>
            <a href="https://www.w3schools.com/html/html_tables.asp" target="_blank" class="resource-link">W3Schools - HTML Tables</a>
            <a href="https://www.w3schools.com/html/html_lists.asp" target="_blank" class="resource-link">W3Schools - HTML Lists</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://css-tricks.com/complete-guide-to-table-element/" target="_blank" class="resource-link">CSS-Tricks - Complete Guide to Tables</a>
            <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/ul" target="_blank" class="resource-link">MDN - Lists in HTML</a>
            <a href="https://frontendmasters.com/courses/html-tables/" target="_blank" class="resource-link">Frontend Masters - Advanced Tables</a>
        --></div>
        ...
        <div id="videos" class="slider-section" style="display: none;">
            ...
            <a href="https://www.youtube.com/watch?v=yG03hR4MrHk" target="_blank" class="resource-link">HTML Tables for Beginners</a>
            <a href="https://www.youtube.com/watch?v=KJgsSFOSQv0" target="_blank" class="resource-link">HTML Lists Tutorial</a>
            <a href="https://www.youtube.com/watch?v=R1SvYhM7cYk" target="_blank" class="resource-link">Creating Lists in HTML</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=OGzPmgsI-pQ" target="_blank" class="resource-link">Styling Tables with CSS</a>
            <a href="https://www.youtube.com/watch?v=Ko7G5U7nyXg" target="_blank" class="resource-link">HTML5 Advanced Table Features</a>
            <a href="https://www.youtube.com/watch?v=TeZFMukxy7g" target="_blank" class="resource-link">Dynamic Lists in Web Development</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.codecademy.com/learn/learn-html-tables" target="_blank" class="resource-link">Codecademy - HTML Tables</a>
            <a href="https://www.udemy.com/course/html-css-beginners/" target="_blank" class="resource-link">Udemy - HTML Basics</a>
            <a href="https://scrimba.com/learn/html" target="_blank" class="resource-link">Scrimba - HTML Lists and Tables</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.udemy.com/course/html-tables-in-depth/" target="_blank" class="resource-link">Udemy - Advanced Tables</a>
            <a href="https://frontendmasters.com/courses/html5/" target="_blank" class="resource-link">Frontend Masters - HTML5 Mastery</a>
            <a href="https://www.coursera.org/learn/html-css-javascript-for-web-developers" target="_blank" class="resource-link">Coursera - Advanced Lists and Tables</a>
        --></div>
    </div>
