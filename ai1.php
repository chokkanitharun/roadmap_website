...
<head>
    ...
    <title>Skill Route - Programming Foundations</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Programming Foundations</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://realpython.com/python-first-steps/" target="_blank" class="resource-link">Real Python - First Steps</a>
            <a href="https://www.geeksforgeeks.org/data-structures/" target="_blank" class="resource-link">GeeksforGeeks - Data Structures</a>
            <a href="https://docs.python.org/3/tutorial/index.html" target="_blank" class="resource-link">Python Official Documentation</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://leetcode.com/" target="_blank" class="resource-link">LeetCode - Practice Algorithms</a>
            <a href="https://www.python-course.eu/python3_object_oriented_programming.php" target="_blank" class="resource-link">Python OOP Concepts</a>
            <a href="https://towardsdatascience.com/algorithms-and-data-structures-you-need-to-know-35cabd7f87b6" target="_blank" class="resource-link">Towards Data Science - Algorithms</a>
        --></div>
 ...
 <?php
     foreach ($vadvanceLinks as $name => $url) {
         ...
         ';
            ...
            <a href="https://www.youtube.com/watch?v=_uQrJ0TkZlc" target="_blank" class="resource-link">YouTube - Python Full Course</a>
            <a href="https://www.youtube.com/watch?v=kLZuut1fYzQ" target="_blank" class="resource-link">YouTube - Data Structures for Beginners</a>
            <a href="https://www.youtube.com/watch?v=JeznW_7DlB0" target="_blank" class="resource-link">YouTube - OOP in Python</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=8hly31xKli0" target="_blank" class="resource-link">YouTube - Advanced Python</a>
            <a href="https://www.youtube.com/watch?v=pkYVOmU3MgA" target="_blank" class="resource-link">YouTube - Advanced Data Structures</a>
            <a href="https://www.youtube.com/watch?v=mtfHkGIxKvE" target="_blank" class="resource-link">YouTube - Algorithms Course</a>
        --> </div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
           ...
           <!-- <div class="section-title">Course Resources for Beginners</div>
            <a href="https://www.udemy.com/course/python-for-beginners/" target="_blank" class="resource-link">Udemy - Python for Beginners</a>
            <a href="https://www.coursera.org/learn/python-data" target="_blank" class="resource-link">Coursera - Python Data Structures</a>
            <a href="https://www.codecademy.com/learn/learn-python-3" target="_blank" class="resource-link">Codecademy - Learn Python 3</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.edx.org/course/cs50s-introduction-to-computer-science" target="_blank" class="resource-link">edX - Introduction to Computer Science</a>
            <a href="https://www.pluralsight.com/courses/python-fundamentals" target="_blank" class="resource-link">Pluralsight - Python Fundamentals</a>
            <a href="https://www.datacamp.com/courses/data-structures-algorithms-in-python" target="_blank" class="resource-link">DataCamp - Data Structures in Python</a>
        --></div>
    </div>
