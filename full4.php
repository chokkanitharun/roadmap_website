...
<head>
    ...
    <title>Skill Route - Front-End Frameworks</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Front-End Frameworks</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://react.dev/learn" target="_blank" class="resource-link">React Official Docs - Learn React</a>
            <a href="https://www.freecodecamp.org/news/what-is-react-beginners-guide/" target="_blank" class="resource-link">FreeCodeCamp - React Guide</a>
            <a href="https://www.geeksforgeeks.org/reactjs-introduction/" target="_blank" class="resource-link">GeeksforGeeks - React Basics</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://react.dev/docs/hooks-intro" target="_blank" class="resource-link">React Docs - Advanced Hooks</a>
            <a href="https://kentcdodds.com/blog/advanced-react-patterns" target="_blank" class="resource-link">Advanced React Patterns - Kent C. Dodds</a>
            <a href="https://blog.logrocket.com/category/react/" target="_blank" class="resource-link">LogRocket Blog - React Tutorials</a>
        --></div>
 ...
 <?php
     foreach ($vadvanceLinks as $name => $url) {
         ...
         ';
            ...
            <a href="https://www.youtube.com/watch?v=w7ejDZ8SWv8" target="_blank" class="resource-link">YouTube - React JS Crash Course</a>
            <a href="https://www.youtube.com/watch?v=Ke90Tje7VS0" target="_blank" class="resource-link">YouTube - React Tutorial for Beginners</a>
            <a href="https://www.youtube.com/watch?v=DLX62G4lc44" target="_blank" class="resource-link">YouTube - React 101</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=mnBhQ82jfXo" target="_blank" class="resource-link">YouTube - Advanced React</a>
            <a href="https://www.youtube.com/watch?v=NFzfvNl-qHU" target="_blank" class="resource-link">YouTube - React Performance Optimization</a>
            <a href="https://www.youtube.com/watch?v=5Wb3s9ViuDw" target="_blank" class="resource-link">YouTube - React Patterns</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://scrimba.com/learn/learnreact" target="_blank" class="resource-link">Scrimba - Learn React for Free</a>
            <a href="https://www.udemy.com/course/react-the-complete-guide-incl-redux/" target="_blank" class="resource-link">Udemy - React Complete Guide</a>
            <a href="https://www.codecademy.com/learn/react-101" target="_blank" class="resource-link">Codecademy - React 101</a>
            ...
            <a href="https://www.pluralsight.com/courses/reactjs-advanced" target="_blank" class="resource-link">Pluralsight - Advanced React</a>
            <a href="https://egghead.io/courses/the-beginner-s-guide-to-react" target="_blank" class="resource-link">Egghead - Advanced React Techniques</a>
        --></div>
    </div>
