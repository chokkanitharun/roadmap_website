...
<head>
    ...
    <title>Skill Route - MVVM Architecture</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">MVVM Architecture</div>
...
?>
            ...
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://developer.android.com/jetpack/guide" target="_blank" class="resource-link">Guide to Android Jetpack - MVVM Basics</a>
            <a href="https://www.geeksforgeeks.org/mvvm-design-pattern/" target="_blank" class="resource-link">MVVM Design Pattern - GeeksforGeeks</a>
            <a href="https://www.raywenderlich.com/10988861-model-view-viewmodel-mvvm-pattern-for-android" target="_blank" class="resource-link">Model-View-ViewModel for Android - RayWenderlich</a>
            
            <div class="section-title">FOR ADVANCED</div>
            <a href="https://medium.com/androiddevelopers/architecture-components-paging-library-in-mvvm-f8f6f23b13b2" target="_blank" class="resource-link">Paging Library with MVVM - Medium</a>
            <a href="https://proandroiddev.com/advanced-mvvm-pattern-in-android-with-live-data-and-kotlin-coroutines-204eb4f536a" target="_blank" class="resource-link">Advanced MVVM with Coroutines - ProAndroidDev</a>
            <a href="https://developer.android.com/jetpack/architecture/livedata" target="_blank" class="resource-link">Using LiveData in MVVM - Official Docs</a>
        --></div>
 ...
 <?php
     foreach ($vadvanceLinks as $name => $url) {
         ...
         ';
            ...
            <a href="https://www.youtube.com/watch?v=_aMNjlHBvZo" target="_blank" class="resource-link">MVVM Pattern for Android - Simplified Coding</a>
            <a href="https://www.youtube.com/watch?v=G_0vPo5DrXI" target="_blank" class="resource-link">MVVM Architecture - FreeCodeCamp</a>
            <a href="https://www.youtube.com/watch?v=UCZzsb0d8O0" target="_blank" class="resource-link">MVVM Explained in Android - Android Developers</a>
            
            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=ZxSef2uk5zc" target="_blank" class="resource-link">Advanced MVVM with Kotlin and LiveData</a>
            <a href="https://www.youtube.com/watch?v=EJFlsjUtMoE" target="_blank" class="resource-link">Coroutines in MVVM - CodingWithMitch</a>
            <a href="https://www.youtube.com/watch?v=pg8oZb7CsSo" target="_blank" class="resource-link">MVVM Best Practices in Android - TechPrimers</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/mvvm-architecture-android/" target="_blank" class="resource-link">MVVM Architecture - Udemy</a>
            <a href="https://www.coursera.org/learn/android-applications-architecture" target="_blank" class="resource-link">Android App Architecture - Coursera</a>
            <a href="https://www.pluralsight.com/courses/mvvm-architecture-android" target="_blank" class="resource-link">MVVM Architecture for Android - Pluralsight</a>
            
            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://frontendmasters.com/courses/android-mvvm/" target="_blank" class="resource-link">Advanced MVVM for Android - Frontend Masters</a>
            <a href="https://www.udemy.com/course/advanced-mvvm-pattern/" target="_blank" class="resource-link">Advanced MVVM Pattern - Udemy</a>
            <a href="https://www.edx.org/course/android-mvvm-design" target="_blank" class="resource-link">MVVM Design for Android - edX</a>
        --></div>
    </div>
