...
<head>
    ...
    <title>Skill Route - Dependency Management Tools</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Swift Package Manager and CocoaPods</div>
...
?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://swift.org/package-manager/" target="_blank" class="resource-link">Swift.org - Swift Package Manager</a>
            <a href="https://guides.cocoapods.org/using/getting-started.html" target="_blank" class="resource-link">CocoaPods - Getting Started</a>
            <a href="https://developer.apple.com/documentation/xcode/adding_package_dependencies_to_your_app" target="_blank" class="resource-link">Apple Docs - Adding Package Dependencies</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://medium.com/swlh/advanced-swift-package-manager-tips-9c1dbfc0cc72" target="_blank" class="resource-link">Medium - Advanced Swift Package Manager Tips</a>
            <a href="https://cocoapods.org/" target="_blank" class="resource-link">CocoaPods.org - Libraries and Tools</a>
            <a href="https://www.udemy.com/course/dependency-management-in-ios/" target="_blank" class="resource-link">Udemy - iOS Dependency Management</a>
    --></div>
 ...
 <?php
     foreach ($vadvanceLinks as $name => $url) {
         ...
         ';
            ...
            <a href="https://www.youtube.com/watch?v=V4A1xINfd6M" target="_blank" class="resource-link">YouTube - Swift Package Manager Tutorial</a>
            <a href="https://www.youtube.com/watch?v=nXegUqw2FOA" target="_blank" class="resource-link">YouTube - Getting Started with CocoaPods</a>
            <a href="https://www.youtube.com/watch?v=RTjfKhO7zYE" target="_blank" class="resource-link">YouTube - Managing Dependencies in iOS</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=9rlIB5-gktM" target="_blank" class="resource-link">YouTube - Advanced SPM Configuration</a>
            <a href="https://www.youtube.com/watch?v=OYbFsDvh9ng" target="_blank" class="resource-link">YouTube - CocoaPods Deep Dive</a>
            <a href="https://www.youtube.com/watch?v=OSLYnNG8PpY" target="_blank" class="resource-link">YouTube - Best Practices in Dependency Management</a>
    --></div>
...
?>
            ...
            <a href="https://www.udemy.com/course/ios-development-dependency-management/" target="_blank" class="resource-link">Udemy - iOS Dependency Management</a>
            <a href="https://developer.apple.com/documentation/xcode/adding_package_dependencies_to_your_app" target="_blank" class="resource-link">Apple - Managing Dependencies in Xcode</a>
            <a href="https://www.codecademy.com/" target="_blank" class="resource-link">Codecademy - Swift Development Basics</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://frontendmasters.com/courses/swift-spm/" target="_blank" class="resource-link">Frontend Masters - Advanced Swift Package Manager</a>
            <a href="https://www.linkedin.com/learning/advanced-ios-dependency-management/" target="_blank" class="resource-link">LinkedIn Learning - Advanced Dependency Management</a>
            <a href="https://teamtreehouse.com/library/swift-dependency-management" target="_blank" class="resource-link">Treehouse - Managing Libraries in Swift</a>
    --></div>
    </div>
