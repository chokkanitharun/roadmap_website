...
<head>
    ...
    <title>Skill Route - Backend Programming</title>
    <style>
        /* Your original CSS styles here (unchanged) */
...
<body>
    ...
    <div class="header">
        ...
        <div class="header-title">Learn a Backend Programming Language</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://nodejs.dev/en/learn/" target="_blank" class="resource-link">Node.js Beginner's Guide</a>
            <a href="https://expressjs.com/en/starter/installing.html" target="_blank" class="resource-link">Express.js Getting Started</a>
            <a href="https://www.mongodb.com/docs/manual/tutorial/" target="_blank" class="resource-link">MongoDB Tutorials</a>
            
            <div class="section-title">FOR ADVANCED</div>
            <a href="https://nodejs.org/en/docs/guides/" target="_blank" class="resource-link">Node.js Advanced Guides</a>
            <a href="https://expressjs.com/en/advanced/best-practice-performance.html" target="_blank" class="resource-link">Express.js Best Practices</a>
    --> </div>
...
?>
          <!--  <div class="section-title">Video Resources for Beginners</div>
            <a href="https://www.youtube.com/watch?v=TlB_eWDSMt4" target="_blank" class="resource-link">Node.js Crash Course - Traversy Media</a>
            <a href="https://www.youtube.com/watch?v=K1hK5DgGsAc" target="_blank" class="resource-link">Express.js Crash Course</a>
            <a href="https://www.youtube.com/watch?v=oSIv-E60NiU" target="_blank" class="resource-link">MongoDB Basics - Programming with Mosh</a>
            
            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=U8XF6AFGqlc" target="_blank" class="resource-link">Advanced Node.js Concepts</a>
            <a href="https://www.youtube.com/watch?v=U5NOKWjP4kU" target="_blank" class="resource-link">Mastering Express.js</a>
            -->  </div>
...
?>
        <!--    <div class="section-title">Course Resources for Beginners</div>
            <a href="https://www.udemy.com/course/the-complete-nodejs-developer-course-2/" target="_blank" class="resource-link">The Complete Node.js Developer Course</a>
            <a href="https://www.udemy.com/course/express-js/" target="_blank" class="resource-link">Learn Express.js - Beginner to Advanced</a>
            
            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://frontendmasters.com/courses/node-js/" target="_blank" class="resource-link">Node.js Advanced Concepts - Frontend Masters</a>
            <a href="https://frontendmasters.com/courses/api-design-nodejs-v3/" target="_blank" class="resource-link">API Design in Node.js</a>
            --></div>
    </div>
