...
<head>
    ...
    <title>Skill Route - CSS Frameworks</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">CSS Frameworks</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://getbootstrap.com/docs/5.0/getting-started/introduction/" target="_blank" class="resource-link">Bootstrap Official Docs</a>
            <a href="https://tailwindcss.com/docs" target="_blank" class="resource-link">Tailwind CSS Official Docs</a>
            <a href="https://www.freecodecamp.org/news/bootstrap-tutorial/" target="_blank" class="resource-link">Bootstrap Tutorial - freeCodeCamp</a>
            
            <div class="section-title">FOR ADVANCED</div>
            <a href="https://tailwindcss.com/docs/utility-first" target="_blank" class="resource-link">Advanced Tailwind CSS</a>
            <a href="https://css-tricks.com/complete-guide-grid/" target="_blank" class="resource-link">Complete Guide to CSS Grid</a>
        --></div>
        ...
        <div id="videos" class="slider-section" style="display: none;">
            ...
            <a href="https://www.youtube.com/watch?v=QAgrHLtG1Yk" target="_blank" class="resource-link">Bootstrap Tutorial - Programming with Mosh</a>
            <a href="https://www.youtube.com/watch?v=pfaSUYaSgRo" target="_blank" class="resource-link">Tailwind CSS Crash Course - Traversy Media</a>
            
            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=dFgzHOX84xQ" target="_blank" class="resource-link">Advanced Tailwind CSS - Dev Ed</a>
            <a href="https://www.youtube.com/watch?v=jV8B24rSN5o" target="_blank" class="resource-link">Mastering Bootstrap 5 - Academind</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/bootstrap-4-tutorials/" target="_blank" class="resource-link">Bootstrap 4 Essentials - Udemy</a>
            <a href="https://www.udemy.com/course/tailwindcss-the-complete-guide/" target="_blank" class="resource-link">Tailwind CSS Complete Guide - Udemy</a>
            
            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://frontendmasters.com/courses/tailwindcss/" target="_blank" class="resource-link">Advanced Tailwind CSS - Frontend Masters</a>
            <a href="https://www.udemy.com/course/the-complete-guide-to-bootstrap-5/" target="_blank" class="resource-link">Complete Guide to Bootstrap 5 - Udemy</a>
        --></div>
    </div>
