...
<head>
    ...
    <title>Skill Route - JavaScript Events</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">JavaScript Events</div>
...
?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://developer.mozilla.org/en-US/docs/Web/Events" target="_blank" class="resource-link">JavaScript Events - MDN</a>
            <a href="https://www.w3schools.com/js/js_events.asp" target="_blank" class="resource-link">JavaScript Events - W3Schools</a>
            <a href="https://javascript.info/introduction-browser-events" target="_blank" class="resource-link">Introduction to Browser Events - JavaScript.info</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://www.smashingmagazine.com/2019/04/javascript-custom-events/" target="_blank" class="resource-link">Custom Events in JavaScript</a>
            <a href="https://dmitripavlutin.com/event-delegation-in-javascript/" target="_blank" class="resource-link">Event Delegation in JavaScript</a>
    --></div>
    ...
    ?>
            ...
            <a href="https://www.youtube.com/watch?v=XF1_MlZ5l6M" target="_blank" class="resource-link">JavaScript Events - Programming with Mosh</a>
            <a href="https://www.youtube.com/watch?v=6Lx8qg_jNAM" target="_blank" class="resource-link">Event Listeners in JavaScript - Traversy Media</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=VXugSM0P5gk" target="_blank" class="resource-link">Event Delegation - Learn JavaScript</a>
            <a href="https://www.youtube.com/watch?v=WnZUDvM3vXM" target="_blank" class="resource-link">Custom Events in JavaScript - Academind</a>
    --></div>
...
?>
            ...
            <a href="https://www.udemy.com/course/javascript-basics/" target="_blank" class="resource-link">JavaScript Events for Beginners - Udemy</a>
            <a href="https://scrimba.com/learn/javascript" target="_blank" class="resource-link">Learn JavaScript Events - Scrimba</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://frontendmasters.com/courses/javascript-the-hard-parts/" target="_blank" class="resource-link">JavaScript Events Deep Dive - Frontend Masters</a>
            <a href="https://www.pluralsight.com/courses/javascript-fundamentals" target="_blank" class="resource-link">JavaScript Events and Advanced Concepts - Pluralsight</a>
    --></div>
    </div>
