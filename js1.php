...
<head>
    ...
    <title>Skill Route - JavaScript Basics</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">JavaScript Basics</div>
...
?>
            ...
            <a href="https://www.w3schools.com/js/" target="_blank" class="resource-link">JavaScript Basics - W3Schools</a>
            <a href="https://www.freecodecamp.org/news/the-complete-javascript-handbook-f26b2c71719c/" target="_blank" class="resource-link">The Complete JavaScript Handbook</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://javascript.info/" target="_blank" class="resource-link">JavaScript.info - Comprehensive Guide</a>
            <a href="https://medium.com/@prakashsvkm/javascript-tips-and-tricks-for-beginners-and-advanced-developers-2e2f3b9cde8d" target="_blank" class="resource-link">Advanced JavaScript Tips and Tricks</a>
    --></div>
    ...
    ?>
            ...
            <a href="https://www.youtube.com/watch?v=W6NZfCO5SIk" target="_blank" class="resource-link">JavaScript Basics - Programming with Mosh</a>
            <a href="https://www.youtube.com/watch?v=upDLs1sn7g4" target="_blank" class="resource-link">JavaScript Crash Course - Traversy Media</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=PkZNo7MFNFg" target="_blank" class="resource-link">FreeCodeCamp JavaScript Tutorial</a>
            <a href="https://www.youtube.com/watch?v=o1IaduQICO0" target="_blank" class="resource-link">Deep Dive into JavaScript - Fireship</a>
    --></div>
...
?>
            ...
            <a href="https://www.udemy.com/course/javascript-for-beginners/" target="_blank" class="resource-link">JavaScript for Beginners - Udemy</a>
            <a href="https://www.codecademy.com/learn/introduction-to-javascript" target="_blank" class="resource-link">Introduction to JavaScript - Codecademy</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://frontendmasters.com/courses/javascript-basics/" target="_blank" class="resource-link">JavaScript Basics - Frontend Masters</a>
            <a href="https://www.coursera.org/learn/javascript" target="_blank" class="resource-link">Advanced JavaScript - Coursera</a>
    --></div>
    </div>
