...
<head>
    ...
    <title>Skill Route - Get Familiar with Xcode</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Get Familiar with Xcode</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://developer.apple.com/xcode/" target="_blank" class="resource-link">Official Xcode Documentation</a>
            <a href="https://www.raywenderlich.com/ios" target="_blank" class="resource-link">Ray Wenderlich - Xcode Tutorials</a>
            <a href="https://www.udemy.com/course/ios-12-and-swift-5-0/" target="_blank" class="resource-link">Learn Xcode with Swift - Udemy</a>
            
            <div class="section-title">FOR ADVANCED</div>
            <a href="https://www.hackingwithswift.com/" target="_blank" class="resource-link">Hacking with Swift - Xcode and Swift Advanced Tutorials</a>
            <a href="https://developer.apple.com/documentation/xcode/" target="_blank" class="resource-link">Xcode Advanced Features Documentation</a>
        --></div>
 ...
 <?php
     foreach ($vadvanceLinks as $name => $url) {
         ...
         ';
            ...
            <a href="https://www.youtube.com/watch?v=F2jcPzR3rKk" target="_blank" class="resource-link">Getting Started with Xcode - CodeWithChris</a>
            <a href="https://www.youtube.com/watch?v=lhFjxGchZ2Y" target="_blank" class="resource-link">Xcode Beginner Tutorial - LearnCode.academy</a>
            
            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=9Qzmri1WaaE" target="_blank" class="resource-link">Advanced Xcode Tips and Tricks - iOS Academy</a>
            <a href="https://www.youtube.com/watch?v=rb5bZsJXgqI" target="_blank" class="resource-link">Xcode Deep Dive - Sean Allen</a>
        --> </div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/ios-12-and-swift-5-0/" target="_blank" class="resource-link">iOS 12 & Swift 5.0 Development - Udemy</a>
            <a href="https://www.coursera.org/learn/swift-programming" target="_blank" class="resource-link">Swift Programming for Beginners - Coursera</a>
            <a href="https://www.edx.org/course/swift-programming-language" target="_blank" class="resource-link">Introduction to Swift - edX</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.udacity.com/course/advanced-ios-app-development--ud585" target="_blank" class="resource-link">Advanced iOS Development - Udacity</a>
            <a href="https://www.pluralsight.com/courses/swift-advanced-topics" target="_blank" class="resource-link">Swift Advanced Topics - Pluralsight</a>
            <a href="https://www.lynda.com/Swift-tutorials/Swift-Advanced-Topics/170085-2.html" target="_blank" class="resource-link">Swift Advanced Topics - Lynda</a>
        --> </div>
    </div>
