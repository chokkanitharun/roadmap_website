...
<head>
    ...
    <title>Skill Route - Machine Learning Basics</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Machine Learning Basics</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://towardsdatascience.com/introduction-to-machine-learning-7b7b12e0e936" target="_blank" class="resource-link">Towards Data Science - Introduction to Machine Learning</a>
            <a href="https://machinelearningmastery.com/machine-learning-for-beginners/" target="_blank" class="resource-link">Machine Learning Mastery - ML for Beginners</a>
            <a href="https://scikit-learn.org/stable/supervised_learning.html" target="_blank" class="resource-link">Scikit-learn - Supervised Learning</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://www.analyticsvidhya.com/blog/2017/09/common-machine-learning-algorithms/" target="_blank" class="resource-link">Analytics Vidhya - Common ML Algorithms</a>
            <a href="https://developers.google.com/machine-learning/clustering/overview" target="_blank" class="resource-link">Google Developers - Clustering</a>
            <a href="https://towardsdatascience.com/a-beginners-guide-to-reinforcement-learning-7d31d07b3725" target="_blank" class="resource-link">Towards Data Science - Reinforcement Learning</a>
        --></div>
 ...
 <?php
     foreach ($vadvanceLinks as $name => $url) {
         ...
         ';
            ...
            <a href="https://www.youtube.com/watch?v=Gv9_4yMHFhI" target="_blank" class="resource-link">YouTube - Intro to Machine Learning</a>
            <a href="https://www.youtube.com/watch?v=HVXime0nQeI" target="_blank" class="resource-link">YouTube - Supervised Learning</a>
            <a href="https://www.youtube.com/watch?v=sJ4hWa6y710" target="_blank" class="resource-link">YouTube - Unsupervised Learning</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=93edT7o7POE" target="_blank" class="resource-link">YouTube - Reinforcement Learning Basics</a>
            <a href="https://www.youtube.com/watch?v=rbEg5aaFJHU" target="_blank" class="resource-link">YouTube - Decision Trees Explained</a>
            <a href="https://www.youtube.com/watch?v=KmMd_HZnZPw" target="_blank" class="resource-link">YouTube - Clustering Algorithms</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.coursera.org/learn/machine-learning" target="_blank" class="resource-link">Coursera - Machine Learning by Andrew Ng</a>
            <a href="https://www.udemy.com/course/machinelearning/" target="_blank" class="resource-link">Udemy - Machine Learning A-Z</a>
            <a href="https://www.datacamp.com/courses/intro-to-machine-learning-with-python" target="_blank" class="resource-link">DataCamp - Intro to ML with Python</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.udacity.com/course/intro-to-machine-learning--ud120" target="_blank" class="resource-link">Udacity - Intro to Machine Learning</a>
            <a href="https://www.edx.org/course/principles-of-machine-learning" target="_blank" class="resource-link">edX - Principles of Machine Learning</a>
            <a href="https://pluralsight.com/courses/machine-learning" target="_blank" class="resource-link">Pluralsight - Machine Learning Course</a>
        --></div>
    </div>
