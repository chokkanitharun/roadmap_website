...
<head>
    ...
    <title>Skill Route - Multithreading and Concurrency</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">Multithreading and Concurrency</div>
    ...
    <div id="slider" class="slider">
        ...
        <div id="articles" class="slider-section">
            ...
            ?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://www.geeksforgeeks.org/multithreading-in-java/" target="_blank" class="resource-link">Multithreading in Java - GeeksforGeeks</a>
            <a href="https://www.javatpoint.com/java-multithreading" target="_blank" class="resource-link">Java Multithreading Basics - JavaTpoint</a>
            <a href="https://www.tutorialspoint.com/java/java_multithreading.htm" target="_blank" class="resource-link">Java Multithreading - TutorialsPoint</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://www.baeldung.com/java-concurrency" target="_blank" class="resource-link">Java Concurrency - Baeldung</a>
            <a href="https://docs.oracle.com/javase/tutorial/essential/concurrency/" target="_blank" class="resource-link">Concurrency in Java - Oracle Docs</a>
        --></div>
        ...
        <div id="videos" class="slider-section" style="display: none;">
            ...
            <a href="https://www.youtube.com/watch?v=kdXnmLAeS-s" target="_blank" class="resource-link">Java Multithreading Basics - Telusko</a>
            <a href="https://www.youtube.com/watch?v=v97gejd8fMA" target="_blank" class="resource-link">Multithreading in Java - freeCodeCamp</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=Eb2dxG39Uh0" target="_blank" class="resource-link">Advanced Concurrency in Java - ProgrammingKnowledge</a>
            <a href="https://www.youtube.com/watch?v=R3icL5D-_nw" target="_blank" class="resource-link">Concurrency and Threading - Coding Tech</a>
        --></div>
        ...
        <div id="courses" class="slider-section" style="display: none;">
            ...
            <a href="https://www.udemy.com/course/java-multithreading-for-beginners/" target="_blank" class="resource-link">Java Multithreading for Beginners - Udemy</a>
            <a href="https://www.coursera.org/learn/parallel-concurrent-distributed-java" target="_blank" class="resource-link">Parallel, Concurrent, and Distributed Java - Coursera</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://www.udemy.com/course/java-concurrency-in-practice/" target="_blank" class="resource-link">Java Concurrency in Practice - Udemy</a>
            <a href="https://www.linkedin.com/learning/java-concurrency" target="_blank" class="resource-link">Java Concurrency Tips - LinkedIn Learning</a>
        --></div>
    </div>
