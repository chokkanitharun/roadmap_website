...
<head>
    ...
    <title>Skill Route - Performance Optimization</title>
    <style>
...
<body>
    <!-- Header Section -->
    <div class="header">
        <div class="header-title">React Performance Optimization</div>
...
?>
            <!--<div class="section-title">FOR BEGINNERS</div>
            <a href="https://react.dev/learn/performance-optimization" target="_blank" class="resource-link">React - Performance Optimization</a>
            <a href="https://blog.logrocket.com/optimizing-performance-react-apps/" target="_blank" class="resource-link">LogRocket - Optimizing React Performance</a>
            <a href="https://developer.mozilla.org/en-US/docs/Web/Performance" target="_blank" class="resource-link">MDN - Web Performance</a>

            <div class="section-title">FOR ADVANCED</div>
            <a href="https://kentcdodds.com/blog/optimize-react-re-renders" target="_blank" class="resource-link">Kent C. Dodds - Optimize React Re-renders</a>
            <a href="https://frontendmasters.com/courses/react-performance/" target="_blank" class="resource-link">Frontend Masters - React Performance</a>
            <a href="https://www.smashingmagazine.com/2021/04/react-performance-optimization-techniques/" target="_blank" class="resource-link">Smashing Magazine - React Optimization Techniques</a>
    --></div>
    ...
    ?>
            ...
            <a href="https://www.youtube.com/watch?v=vZy0anZRd7k" target="_blank" class="resource-link">React Performance Optimization Basics</a>
            <a href="https://www.youtube.com/watch?v=T2sv8E0NjCM" target="_blank" class="resource-link">Memoization and Lazy Loading in React</a>
            <a href="https://www.youtube.com/watch?v=sZgYcS-JgeA" target="_blank" class="resource-link">React Profiler API Tutorial</a>

            <div class="section-title">Video Resources for Advanced</div>
            <a href="https://www.youtube.com/watch?v=-mJFZp84TIY" target="_blank" class="resource-link">Advanced React Performance Patterns</a>
            <a href="https://www.youtube.com/watch?v=WiLE-9WD-gc" target="_blank" class="resource-link">Mastering Performance in React</a>
            <a href="https://www.youtube.com/watch?v=4SRzJbYWbEo" target="_blank" class="resource-link">React Performance Optimization Advanced Tips</a>
    --></div>
...
?>
            ...
            <a href="https://scrimba.com/learn/reactperformance" target="_blank" class="resource-link">Scrimba - React Performance</a>
            ...
            <a href="https://www.coursera.org/learn/react-performance" target="_blank" class="resource-link">Coursera - React Performance Optimization</a>

            <div class="section-title">Course Resources for Advanced</div>
            <a href="https://frontendmasters.com/courses/advanced-react-performance/" target="_blank" class="resource-link">Frontend Masters - Advanced React Performance</a>
            <a href="https://egghead.io/courses/advanced-react-performance-optimization" target="_blank" class="resource-link">Egghead - React Performance Optimization</a>
            <a href="https://www.udemy.com/course/advanced-react-performance/" target="_blank" class="resource-link">Udemy - Advanced React Performance</a>
    --></div>
    </div>
